...
- branch/tag: `archive/u8.4-pre-greenfield` (`d13c9f7…`)

## Ashes

| Source | What we keep |
|--------|----------------|
| **Aetherion U8.4** | Brand; first real GDExtension proof; Conductor → chunk → TileMap idea |
| **SSXL-ext 9.1** | Winning ticket: **build cdylib → deploy into Godot project → launch Godot**; optional godot feature; bulk host path; scale confirmation commits (~4M tiles) |
