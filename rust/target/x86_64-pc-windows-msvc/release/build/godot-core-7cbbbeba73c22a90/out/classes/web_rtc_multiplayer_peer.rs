...
pub(super) mod re_export {
    ...
    impl WebRtcMultiplayerPeer {
        pub(crate) fn create_server_full(&mut self, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10884usize);
        ...
        pub(crate) fn create_client_full(&mut self, peer_id: i32, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10885usize);
        ...
        pub(crate) fn create_mesh_full(&mut self, peer_id: i32, channels_config: RefArg < VariantArray >,) -> crate::global::Error {
            ...
            let args = (peer_id, channels_config,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10886usize);
        ...
        pub(crate) fn add_peer_full(&mut self, peer: ObjectArg < crate::classes::WebRtcPeerConnection >, peer_id: i32, unreliable_lifetime: i32,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::WebRtcPeerConnection >, i32, i32,);
            let args = (peer, peer_id, unreliable_lifetime,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10887usize);
        ...
        #[inline]
        pub fn add_peer(&mut self, peer: impl AsObjectArg < crate::classes::WebRtcPeerConnection >, peer_id: i32,) -> crate::global::Error {
            self.add_peer_ex(peer, peer_id,) . done()
        }
        #[inline]
        pub fn add_peer_ex < 'a > (&'a mut self, peer: impl AsObjectArg < crate::classes::WebRtcPeerConnection >, peer_id: i32,) -> ExAddPeer < 'a > {
        ...
        pub fn remove_peer(&mut self, peer_id: i32,) {
            ...
            let args = (peer_id,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10888usize);
        ...
        pub fn has_peer(&mut self, peer_id: i32,) -> bool {
            ...
            let args = (peer_id,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10889usize);
    ...
    impl crate::obj::GodotClass for WebRtcMultiplayerPeer {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"WebRTCMultiplayerPeer"));
            * name
        }
...
pub struct ExAddPeer < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::WebRtcMultiplayerPeer, peer: ObjectCow < crate::classes::WebRtcPeerConnection >, peer_id: i32, unreliable_lifetime: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExAddPeer < 'a > {
    fn new(surround_object: &'a mut re_export::WebRtcMultiplayerPeer, peer: impl AsObjectArg < crate::classes::WebRtcPeerConnection >, peer_id: i32,) -> Self {
        let unreliable_lifetime = 1i32;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, peer: peer.consume_arg(), peer_id: peer_id, unreliable_lifetime: unreliable_lifetime,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::WebRtcMultiplayerPeer::add_peer_full(surround_object, peer.cow_as_object_arg(), peer_id, unreliable_lifetime,)
    }
}
#[cfg(since_api = "4.2")]
pub use signals::*;
