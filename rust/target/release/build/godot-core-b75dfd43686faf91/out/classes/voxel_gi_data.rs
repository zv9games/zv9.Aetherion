...
pub(super) mod re_export {
    ...
    impl VoxelGiData {
        pub fn allocate(&mut self, to_cell_xform: Transform3D, aabb: Aabb, octree_size: Vector3, octree_cells: &PackedByteArray, data_cells: &PackedByteArray, distance_field: &PackedByteArray, level_counts: &PackedInt32Array,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10848usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "allocate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bounds(&self,) -> Aabb {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10849usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_bounds", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_octree_size(&self,) -> Vector3 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10850usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_octree_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_to_cell_xform(&self,) -> Transform3D {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10851usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_to_cell_xform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_octree_cells(&self,) -> PackedByteArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_octree_cells", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_data_cells(&self,) -> PackedByteArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_data_cells", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_level_counts(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_level_counts", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_dynamic_range(&mut self, dynamic_range: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_dynamic_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_dynamic_range(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_dynamic_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_energy(&mut self, energy: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_energy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_energy(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_energy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bias(&mut self, bias: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bias(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_normal_bias(&mut self, bias: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_normal_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_normal_bias(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_normal_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_propagation(&mut self, propagation: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_propagation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_propagation(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "get_propagation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_interior(&mut self, interior: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_interior", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_interior(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "is_interior", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_two_bounces(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "set_use_two_bounces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_two_bounces(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VoxelGiData", "is_using_two_bounces", self.object_ptr, self.__checked_id(), args,)
            }
        }
