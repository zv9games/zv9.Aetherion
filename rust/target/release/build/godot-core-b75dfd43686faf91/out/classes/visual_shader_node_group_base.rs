...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeGroupBase {
        ...
        pub fn get_inputs(&self,) -> GString {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10682usize);
        ...
        pub fn set_outputs(&mut self, outputs: impl AsArg < GString >,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10683usize);
        ...
        pub fn get_outputs(&self,) -> GString {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10684usize);
        ...
        pub fn is_valid_port_name(&self, name: impl AsArg < GString >,) -> bool {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10685usize);
        ...
        pub fn add_input_port(&mut self, id: i32, type_: i32, name: impl AsArg < GString >,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10686usize);
        ...
        pub fn remove_input_port(&mut self, id: i32,) {
            ...
            let args = (id,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10687usize);
        ...
        pub fn get_input_port_count(&self,) -> i32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10688usize);
