...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for ScriptLanguage {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ScriptLanguage"));
            * name
        }
...
impl crate::obj::EngineEnum for ScriptNameCasing {
    ...
    fn as_str(&self) -> &'static str {
        ...
        match * self {
            Self::AUTO => "AUTO", Self::PASCAL_CASE => "PASCAL_CASE", Self::SNAKE_CASE => "SNAKE_CASE", Self::KEBAB_CASE => "KEBAB_CASE", _ => "",
        }
    }
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::AUTO => "SCRIPT_NAME_CASING_AUTO", Self::PASCAL_CASE => "SCRIPT_NAME_CASING_PASCAL_CASE", Self::SNAKE_CASE => "SCRIPT_NAME_CASING_SNAKE_CASE", Self::KEBAB_CASE => "SCRIPT_NAME_CASING_KEBAB_CASE", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
        &[ScriptNameCasing::AUTO, ScriptNameCasing::PASCAL_CASE, ScriptNameCasing::SNAKE_CASE, ScriptNameCasing::KEBAB_CASE]
    }
