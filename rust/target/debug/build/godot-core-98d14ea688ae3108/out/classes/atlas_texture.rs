...
pub(super) mod re_export {
    ...
    impl AtlasTexture {
        pub fn set_atlas(&mut self, atlas: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "set_atlas", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_atlas(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "get_atlas", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_region(&mut self, region: Rect2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "set_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_region(&self,) -> Rect2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "get_region", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_margin(&mut self, margin: Rect2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "set_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_margin(&self,) -> Rect2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "get_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_filter_clip(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "set_filter_clip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_filter_clip(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AtlasTexture", "has_filter_clip", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AtlasTexture__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::AtlasTexture;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for AtlasTexture {
