...
pub(super) mod re_export {
    ...
    impl WebSocketMultiplayerPeer {
        pub(crate) fn create_client_full(&mut self, url: CowArg < GString >, tls_client_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::TlsOptions >,);
        ...
        pub(crate) fn create_server_full(&mut self, port: i32, bind_address: CowArg < GString >, tls_server_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (i32, CowArg < 'a0, GString >, ObjectArg < crate::classes::TlsOptions >,);
    ...
    impl crate::obj::GodotClass for WebSocketMultiplayerPeer {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"WebSocketMultiplayerPeer"));
            * name
        }
...
pub struct ExCreateClient < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::WebSocketMultiplayerPeer, url: CowArg < 'a, GString >, tls_client_options: ObjectCow < crate::classes::TlsOptions >,
}
...
impl < 'a > ExCreateClient < 'a > {
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::WebSocketMultiplayerPeer::create_client_full(surround_object, url, tls_client_options.cow_as_object_arg(),)
    }
}
...
pub struct ExCreateServer < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::WebSocketMultiplayerPeer, port: i32, bind_address: CowArg < 'a, GString >, tls_server_options: ObjectCow < crate::classes::TlsOptions >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateServer < 'a > {
    fn new(surround_object: &'a mut re_export::WebSocketMultiplayerPeer, port: i32,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, port: port, bind_address: CowArg::Owned(bind_address), tls_server_options: tls_server_options.consume_arg(),
        }
    }
    #[inline]
    ...
    #[inline]
    pub fn tls_server_options(self, tls_server_options: impl AsObjectArg < crate::classes::TlsOptions >) -> Self {
        Self {
            tls_server_options: tls_server_options.consume_arg(), .. self
        }
    }
    #[inline]
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::WebSocketMultiplayerPeer::create_server_full(surround_object, port, bind_address, tls_server_options.cow_as_object_arg(),)
    }
}
pub use signals::*;
mod signals {
