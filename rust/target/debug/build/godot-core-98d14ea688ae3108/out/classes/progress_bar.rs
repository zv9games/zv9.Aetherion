...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for ProgressBar {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ProgressBar"));
            * name
        }
...
impl crate::obj::EngineEnum for FillMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::BEGIN_TO_END => "FILL_BEGIN_TO_END", Self::END_TO_BEGIN => "FILL_END_TO_BEGIN", Self::TOP_TO_BOTTOM => "FILL_TOP_TO_BOTTOM", Self::BOTTOM_TO_TOP => "FILL_BOTTOM_TO_TOP", _ => self.as_str(),
        }
    }
