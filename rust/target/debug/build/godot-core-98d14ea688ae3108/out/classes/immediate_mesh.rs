...
pub(super) mod re_export {
    ...
    impl ImmediateMesh {
        pub(crate) fn surface_begin_full(&mut self, primitive: crate::classes::mesh::PrimitiveType, material: ObjectArg < crate::classes::Material >,) {
            type CallRet = ();
            type CallParams = (crate::classes::mesh::PrimitiveType, ObjectArg < crate::classes::Material >,);
    ...
    impl crate::obj::GodotClass for ImmediateMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ImmediateMesh"));
            * name
        }
...
pub struct ExSurfaceBegin < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::ImmediateMesh, primitive: crate::classes::mesh::PrimitiveType, material: ObjectCow < crate::classes::Material >,
}
...
impl < 'a > ExSurfaceBegin < 'a > {
    fn new(surround_object: &'a mut re_export::ImmediateMesh, primitive: crate::classes::mesh::PrimitiveType,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, primitive: primitive, material: material.consume_arg(),
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::ImmediateMesh::surface_begin_full(surround_object, primitive, material.cow_as_object_arg(),)
    }
}
pub use signals::*;
mod signals {
