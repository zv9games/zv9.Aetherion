...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for BackBufferCopy {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"BackBufferCopy"));
            * name
        }
...
impl crate::obj::EngineEnum for CopyMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DISABLED => "COPY_MODE_DISABLED", Self::RECT => "COPY_MODE_RECT", Self::VIEWPORT => "COPY_MODE_VIEWPORT", _ => self.as_str(),
        }
    }
