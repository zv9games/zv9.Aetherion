...
pub(super) mod re_export {
    ...
    impl EditorNode3DGizmoPlugin {
        ...
        pub(crate) fn create_icon_material_full(&mut self, name: CowArg < GString >, texture: ObjectArg < crate::classes::Texture2D >, on_top: bool, color: Color,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Texture2D >, bool, Color,);
        ...
        #[inline]
        pub fn create_icon_material(&mut self, name: impl AsArg < GString >, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            self.create_icon_material_ex(name, texture,) . done()
        }
        #[inline]
        pub fn create_icon_material_ex < 'a > (&'a mut self, name: impl AsArg < GString > + 'a, texture: impl AsObjectArg < crate::classes::Texture2D >,) -> ExCreateIconMaterial < 'a > {
            ExCreateIconMaterial::new(self, name, texture,)
        }
        pub(crate) fn create_handle_material_full(&mut self, name: CowArg < GString >, billboard: bool, texture: ObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, bool, ObjectArg < crate::classes::Texture2D >,);
        ...
        pub fn add_material(&mut self, name: impl AsArg < GString >, material: impl AsObjectArg < crate::classes::StandardMaterial3D >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::StandardMaterial3D >,);
            let args = (name.into_arg(), material.as_object_arg(),);
            unsafe {
        ...
        pub(crate) fn get_material_full(&mut self, name: CowArg < GString >, gizmo: ObjectArg < crate::classes::EditorNode3DGizmo >,) -> Option < Gd < crate::classes::StandardMaterial3D > > {
            type CallRet = Option < Gd < crate::classes::StandardMaterial3D > >;
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::EditorNode3DGizmo >,);
            let args = (name, gizmo,);
            unsafe {
    ...
    impl crate::obj::GodotClass for EditorNode3DGizmoPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorNode3DGizmoPlugin"));
            * name
        }
...
pub struct ExCreateIconMaterial < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: CowArg < 'a, GString >, texture: ObjectCow < crate::classes::Texture2D >, on_top: bool, color: Color,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateIconMaterial < 'a > {
    fn new(surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: impl AsArg < GString > + 'a, texture: impl AsObjectArg < crate::classes::Texture2D >,) -> Self {
        let on_top = false;
        let color = Color::from_rgba(1 as _, 1 as _, 1 as _, 1 as _);
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), texture: texture.consume_arg(), on_top: on_top, color: color,
        }
    }
    #[inline]
    pub fn on_top(self, on_top: bool) -> Self {
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorNode3DGizmoPlugin::create_icon_material_full(surround_object, name, texture.cow_as_object_arg(), on_top, color,)
    }
}
...
pub struct ExCreateHandleMaterial < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: CowArg < 'a, GString >, billboard: bool, texture: ObjectCow < crate::classes::Texture2D >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateHandleMaterial < 'a > {
    fn new(surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: impl AsArg < GString > + 'a,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), billboard: billboard, texture: texture.consume_arg(),
        }
    }
    #[inline]
    pub fn billboard(self, billboard: bool) -> Self {
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorNode3DGizmoPlugin::create_handle_material_full(surround_object, name, billboard, texture.cow_as_object_arg(),)
    }
}
...
pub struct ExGetMaterial < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: CowArg < 'a, GString >, gizmo: ObjectCow < crate::classes::EditorNode3DGizmo >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExGetMaterial < 'a > {
    fn new(surround_object: &'a mut re_export::EditorNode3DGizmoPlugin, name: impl AsArg < GString > + 'a,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), gizmo: gizmo.consume_arg(),
        }
    }
    #[inline]
    pub fn gizmo(self, gizmo: impl AsObjectArg < crate::classes::EditorNode3DGizmo >) -> Self {
        Self {
            gizmo: gizmo.consume_arg(), .. self
        }
    }
    #[inline]
    pub fn done(self) -> Option < Gd < crate::classes::StandardMaterial3D > > {
        ...
        = self;
        re_export::EditorNode3DGizmoPlugin::get_material_full(surround_object, name, gizmo.cow_as_object_arg(),)
    }
}
pub use signals::*;
mod signals {
