...
pub(super) mod re_export {
    ...
    impl RemoteTransform2D {
        pub fn set_remote_node(&mut self, path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "set_remote_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_remote_node(&self,) -> NodePath {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "get_remote_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn force_update_cache(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "force_update_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_global_coordinates(&mut self, use_global_coordinates: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "set_use_global_coordinates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_use_global_coordinates(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "get_use_global_coordinates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_position(&mut self, update_remote_position: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "set_update_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_position(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "get_update_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_rotation(&mut self, update_remote_rotation: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "set_update_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_rotation(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "get_update_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_update_scale(&mut self, update_remote_scale: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "set_update_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_update_scale(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RemoteTransform2D", "get_update_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for RemoteTransform2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"RemoteTransform2D"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::Node2D > for RemoteTransform2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CanvasItem > for RemoteTransform2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for RemoteTransform2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for RemoteTransform2D {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`RemoteTransform2D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_RemoteTransform2D__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::RemoteTransform2D > for $Class {
...
mod signals {
    ...
    use super::re_export::RemoteTransform2D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::canvas_item::SignalsOfCanvasItem;
    impl WithSignals for RemoteTransform2D {
