...
pub(super) mod re_export {
    ...
    impl VoxelGi {
        pub fn set_probe_data(&mut self, data: impl AsObjectArg < crate::classes::VoxelGiData >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::VoxelGiData >,);
            let args = (data.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10839usize);
        ...
        pub fn get_probe_data(&self,) -> Option < Gd < crate::classes::VoxelGiData > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10840usize);
        ...
        pub fn set_subdiv(&mut self, subdiv: crate::classes::voxel_gi::Subdiv,) {
            ...
            let args = (subdiv,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10841usize);
        ...
        pub fn get_subdiv(&self,) -> crate::classes::voxel_gi::Subdiv {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10842usize);
        ...
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            let args = (size,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10843usize);
        ...
        pub fn get_size(&self,) -> Vector3 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10844usize);
        ...
        pub fn set_camera_attributes(&mut self, camera_attributes: impl AsObjectArg < crate::classes::CameraAttributes >,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10845usize);
        ...
        pub fn get_camera_attributes(&self,) -> Option < Gd < crate::classes::CameraAttributes > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10846usize);
        ...
        pub(crate) fn bake_full(&mut self, from_node: ObjectArg < crate::classes::Node >, create_visual_debug: bool,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Node >, bool,);
            let args = (from_node, create_visual_debug,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10847usize);
    ...
    impl crate::obj::GodotClass for VoxelGi {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VoxelGI"));
            * name
        }
...
#[must_use]
pub struct ExBake < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::VoxelGi, from_node: ObjectCow < crate::classes::Node >, create_visual_debug: bool,
}
...
impl < 'a > ExBake < 'a > {
    fn new(surround_object: &'a mut re_export::VoxelGi,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, from_node: from_node.consume_arg(), create_visual_debug: create_visual_debug,
        }
    }
    #[inline]
    pub fn from_node(self, from_node: impl AsObjectArg < crate::classes::Node >) -> Self {
        Self {
            from_node: from_node.consume_arg(), .. self
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::VoxelGi::bake_full(surround_object, from_node.cow_as_object_arg(), create_visual_debug,)
    }
}
#[repr(transparent)]
...
impl crate::obj::EngineEnum for Subdiv {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::MAX => "SUBDIV_MAX", _ => self.as_str(),
        }
    }
