...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for ConeTwistJoint3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ConeTwistJoint3D"));
            * name
        }
...
impl crate::obj::EngineEnum for Param {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SWING_SPAN => "PARAM_SWING_SPAN", Self::TWIST_SPAN => "PARAM_TWIST_SPAN", Self::BIAS => "PARAM_BIAS", Self::SOFTNESS => "PARAM_SOFTNESS", Self::RELAXATION => "PARAM_RELAXATION", Self::MAX => "PARAM_MAX", _ => self.as_str(),
        }
    }
