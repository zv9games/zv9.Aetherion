...
pub(super) mod re_export {
    ...
    impl BitMap {
        pub fn create(&mut self, size: Vector2i,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "create", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn create_from_image_alpha_full(&mut self, image: ObjectArg < crate::classes::Image >, threshold: f32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >, f32,);
            let args = (image, threshold,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1243usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "create_from_image_alpha", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn set_bitv(&mut self, position: Vector2i, bit: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "set_bitv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bit(&mut self, x: i32, y: i32, bit: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "set_bit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bitv(&self, position: Vector2i,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "get_bitv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bit(&self, x: i32, y: i32,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "get_bit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bit_rect(&mut self, rect: Rect2i, bit: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "set_bit_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_true_bit_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "get_true_bit_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn resize(&mut self, new_size: Vector2i,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "resize", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn grow_mask(&mut self, pixels: i32, rect: Rect2i,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "grow_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn convert_to_image(&self,) -> Option < Gd < crate::classes::Image > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "convert_to_image", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn opaque_to_polygons_full(&self, rect: Rect2i, epsilon: f32,) -> Array < PackedVector2Array > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BitMap", "opaque_to_polygons", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_BitMap__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::BitMap;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for BitMap {
