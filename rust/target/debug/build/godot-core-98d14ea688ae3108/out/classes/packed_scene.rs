...
pub(super) mod re_export {
    ...
    impl PackedScene {
        pub fn pack(&mut self, path: impl AsObjectArg < crate::classes::Node >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::Node >,);
            let args = (path.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6228usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PackedScene", "pack", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn instantiate_full(&self, edit_state: crate::classes::packed_scene::GenEditState,) -> Option < Gd < crate::classes::Node > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PackedScene", "instantiate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        #[doc = "To set the default parameters, use [`Self::instantiate_ex`] and its builder methods.  See [the book](https://godot-rust.github.io/book/godot-api/functions.html#default-parameters) for detailed usage instructions."]
        #[inline]
        pub fn instantiate(&self,) -> Option < Gd < crate::classes::Node > > {
            self.instantiate_ex() . done()
        }
        #[inline]
        pub fn instantiate_ex < 'a > (&'a self,) -> ExInstantiate < 'a > {
        ...
        pub fn can_instantiate(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PackedScene", "can_instantiate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_state(&self,) -> Option < Gd < crate::classes::SceneState > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PackedScene", "get_state", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PackedScene {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PackedScene"));
            * name
        }
...
pub struct ExInstantiate < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a re_export::PackedScene, edit_state: crate::classes::packed_scene::GenEditState,
}
