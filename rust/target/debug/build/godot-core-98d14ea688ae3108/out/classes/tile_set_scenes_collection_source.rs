...
pub(super) mod re_export {
    ...
    impl TileSetScenesCollectionSource {
        ...
        pub(crate) fn create_scene_tile_full(&mut self, packed_scene: ObjectArg < crate::classes::PackedScene >, id_override: i32,) -> i32 {
            type CallRet = i32;
            type CallParams = (ObjectArg < crate::classes::PackedScene >, i32,);
        ...
        #[inline]
        pub fn create_scene_tile(&mut self, packed_scene: impl AsObjectArg < crate::classes::PackedScene >,) -> i32 {
            self.create_scene_tile_ex(packed_scene,) . done()
        }
        #[inline]
        pub fn create_scene_tile_ex < 'a > (&'a mut self, packed_scene: impl AsObjectArg < crate::classes::PackedScene >,) -> ExCreateSceneTile < 'a > {
        ...
        pub fn set_scene_tile_scene(&mut self, id: i32, packed_scene: impl AsObjectArg < crate::classes::PackedScene >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::PackedScene >,);
            let args = (id, packed_scene.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for TileSetScenesCollectionSource {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TileSetScenesCollectionSource"));
            * name
        }
...
pub struct ExCreateSceneTile < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::TileSetScenesCollectionSource, packed_scene: ObjectCow < crate::classes::PackedScene >, id_override: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateSceneTile < 'a > {
    fn new(surround_object: &'a mut re_export::TileSetScenesCollectionSource, packed_scene: impl AsObjectArg < crate::classes::PackedScene >,) -> Self {
        let id_override = - 1i32;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, packed_scene: packed_scene.consume_arg(), id_override: id_override,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> i32 {
        ...
        = self;
        re_export::TileSetScenesCollectionSource::create_scene_tile_full(surround_object, packed_scene.cow_as_object_arg(), id_override,)
    }
}
pub use signals::*;
mod signals {
