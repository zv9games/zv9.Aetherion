...
pub(super) mod re_export {
    ...
    impl GltfState {
        ...
        pub fn append_gltf_node(&mut self, gltf_node: impl AsObjectArg < crate::classes::GltfNode >, godot_scene_node: impl AsObjectArg < crate::classes::Node >, parent_node_index: i32,) -> i32 {
            type CallRet = i32;
            type CallParams = (ObjectArg < crate::classes::GltfNode >, ObjectArg < crate::classes::Node >, i32,);
            let args = (gltf_node.as_object_arg(), godot_scene_node.as_object_arg(), parent_node_index,);
            unsafe {
