...
pub(super) mod re_export {
    ...
    impl AudioEffectAmplify {
        pub fn set_volume_db(&mut self, volume: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectAmplify", "set_volume_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_volume_db(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectAmplify", "get_volume_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_volume_linear(&mut self, volume: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectAmplify", "set_volume_linear", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_volume_linear(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectAmplify", "get_volume_linear", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AudioEffectAmplify__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::AudioEffectAmplify;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for AudioEffectAmplify {
