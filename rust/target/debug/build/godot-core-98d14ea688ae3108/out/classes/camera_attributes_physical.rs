...
pub(super) mod re_export {
    ...
    impl CameraAttributesPhysical {
        pub fn set_aperture(&mut self, aperture: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_aperture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_aperture(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_aperture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shutter_speed(&mut self, shutter_speed: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_shutter_speed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shutter_speed(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_shutter_speed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_focal_length(&mut self, focal_length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_focal_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_focal_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_focal_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_focus_distance(&mut self, focus_distance: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_focus_distance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_focus_distance(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_focus_distance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_near(&mut self, near: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_near", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_near(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_near", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_far(&mut self, far: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_far", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_far(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_far", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fov(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_fov", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_auto_exposure_max_exposure_value(&mut self, exposure_value_max: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_auto_exposure_max_exposure_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_auto_exposure_max_exposure_value(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_auto_exposure_max_exposure_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_auto_exposure_min_exposure_value(&mut self, exposure_value_min: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "set_auto_exposure_min_exposure_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_auto_exposure_min_exposure_value(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CameraAttributesPhysical", "get_auto_exposure_min_exposure_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_CameraAttributesPhysical__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::CameraAttributesPhysical;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for CameraAttributesPhysical {
