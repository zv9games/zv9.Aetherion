    ...
    impl XrInterfaceExtension {
        pub fn get_color_texture(&mut self,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "XrInterfaceExtension", "get_color_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_depth_texture(&mut self,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "XrInterfaceExtension", "get_depth_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_velocity_texture(&mut self,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "XrInterfaceExtension", "get_velocity_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_blit(&mut self, render_target: Rid, src_rect: Rect2, dst_rect: Rect2i, use_layer: bool, layer: u32, apply_lens_distortion: bool, eye_center: Vector2, k1: f64, k2: f64, upscale: f64, aspect_ratio: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "XrInterfaceExtension", "add_blit", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_render_target_texture(&mut self, render_target: Rid,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "XrInterfaceExtension", "get_render_target_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
