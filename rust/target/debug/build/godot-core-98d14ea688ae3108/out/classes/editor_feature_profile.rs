...
impl crate::obj::EngineEnum for Feature {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SCRIPT => "FEATURE_SCRIPT", Self::ASSET_LIB => "FEATURE_ASSET_LIB", Self::SCENE_TREE => "FEATURE_SCENE_TREE", Self::NODE_DOCK => "FEATURE_NODE_DOCK", Self::FILESYSTEM_DOCK => "FEATURE_FILESYSTEM_DOCK", Self::IMPORT_DOCK => "FEATURE_IMPORT_DOCK", Self::HISTORY_DOCK => "FEATURE_HISTORY_DOCK", Self::GAME => "FEATURE_GAME", Self::MAX => "FEATURE_MAX", _ => self.as_str(),
        }
    }
