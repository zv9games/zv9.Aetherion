...
pub(super) mod re_export {
    ...
    impl PhysicsRayQueryParameters2D {
        pub(crate) fn create_full(from: Vector2, to: Vector2, collision_mask: u32, exclude: RefArg < Array < Rid > >,) -> Option < Gd < crate::classes::PhysicsRayQueryParameters2D > > {
            type CallRet = Option < Gd < crate::classes::PhysicsRayQueryParameters2D > >;
            type CallParams < 'a0, > = (Vector2, Vector2, u32, RefArg < 'a0, Array < Rid > >,);
            let args = (from, to, collision_mask, exclude,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6547usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "create", std::ptr::null_mut(), None, args,)
            }
        }
        ...
        pub fn set_from(&mut self, from: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_from", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_from(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "get_from", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_to(&mut self, to: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_to", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_to(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "get_to", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_collision_mask(&mut self, collision_mask: u32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_collision_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collision_mask(&self,) -> u32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "get_collision_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_exclude(&mut self, exclude: &Array < Rid >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_exclude", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_exclude(&self,) -> Array < Rid > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "get_exclude", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_collide_with_bodies(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_collide_with_bodies", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_collide_with_bodies_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "is_collide_with_bodies_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_collide_with_areas(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_collide_with_areas", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_collide_with_areas_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "is_collide_with_areas_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_hit_from_inside(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "set_hit_from_inside", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_hit_from_inside_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsRayQueryParameters2D", "is_hit_from_inside_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PhysicsRayQueryParameters2D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PhysicsRayQueryParameters2D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for PhysicsRayQueryParameters2D {
