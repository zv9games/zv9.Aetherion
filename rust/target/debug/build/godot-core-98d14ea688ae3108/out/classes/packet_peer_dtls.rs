...
pub(super) mod re_export {
    ...
    impl PacketPeerDtls {
        pub fn poll(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerDtls", "poll", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn connect_to_peer_full(&mut self, packet_peer: ObjectArg < crate::classes::PacketPeerUdp >, hostname: CowArg < GString >, client_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            ...
            type CallParams < 'a0, > = (ObjectArg < crate::classes::PacketPeerUdp >, CowArg < 'a0, GString >, ObjectArg < crate::classes::TlsOptions >,);
            let args = (packet_peer, hostname, client_options,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6241usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerDtls", "connect_to_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_status(&self,) -> crate::classes::packet_peer_dtls::Status {
            type CallRet = crate::classes::packet_peer_dtls::Status;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6242usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerDtls", "get_status", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn disconnect_from_peer(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerDtls", "disconnect_from_peer", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PacketPeerDtls__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PacketPeerDtls;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for PacketPeerDtls {
