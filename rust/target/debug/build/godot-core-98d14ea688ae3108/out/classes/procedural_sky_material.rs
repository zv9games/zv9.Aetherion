...
pub(super) mod re_export {
    ...
    impl ProceduralSkyMaterial {
        ...
        pub fn set_sky_cover(&mut self, sky_cover: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Texture2D >,);
            let args = (sky_cover.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for ProceduralSkyMaterial {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ProceduralSkyMaterial"));
            * name
        }
