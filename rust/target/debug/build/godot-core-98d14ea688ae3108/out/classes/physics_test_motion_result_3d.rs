...
pub(super) mod re_export {
    ...
    impl PhysicsTestMotionResult3D {
        pub fn get_travel(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_travel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_remainder(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_remainder", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collision_safe_fraction(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_safe_fraction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collision_unsafe_fraction(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_unsafe_fraction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collision_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_collision_point_full(&self, collision_index: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collision_normal_full(&self, collision_index: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collider_velocity_full(&self, collision_index: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collider_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collider_id_full(&self, collision_index: i32,) -> u64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collider_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collider_rid_full(&self, collision_index: i32,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collider_rid", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collider_full(&self, collision_index: i32,) -> Option < Gd < crate::classes::Object > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collider", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collider_shape_full(&self, collision_index: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collider_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collision_local_shape_full(&self, collision_index: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_local_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_collision_depth_full(&self, collision_index: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicsTestMotionResult3D", "get_collision_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PhysicsTestMotionResult3D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PhysicsTestMotionResult3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for PhysicsTestMotionResult3D {
