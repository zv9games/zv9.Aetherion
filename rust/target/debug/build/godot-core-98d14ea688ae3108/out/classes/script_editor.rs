...
pub(super) mod re_export {
    ...
    impl ScriptEditor {
        pub fn get_current_editor(&self,) -> Option < Gd < crate::classes::ScriptEditorBase > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(432usize);
        ...
        pub fn get_open_script_editors(&self,) -> Array < Gd < crate::classes::ScriptEditorBase > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(433usize);
        ...
        pub fn get_breakpoints(&mut self,) -> PackedStringArray {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(434usize);
        ...
        pub fn register_syntax_highlighter(&mut self, syntax_highlighter: impl AsObjectArg < crate::classes::EditorSyntaxHighlighter >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorSyntaxHighlighter >,);
            let args = (syntax_highlighter.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(435usize);
        ...
        pub fn unregister_syntax_highlighter(&mut self, syntax_highlighter: impl AsObjectArg < crate::classes::EditorSyntaxHighlighter >,) {
            ...
            let args = (syntax_highlighter.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(436usize);
        ...
        pub fn goto_line(&mut self, line_number: i32,) {
            ...
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(437usize);
        ...
        pub fn get_current_script(&mut self,) -> Option < Gd < crate::classes::Script > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(438usize);
        ...
        pub fn open_script_create_dialog(&mut self, base_name: impl AsArg < GString >, base_path: impl AsArg < GString >,) {
            ...
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(440usize);
        ...
        pub fn update_docs_from_script(&mut self, script: impl AsObjectArg < crate::classes::Script >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Script >,);
