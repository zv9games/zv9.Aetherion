...
pub(super) mod re_export {
    ...
    impl EditorContextMenuPlugin {
        pub fn add_menu_shortcut(&mut self, shortcut: impl AsObjectArg < crate::classes::Shortcut >, callback: &Callable,) {
            type CallRet = ();
            type CallParams < 'a0, > = (ObjectArg < crate::classes::Shortcut >, RefArg < 'a0, Callable >,);
            let args = (shortcut.as_object_arg(), RefArg::new(callback),);
            unsafe {
        ...
        pub(crate) fn add_context_menu_item_full(&mut self, name: CowArg < GString >, callback: RefArg < Callable >, icon: ObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (CowArg < 'a0, GString >, RefArg < 'a1, Callable >, ObjectArg < crate::classes::Texture2D >,);
        ...
        pub(crate) fn add_context_menu_item_from_shortcut_full(&mut self, name: CowArg < GString >, shortcut: ObjectArg < crate::classes::Shortcut >, icon: ObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Shortcut >, ObjectArg < crate::classes::Texture2D >,);
        ...
        #[inline]
        pub fn add_context_menu_item_from_shortcut(&mut self, name: impl AsArg < GString >, shortcut: impl AsObjectArg < crate::classes::Shortcut >,) {
            self.add_context_menu_item_from_shortcut_ex(name, shortcut,) . done()
        }
        #[inline]
        pub fn add_context_menu_item_from_shortcut_ex < 'a > (&'a mut self, name: impl AsArg < GString > + 'a, shortcut: impl AsObjectArg < crate::classes::Shortcut >,) -> ExAddContextMenuItemFromShortcut < 'a > {
            ExAddContextMenuItemFromShortcut::new(self, name, shortcut,)
        }
        pub(crate) fn add_context_submenu_item_full(&mut self, name: CowArg < GString >, menu: ObjectArg < crate::classes::PopupMenu >, icon: ObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::PopupMenu >, ObjectArg < crate::classes::Texture2D >,);
        ...
        #[inline]
        pub fn add_context_submenu_item(&mut self, name: impl AsArg < GString >, menu: impl AsObjectArg < crate::classes::PopupMenu >,) {
            self.add_context_submenu_item_ex(name, menu,) . done()
        }
        #[inline]
        pub fn add_context_submenu_item_ex < 'a > (&'a mut self, name: impl AsArg < GString > + 'a, menu: impl AsObjectArg < crate::classes::PopupMenu >,) -> ExAddContextSubmenuItem < 'a > {
    ...
    impl crate::obj::GodotClass for EditorContextMenuPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorContextMenuPlugin"));
            * name
        }
...
pub struct ExAddContextMenuItem < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorContextMenuPlugin, name: CowArg < 'a, GString >, callback: CowArg < 'a, Callable >, icon: ObjectCow < crate::classes::Texture2D >,
}
...
impl < 'a > ExAddContextMenuItem < 'a > {
    fn new(surround_object: &'a mut re_export::EditorContextMenuPlugin, name: impl AsArg < GString > + 'a, callback: &'a Callable,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), callback: CowArg::Borrowed(callback), icon: icon.consume_arg(),
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorContextMenuPlugin::add_context_menu_item_full(surround_object, name, callback.cow_as_arg(), icon.cow_as_object_arg(),)
    }
}
...
pub struct ExAddContextMenuItemFromShortcut < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorContextMenuPlugin, name: CowArg < 'a, GString >, shortcut: ObjectCow < crate::classes::Shortcut >, icon: ObjectCow < crate::classes::Texture2D >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExAddContextMenuItemFromShortcut < 'a > {
    fn new(surround_object: &'a mut re_export::EditorContextMenuPlugin, name: impl AsArg < GString > + 'a, shortcut: impl AsObjectArg < crate::classes::Shortcut >,) -> Self {
        let icon = Gd::null_arg();
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), shortcut: shortcut.consume_arg(), icon: icon.consume_arg(),
        }
    }
    #[inline]
    pub fn icon(self, icon: impl AsObjectArg < crate::classes::Texture2D >) -> Self {
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorContextMenuPlugin::add_context_menu_item_from_shortcut_full(surround_object, name, shortcut.cow_as_object_arg(), icon.cow_as_object_arg(),)
    }
}
...
pub struct ExAddContextSubmenuItem < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorContextMenuPlugin, name: CowArg < 'a, GString >, menu: ObjectCow < crate::classes::PopupMenu >, icon: ObjectCow < crate::classes::Texture2D >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExAddContextSubmenuItem < 'a > {
    fn new(surround_object: &'a mut re_export::EditorContextMenuPlugin, name: impl AsArg < GString > + 'a, menu: impl AsObjectArg < crate::classes::PopupMenu >,) -> Self {
        let icon = Gd::null_arg();
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), menu: menu.consume_arg(), icon: icon.consume_arg(),
        }
    }
    #[inline]
    pub fn icon(self, icon: impl AsObjectArg < crate::classes::Texture2D >) -> Self {
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorContextMenuPlugin::add_context_submenu_item_full(surround_object, name, menu.cow_as_object_arg(), icon.cow_as_object_arg(),)
    }
}
#[repr(transparent)]
...
impl crate::obj::EngineEnum for ContextMenuSlot {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SCENE_TREE => "CONTEXT_SLOT_SCENE_TREE", Self::FILESYSTEM => "CONTEXT_SLOT_FILESYSTEM", Self::SCRIPT_EDITOR => "CONTEXT_SLOT_SCRIPT_EDITOR", Self::FILESYSTEM_CREATE => "CONTEXT_SLOT_FILESYSTEM_CREATE", Self::SCRIPT_EDITOR_CODE => "CONTEXT_SLOT_SCRIPT_EDITOR_CODE", Self::SCENE_TABS => "CONTEXT_SLOT_SCENE_TABS", Self::SLOT_2D_EDITOR => "CONTEXT_SLOT_2D_EDITOR", _ => self.as_str(),
        }
    }
