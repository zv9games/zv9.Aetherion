    ...
    impl PacketPeerUdp {
        pub(crate) fn bind_full(&mut self, port: i32, bind_address: CowArg < GString >, recv_buf_size: i32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "bind", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn close(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "close", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn wait(&mut self,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "wait", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_bound(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "is_bound", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn connect_to_host(&mut self, host: impl AsArg < GString >, port: i32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "connect_to_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_socket_connected(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "is_socket_connected", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_packet_ip(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "get_packet_ip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_packet_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "get_packet_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "get_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_dest_address(&mut self, host: impl AsArg < GString >, port: i32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "set_dest_address", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_broadcast_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "set_broadcast_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn join_multicast_group(&mut self, multicast_address: impl AsArg < GString >, interface_name: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "join_multicast_group", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn leave_multicast_group(&mut self, multicast_address: impl AsArg < GString >, interface_name: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PacketPeerUdp", "leave_multicast_group", self.object_ptr, self.__checked_id(), args,)
            }
        }
