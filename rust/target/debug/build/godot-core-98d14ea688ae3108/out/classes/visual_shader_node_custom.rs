...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeCustom {
        pub fn get_option_index(&self, option: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCustom", "get_option_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for VisualShaderNodeCustom {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeCustom"));
            * name
        }
