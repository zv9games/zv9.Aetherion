...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeVectorOp {
        pub fn set_operator(&mut self, op: crate::classes::visual_shader_node_vector_op::Operator,) {
            ...
            let args = (op,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10837usize);
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVectorOp {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeVectorOp"));
            * name
        }
...
impl crate::obj::EngineEnum for Operator {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::ADD => "OP_ADD", Self::SUB => "OP_SUB", Self::MUL => "OP_MUL", Self::DIV => "OP_DIV", Self::MOD => "OP_MOD", Self::POW => "OP_POW", Self::MAX => "OP_MAX", Self::MIN => "OP_MIN", Self::CROSS => "OP_CROSS", Self::ATAN2 => "OP_ATAN2", Self::REFLECT => "OP_REFLECT", Self::STEP => "OP_STEP", Self::ENUM_SIZE => "OP_ENUM_SIZE", _ => self.as_str(),
        }
    }
