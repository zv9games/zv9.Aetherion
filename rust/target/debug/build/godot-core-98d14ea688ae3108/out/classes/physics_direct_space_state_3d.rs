...
pub(super) mod re_export {
    ...
    impl PhysicsDirectSpaceState3D {
        pub(crate) fn intersect_point_full(&mut self, parameters: ObjectArg < crate::classes::PhysicsPointQueryParameters3D >, max_results: i32,) -> Array < Dictionary > {
            type CallRet = Array < Dictionary >;
            type CallParams = (ObjectArg < crate::classes::PhysicsPointQueryParameters3D >, i32,);
        ...
        #[inline]
        pub fn intersect_point(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsPointQueryParameters3D >,) -> Array < Dictionary > {
            self.intersect_point_ex(parameters,) . done()
        }
        #[inline]
        pub fn intersect_point_ex < 'a > (&'a mut self, parameters: impl AsObjectArg < crate::classes::PhysicsPointQueryParameters3D >,) -> ExIntersectPoint < 'a > {
            ExIntersectPoint::new(self, parameters,)
        }
        pub fn intersect_ray(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsRayQueryParameters3D >,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams = (ObjectArg < crate::classes::PhysicsRayQueryParameters3D >,);
        ...
        pub(crate) fn intersect_shape_full(&mut self, parameters: ObjectArg < crate::classes::PhysicsShapeQueryParameters3D >, max_results: i32,) -> Array < Dictionary > {
            type CallRet = Array < Dictionary >;
            type CallParams = (ObjectArg < crate::classes::PhysicsShapeQueryParameters3D >, i32,);
            let args = (parameters, max_results,);
            unsafe {
        ...
        #[inline]
        pub fn intersect_shape(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> Array < Dictionary > {
            self.intersect_shape_ex(parameters,) . done()
        }
        #[inline]
        pub fn intersect_shape_ex < 'a > (&'a mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> ExIntersectShape < 'a > {
            ExIntersectShape::new(self, parameters,)
        }
        pub fn cast_motion(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> PackedFloat32Array {
            type CallRet = PackedFloat32Array;
            type CallParams = (ObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,);
            let args = (parameters.as_object_arg(),);
            unsafe {
        ...
        pub(crate) fn collide_shape_full(&mut self, parameters: ObjectArg < crate::classes::PhysicsShapeQueryParameters3D >, max_results: i32,) -> Array < Vector3 > {
        ...
        #[inline]
        pub fn collide_shape(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> Array < Vector3 > {
            self.collide_shape_ex(parameters,) . done()
        }
        #[inline]
        pub fn collide_shape_ex < 'a > (&'a mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> ExCollideShape < 'a > {
            ExCollideShape::new(self, parameters,)
        }
        pub fn get_rest_info(&mut self, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams = (ObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,);
            let args = (parameters.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for PhysicsDirectSpaceState3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PhysicsDirectSpaceState3D"));
            * name
        }
...
pub struct ExIntersectPoint < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::PhysicsDirectSpaceState3D, parameters: ObjectCow < crate::classes::PhysicsPointQueryParameters3D >, max_results: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExIntersectPoint < 'a > {
    fn new(surround_object: &'a mut re_export::PhysicsDirectSpaceState3D, parameters: impl AsObjectArg < crate::classes::PhysicsPointQueryParameters3D >,) -> Self {
    ...
    pub fn done(self) -> Array < Dictionary > {
        ...
        = self;
        re_export::PhysicsDirectSpaceState3D::intersect_point_full(surround_object, parameters.cow_as_object_arg(), max_results,)
    }
}
...
pub struct ExIntersectShape < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::PhysicsDirectSpaceState3D, parameters: ObjectCow < crate::classes::PhysicsShapeQueryParameters3D >, max_results: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExIntersectShape < 'a > {
    fn new(surround_object: &'a mut re_export::PhysicsDirectSpaceState3D, parameters: impl AsObjectArg < crate::classes::PhysicsShapeQueryParameters3D >,) -> Self {
        let max_results = 32i32;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, parameters: parameters.consume_arg(), max_results: max_results,
        }
    ...
    pub fn done(self) -> Array < Dictionary > {
        ...
        = self;
        re_export::PhysicsDirectSpaceState3D::intersect_shape_full(surround_object, parameters.cow_as_object_arg(), max_results,)
    }
}
...
impl < 'a > ExCollideShape < 'a > {
    ...
    pub fn done(self) -> Array < Vector3 > {
        ...
        = self;
        re_export::PhysicsDirectSpaceState3D::collide_shape_full(surround_object, parameters.cow_as_object_arg(), max_results,)
    }
}
pub use signals::*;
mod signals {
