...
pub(super) mod re_export {
    ...
    impl AudioEffectCompressor {
        pub fn set_threshold(&mut self, threshold: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_threshold", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_threshold(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_threshold", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ratio(&mut self, ratio: f32,) {
            ...
            let args = (ratio,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(700usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_ratio", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ratio(&self,) -> f32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(701usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_ratio", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_gain(&mut self, gain: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_gain(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_attack_us(&mut self, attack_us: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_attack_us", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_attack_us(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_attack_us", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_release_ms(&mut self, release_ms: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_release_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_release_ms(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_release_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mix(&mut self, mix: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_mix", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mix(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_mix", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sidechain(&mut self, sidechain: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "set_sidechain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sidechain(&self,) -> StringName {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCompressor", "get_sidechain", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AudioEffectCompressor__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::AudioEffectCompressor;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for AudioEffectCompressor {
