...
pub(super) mod re_export {
    ...
    impl OpenXrExtensionWrapperExtension {
        pub fn get_openxr_api(&mut self,) -> Option < Gd < crate::classes::OpenXrApiExtension > > {
            type CallRet = Option < Gd < crate::classes::OpenXrApiExtension > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_servers_api() . fptr_by_index(106usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrExtensionWrapperExtension", "get_openxr_api", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn register_extension_wrapper(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrExtensionWrapperExtension", "register_extension_wrapper", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_OpenXrExtensionWrapperExtension__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::OpenXrExtensionWrapperExtension;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for OpenXrExtensionWrapperExtension {
