...
pub(super) mod re_export {
    ...
    impl BoxMesh {
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_width(&mut self, subdivide: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "set_subdivide_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_width(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "get_subdivide_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_height(&mut self, divisions: i32,) {
            type CallRet = ();
            type CallParams = (i32,);
            let args = (divisions,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1292usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "set_subdivide_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_height(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "get_subdivide_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_depth(&mut self, divisions: i32,) {
            type CallRet = ();
            type CallParams = (i32,);
            let args = (divisions,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(1294usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "set_subdivide_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_depth(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "BoxMesh", "get_subdivide_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for BoxMesh {
        type Base = crate::classes::PrimitiveMesh;
        fn class_name() -> ClassName {
            static CLASS_NAME: std::sync::OnceLock < ClassName > = std::sync::OnceLock::new();
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"BoxMesh"));
            * name
        }
        const INIT_LEVEL: crate::init::InitLevel = crate::init::InitLevel::Scene;
        
    }
    unsafe impl crate::obj::Bounds for BoxMesh {
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PrimitiveMesh > for BoxMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Mesh > for BoxMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for BoxMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for BoxMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for BoxMesh {
        
    }
    impl crate::obj::cap::GodotDefault for BoxMesh {
        fn __godot_default() -> crate::obj::Gd < Self > {
            crate::classes::construct_engine_object::< Self > ()
        }
    }
    impl std::ops::Deref for BoxMesh {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`BoxMesh`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_BoxMesh__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::BoxMesh > for $Class {
...
mod signals {
    ...
    use super::re_export::BoxMesh;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for BoxMesh {
