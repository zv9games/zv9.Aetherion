...
pub(super) mod re_export {
    ...
    impl Range {
        pub fn get_value(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_step(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_page(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_page", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_as_ratio(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "get_as_ratio", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_value(&mut self, value: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_value_no_signal(&mut self, value: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_value_no_signal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_min(&mut self, minimum: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max(&mut self, maximum: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_step(&mut self, step: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_page(&mut self, pagesize: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_page", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_as_ratio(&mut self, value: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_as_ratio", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_rounded_values(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_use_rounded_values", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_rounded_values(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "is_using_rounded_values", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_exp_ratio(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_exp_ratio", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_ratio_exp(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "is_ratio_exp", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_allow_greater(&mut self, allow: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_allow_greater", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_greater_allowed(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "is_greater_allowed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_allow_lesser(&mut self, allow: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "set_allow_lesser", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_lesser_allowed(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "is_lesser_allowed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn share(&mut self, with: impl AsObjectArg < crate::classes::Node >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "share", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn unshare(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Range", "unshare", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_Range__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::Range;
    use crate::registry::signal::TypedSignal;
    use super::*;
    #[doc = "A collection of signals for the [`Range`][crate::classes::Range] class."]
    pub struct SignalsOfRange < 'c, C: WithSignals > {
        #[doc(hidden)]
        pub(crate) __internal_obj: Option < C::__SignalObj < 'c >>,
    }
    impl < 'c, C: WithSignals > SignalsOfRange < 'c, C > {
        #[doc = "Signature: `(value: f64)`"]
        pub fn value_changed(&mut self) -> SigValueChanged < 'c, C > {
            SigValueChanged {
                typed: TypedSignal::extract(&mut self.__internal_obj, "value_changed")
            }
        }
        #[doc = "Signature: `()`"]
    ...
    type TypedSigValueChanged < 'c, C > = TypedSignal < 'c, C, (f64,) >;
    pub struct SigValueChanged < 'c, C: WithSignals > {
        typed: TypedSigValueChanged < 'c, C >,
    }
    impl < 'c, C: WithSignals > SigValueChanged < 'c, C > {
        pub fn emit(&mut self, value: f64,) {
            self.typed.emit_tuple((value,));
            
        }
    }
    impl < 'c, C: WithSignals > std::ops::Deref for SigValueChanged < 'c, C > {
        type Target = TypedSigValueChanged < 'c, C >;
        fn deref(&self) -> &Self::Target {
            &self.typed
        }
    }
    impl < C: WithSignals > std::ops::DerefMut for SigValueChanged < '_, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.typed
        }
    }
    ...
    impl < 'c, C: WithSignals > std::ops::Deref for SignalsOfRange < 'c, C > {
        type Target = < < Range as crate::obj::GodotClass > ::Base as WithSignals > ::SignalCollection < 'c, C >;
        fn deref(&self) -> &Self::Target {
            type Derived = Range;
            crate::private::signal_collection_to_base::< C, Derived > (self)
        }
    }
    impl < 'c, C: WithSignals > std::ops::DerefMut for SignalsOfRange < 'c, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            type Derived = Range;
