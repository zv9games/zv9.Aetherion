...
pub(super) mod re_export {
    ...
    impl ENetConnection {
        ...
        pub fn dtls_server_setup(&mut self, server_options: impl AsObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::TlsOptions >,);
            let args = (server_options.as_object_arg(),);
            unsafe {
        ...
        pub(crate) fn dtls_client_setup_full(&mut self, hostname: CowArg < GString >, client_options: ObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
    ...
    impl crate::obj::GodotClass for ENetConnection {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ENetConnection"));
            * name
        }
...
pub struct ExDtlsClientSetup < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::ENetConnection, hostname: CowArg < 'a, GString >, client_options: ObjectCow < crate::classes::TlsOptions >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExDtlsClientSetup < 'a > {
    fn new(surround_object: &'a mut re_export::ENetConnection, hostname: impl AsArg < GString > + 'a,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, hostname: hostname.into_arg(), client_options: client_options.consume_arg(),
        }
    }
    #[inline]
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::ENetConnection::dtls_client_setup_full(surround_object, hostname, client_options.cow_as_object_arg(),)
    }
}
#[repr(transparent)]
...
impl crate::obj::EngineEnum for CompressionMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "COMPRESS_NONE", Self::RANGE_CODER => "COMPRESS_RANGE_CODER", Self::FASTLZ => "COMPRESS_FASTLZ", Self::ZLIB => "COMPRESS_ZLIB", Self::ZSTD => "COMPRESS_ZSTD", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for EventType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::ERROR => "EVENT_ERROR", Self::NONE => "EVENT_NONE", Self::CONNECT => "EVENT_CONNECT", Self::DISCONNECT => "EVENT_DISCONNECT", Self::RECEIVE => "EVENT_RECEIVE", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for HostStatistic {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TOTAL_SENT_DATA => "HOST_TOTAL_SENT_DATA", Self::TOTAL_SENT_PACKETS => "HOST_TOTAL_SENT_PACKETS", Self::TOTAL_RECEIVED_DATA => "HOST_TOTAL_RECEIVED_DATA", Self::TOTAL_RECEIVED_PACKETS => "HOST_TOTAL_RECEIVED_PACKETS", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
