...
pub(super) mod re_export {
    ...
    impl CylinderMesh {
        pub fn set_top_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_top_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_top_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "get_top_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bottom_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_bottom_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bottom_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "get_bottom_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height(&mut self, height: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_height(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "get_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_radial_segments(&mut self, segments: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_radial_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radial_segments(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "get_radial_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rings(&mut self, rings: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rings(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "get_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_top(&mut self, cap_top: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_top(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "is_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_bottom(&mut self, cap_bottom: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "set_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_bottom(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CylinderMesh", "is_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CylinderMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"CylinderMesh"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PrimitiveMesh > for CylinderMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Mesh > for CylinderMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for CylinderMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for CylinderMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for CylinderMesh {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`CylinderMesh`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_CylinderMesh__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::CylinderMesh > for $Class {
...
mod signals {
    ...
    use super::re_export::CylinderMesh;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for CylinderMesh {
