...
pub(super) mod re_export {
    ...
    #[doc = "# Singleton\n\nThis class is a singleton. You can get the one instance using [`TextServerManager::singleton()`][TextServerManager::singleton].\n\n# Final class\n\nThis class is _final_, meaning you cannot inherit from it, and it comes without `I*` interface trait. It is still possible that other Godot classes inherit from it, but that is limited to the engine itself."]
    #[derive(Debug)]
    #[repr(C)]
    ...
    impl TextServerManager {
        pub fn singleton() -> Gd < Self > {
            unsafe {
                let __class_name = StringName::from(c"TextServerManager");
                let __object_ptr = sys::interface_fn !(global_get_singleton) (__class_name.string_sys());
                Gd::from_obj_sys(__object_ptr)
            }
        }
        pub fn add_interface(&mut self, interface: impl AsObjectArg < crate::classes::TextServer >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TextServer >,);
        ...
        pub fn remove_interface(&mut self, interface: impl AsObjectArg < crate::classes::TextServer >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TextServer >,);
            let args = (interface.as_object_arg(),);
            unsafe {
        ...
        pub fn set_primary_interface(&mut self, index: impl AsObjectArg < crate::classes::TextServer >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TextServer >,);
            let args = (index.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for TextServerManager {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TextServerManager"));
            * name
        }
