...
pub(super) mod re_export {
    ...
    impl JsonRpc {
        pub fn set_scope(&mut self, scope: impl AsArg < GString >, target: impl AsObjectArg < crate::classes::Object >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Object >,);
            let args = (scope.into_arg(), target.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4728usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "JsonRpc", "set_scope", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for JsonRpc {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"JSONRPC"));
            * name
        }
