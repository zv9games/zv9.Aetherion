...
pub(super) mod re_export {
    ...
    impl OpenXrActionMap {
        pub fn set_action_sets(&mut self, action_sets: &VariantArray,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "set_action_sets", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_action_sets(&self,) -> VariantArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_action_sets", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_action_set_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_action_set_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_action_set(&self, name: impl AsArg < GString >,) -> Option < Gd < crate::classes::OpenXrActionSet > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "find_action_set", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_action_set(&self, idx: i32,) -> Option < Gd < crate::classes::OpenXrActionSet > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_action_set", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_action_set(&mut self, action_set: impl AsObjectArg < crate::classes::OpenXrActionSet >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrActionSet >,);
            let args = (action_set.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6035usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "add_action_set", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_action_set(&mut self, action_set: impl AsObjectArg < crate::classes::OpenXrActionSet >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrActionSet >,);
            let args = (action_set.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6036usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "remove_action_set", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_interaction_profiles(&mut self, interaction_profiles: &VariantArray,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "set_interaction_profiles", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_interaction_profiles(&self,) -> VariantArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_interaction_profiles", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_interaction_profile_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_interaction_profile_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_interaction_profile(&self, name: impl AsArg < GString >,) -> Option < Gd < crate::classes::OpenXrInteractionProfile > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "find_interaction_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_interaction_profile(&self, idx: i32,) -> Option < Gd < crate::classes::OpenXrInteractionProfile > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "get_interaction_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_interaction_profile(&mut self, interaction_profile: impl AsObjectArg < crate::classes::OpenXrInteractionProfile >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrInteractionProfile >,);
            let args = (interaction_profile.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6042usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "add_interaction_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_interaction_profile(&mut self, interaction_profile: impl AsObjectArg < crate::classes::OpenXrInteractionProfile >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrInteractionProfile >,);
            let args = (interaction_profile.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6043usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "remove_interaction_profile", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_default_action_sets(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrActionMap", "create_default_action_sets", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for OpenXrActionMap {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"OpenXRActionMap"));
            * name
        }
