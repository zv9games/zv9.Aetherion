...
pub(super) mod re_export {
    ...
    impl PhysicalSkyMaterial {
        pub fn set_rayleigh_coefficient(&mut self, rayleigh: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_rayleigh_coefficient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rayleigh_coefficient(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_rayleigh_coefficient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rayleigh_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_rayleigh_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rayleigh_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_rayleigh_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mie_coefficient(&mut self, mie: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_mie_coefficient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mie_coefficient(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_mie_coefficient", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mie_eccentricity(&mut self, eccentricity: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_mie_eccentricity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mie_eccentricity(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_mie_eccentricity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mie_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_mie_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mie_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_mie_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_turbidity(&mut self, turbidity: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_turbidity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_turbidity(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_turbidity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sun_disk_scale(&mut self, scale: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_sun_disk_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sun_disk_scale(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_sun_disk_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ground_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_ground_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ground_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_ground_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_energy_multiplier(&mut self, multiplier: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_energy_multiplier", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_energy_multiplier(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_energy_multiplier", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_debanding(&mut self, use_debanding: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_use_debanding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_use_debanding(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_use_debanding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_night_sky(&mut self, night_sky: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "set_night_sky", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_night_sky(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalSkyMaterial", "get_night_sky", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PhysicalSkyMaterial__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PhysicalSkyMaterial;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for PhysicalSkyMaterial {
