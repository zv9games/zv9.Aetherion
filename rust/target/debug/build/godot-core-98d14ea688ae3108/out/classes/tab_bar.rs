...
pub(super) mod re_export {
    ...
    impl TabBar {
        ...
        pub(crate) fn add_tab_full(&mut self, title: CowArg < GString >, icon: ObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Texture2D >,);
            let args = (title, icon,);
            unsafe {
    ...
    impl crate::obj::GodotClass for TabBar {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TabBar"));
            * name
        }
...
pub struct ExAddTab < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::TabBar, title: CowArg < 'a, GString >, icon: ObjectCow < crate::classes::Texture2D >,
}
...
impl < 'a > ExAddTab < 'a > {
    fn new(surround_object: &'a mut re_export::TabBar,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, title: CowArg::Owned(title), icon: icon.consume_arg(),
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::TabBar::add_tab_full(surround_object, title, icon.cow_as_object_arg(),)
    }
}
#[repr(transparent)]
...
impl crate::obj::EngineEnum for AlignmentMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LEFT => "ALIGNMENT_LEFT", Self::CENTER => "ALIGNMENT_CENTER", Self::RIGHT => "ALIGNMENT_RIGHT", Self::MAX => "ALIGNMENT_MAX", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for CloseButtonDisplayPolicy {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SHOW_NEVER => "CLOSE_BUTTON_SHOW_NEVER", Self::SHOW_ACTIVE_ONLY => "CLOSE_BUTTON_SHOW_ACTIVE_ONLY", Self::SHOW_ALWAYS => "CLOSE_BUTTON_SHOW_ALWAYS", Self::MAX => "CLOSE_BUTTON_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
