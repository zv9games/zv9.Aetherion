...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for Generic6DofJoint3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Generic6DOFJoint3D"));
            * name
        }
