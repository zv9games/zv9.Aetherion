...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for LookAtModifier3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"LookAtModifier3D"));
            * name
        }
...
impl crate::obj::EngineEnum for OriginFrom {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SELF => "ORIGIN_FROM_SELF", Self::SPECIFIC_BONE => "ORIGIN_FROM_SPECIFIC_BONE", Self::EXTERNAL_NODE => "ORIGIN_FROM_EXTERNAL_NODE", _ => self.as_str(),
        }
    }
