...
pub(super) mod re_export {
    ...
    impl TextServer {
        ...
        pub fn font_set_texture_image(&mut self, font_rid: Rid, size: Vector2i, texture_index: i64, image: impl AsObjectArg < crate::classes::Image >,) {
            type CallRet = ();
            type CallParams = (Rid, Vector2i, i64, ObjectArg < crate::classes::Image >,);
        ...
        pub(crate) fn font_draw_glyph_full(&self, font_rid: Rid, canvas: Rid, size: i64, pos: Vector2, index: i64, color: Color,) {
            type CallRet = ();
            type CallParams = (Rid, Rid, i64, Vector2, i64, Color,);
        ...
        pub(crate) fn font_draw_glyph_outline_full(&self, font_rid: Rid, canvas: Rid, size: i64, outline_size: i64, pos: Vector2, index: i64, color: Color,) {
            type CallRet = ();
            type CallParams = (Rid, Rid, i64, i64, Vector2, i64, Color,);
        ...
        pub(crate) fn shaped_text_draw_full(&self, shaped: Rid, canvas: Rid, pos: Vector2, clip_l: f64, clip_r: f64, color: Color,) {
            type CallRet = ();
            type CallParams = (Rid, Rid, Vector2, f64, f64, Color,);
        ...
        pub(crate) fn shaped_text_draw_outline_full(&self, shaped: Rid, canvas: Rid, pos: Vector2, clip_l: f64, clip_r: f64, outline_size: i64, color: Color,) {
            type CallRet = ();
            type CallParams = (Rid, Rid, Vector2, f64, f64, i64, Color,);
...
impl crate::obj::EngineEnum for OverrunBehavior {
    ...
    fn values() -> &'static[Self] {
        &[OverrunBehavior::NO_TRIMMING, OverrunBehavior::TRIM_CHAR, OverrunBehavior::TRIM_WORD, OverrunBehavior::TRIM_ELLIPSIS, OverrunBehavior::TRIM_WORD_ELLIPSIS]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < OverrunBehavior >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("NO_TRIMMING", "OVERRUN_NO_TRIMMING", OverrunBehavior::NO_TRIMMING), crate::meta::inspect::EnumConstant::new("TRIM_CHAR", "OVERRUN_TRIM_CHAR", OverrunBehavior::TRIM_CHAR), crate::meta::inspect::EnumConstant::new("TRIM_WORD", "OVERRUN_TRIM_WORD", OverrunBehavior::TRIM_WORD), crate::meta::inspect::EnumConstant::new("TRIM_ELLIPSIS", "OVERRUN_TRIM_ELLIPSIS", OverrunBehavior::TRIM_ELLIPSIS), crate::meta::inspect::EnumConstant::new("TRIM_WORD_ELLIPSIS", "OVERRUN_TRIM_WORD_ELLIPSIS", OverrunBehavior::TRIM_WORD_ELLIPSIS)]
        }
    }
}
