...
pub(super) mod re_export {
    ...
    pub trait IEditorResourceTooltipPlugin: crate::obj::GodotClass < Base = EditorResourceTooltipPlugin > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        fn make_tooltip_for_path(&self, path: GString, metadata: Dictionary, base: Option < Gd < crate::classes::Control > >,) -> Option < Gd < crate::classes::Control > > {
            unimplemented !()
        }
    }
    impl EditorResourceTooltipPlugin {
        pub fn request_thumbnail(&self, path: impl AsArg < GString >, control: impl AsObjectArg < crate::classes::TextureRect >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::TextureRect >,);
            let args = (path.into_arg(), control.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(348usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorResourceTooltipPlugin", "request_thumbnail", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorResourceTooltipPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorResourceTooltipPlugin"));
            * name
        }
