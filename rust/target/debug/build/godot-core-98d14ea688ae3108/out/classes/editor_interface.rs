...
pub(super) mod re_export {
    ...
    impl EditorInterface {
        ...
        pub(crate) fn popup_dialog_full(&mut self, dialog: ObjectArg < crate::classes::Window >, rect: Rect2i,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Window >, Rect2i,);
        ...
        pub(crate) fn popup_dialog_centered_full(&mut self, dialog: ObjectArg < crate::classes::Window >, minsize: Vector2i,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Window >, Vector2i,);
        ...
        pub(crate) fn popup_dialog_centered_ratio_full(&mut self, dialog: ObjectArg < crate::classes::Window >, ratio: f32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Window >, f32,);
        ...
        pub(crate) fn popup_dialog_centered_clamped_full(&mut self, dialog: ObjectArg < crate::classes::Window >, minsize: Vector2i, fallback_ratio: f32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Window >, Vector2i, f32,);
        ...
        pub(crate) fn popup_node_selector_full(&mut self, callback: RefArg < Callable >, valid_types: RefArg < Array < StringName > >, current_value: ObjectArg < crate::classes::Node >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (RefArg < 'a0, Callable >, RefArg < 'a1, Array < StringName > >, ObjectArg < crate::classes::Node >,);
        ...
        pub(crate) fn popup_property_selector_full(&mut self, object: ObjectArg < crate::classes::Object >, callback: RefArg < Callable >, type_filter: RefArg < PackedInt32Array >, current_value: CowArg < GString >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, 'a2, > = (ObjectArg < crate::classes::Object >, RefArg < 'a0, Callable >, RefArg < 'a1, PackedInt32Array >, CowArg < 'a2, GString >,);
        ...
        pub(crate) fn popup_method_selector_full(&mut self, object: ObjectArg < crate::classes::Object >, callback: RefArg < Callable >, current_value: CowArg < GString >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::Object >, RefArg < 'a0, Callable >, CowArg < 'a1, GString >,);
        ...
        #[inline]
        pub fn popup_method_selector(&mut self, object: impl AsObjectArg < crate::classes::Object >, callback: &Callable,) {
            self.popup_method_selector_ex(object, callback,) . done()
        }
        #[inline]
        pub fn popup_method_selector_ex < 'a > (&'a mut self, object: impl AsObjectArg < crate::classes::Object >, callback: &'a Callable,) -> ExPopupMethodSelector < 'a > {
        ...
        pub(crate) fn inspect_object_full(&mut self, object: ObjectArg < crate::classes::Object >, for_property: CowArg < GString >, inspector_only: bool,) {
            type CallRet = ();
            type CallParams < 'a0, > = (ObjectArg < crate::classes::Object >, CowArg < 'a0, GString >, bool,);
        ...
        pub(crate) fn edit_script_full(&mut self, script: ObjectArg < crate::classes::Script >, line: i32, column: i32, grab_focus: bool,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Script >, i32, i32, bool,);
...
pub struct ExPopupNodeSelector < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorInterface, callback: CowArg < 'a, Callable >, valid_types: CowArg < 'a, Array < StringName > >, current_value: ObjectCow < crate::classes::Node >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExPopupNodeSelector < 'a > {
    fn new(surround_object: &'a mut re_export::EditorInterface, callback: &'a Callable,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, callback: CowArg::Borrowed(callback), valid_types: CowArg::Owned(valid_types), current_value: current_value.consume_arg(),
        }
    }
    #[inline]
    ...
    #[inline]
    pub fn current_value(self, current_value: impl AsObjectArg < crate::classes::Node >) -> Self {
        Self {
            current_value: current_value.consume_arg(), .. self
        }
    }
    #[inline]
    pub fn done(self) {
        ...
        = self;
        re_export::EditorInterface::popup_node_selector_full(surround_object, callback.cow_as_arg(), valid_types.cow_as_arg(), current_value.cow_as_object_arg(),)
    }
}
...
pub struct ExPopupPropertySelector < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorInterface, object: ObjectCow < crate::classes::Object >, callback: CowArg < 'a, Callable >, type_filter: CowArg < 'a, PackedInt32Array >, current_value: CowArg < 'a, GString >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExPopupPropertySelector < 'a > {
    fn new(surround_object: &'a mut re_export::EditorInterface, object: impl AsObjectArg < crate::classes::Object >, callback: &'a Callable,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, object: object.consume_arg(), callback: CowArg::Borrowed(callback), type_filter: CowArg::Owned(type_filter), current_value: CowArg::Owned(current_value),
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorInterface::popup_property_selector_full(surround_object, object.cow_as_object_arg(), callback.cow_as_arg(), type_filter.cow_as_arg(), current_value,)
    }
}
...
pub struct ExPopupMethodSelector < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorInterface, object: ObjectCow < crate::classes::Object >, callback: CowArg < 'a, Callable >, current_value: CowArg < 'a, GString >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExPopupMethodSelector < 'a > {
    fn new(surround_object: &'a mut re_export::EditorInterface, object: impl AsObjectArg < crate::classes::Object >, callback: &'a Callable,) -> Self {
        let current_value = GString::from("");
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, object: object.consume_arg(), callback: CowArg::Borrowed(callback), current_value: CowArg::Owned(current_value),
        }
    }
    #[inline]
    pub fn current_value(self, current_value: impl AsArg < GString > + 'a) -> Self {
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorInterface::popup_method_selector_full(surround_object, object.cow_as_object_arg(), callback.cow_as_arg(), current_value,)
    }
}
