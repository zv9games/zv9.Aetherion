...
pub(super) mod re_export {
    ...
    impl FileAccess {
        ...
        pub(crate) fn create_temp_full(mode_flags: i32, prefix: CowArg < GString >, extension: CowArg < GString >, keep: bool,) -> Option < Gd < crate::classes::FileAccess > > {
            type CallRet = Option < Gd < crate::classes::FileAccess > >;
            type CallParams < 'a0, 'a1, > = (i32, CowArg < 'a0, GString >, CowArg < 'a1, GString >, bool,);
        ...
        #[inline]
        pub fn create_temp(mode_flags: i32,) -> Option < Gd < crate::classes::FileAccess > > {
...
pub struct ExCreateTemp < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, mode_flags: i32, prefix: CowArg < 'a, GString >, extension: CowArg < 'a, GString >, keep: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateTemp < 'a > {
    fn new(mode_flags: i32,) -> Self {
...
impl crate::obj::EngineEnum for ModeFlags {
    ...
    fn values() -> &'static[Self] {
        &[ModeFlags::READ, ModeFlags::WRITE, ModeFlags::READ_WRITE, ModeFlags::WRITE_READ]
    }
