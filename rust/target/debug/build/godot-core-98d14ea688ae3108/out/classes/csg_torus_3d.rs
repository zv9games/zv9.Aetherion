...
pub(super) mod re_export {
    ...
    impl CsgTorus3D {
        pub fn set_inner_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inner_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_outer_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_outer_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sides(&mut self, sides: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_sides", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sides(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_sides", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ring_sides(&mut self, sides: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_ring_sides", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ring_sides(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_ring_sides", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_material(&mut self, material: impl AsObjectArg < crate::classes::Material >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_material(&self,) -> Option < Gd < crate::classes::Material > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_smooth_faces(&mut self, smooth_faces: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "set_smooth_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_smooth_faces(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CsgTorus3D", "get_smooth_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for CsgTorus3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"CSGTorus3D"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::CsgPrimitive3D > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CsgShape3D > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::GeometryInstance3D > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::VisualInstance3D > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node3D > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for CsgTorus3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for CsgTorus3D {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`CsgTorus3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_CsgTorus3D__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::CsgTorus3D > for $Class {
...
mod signals {
    ...
    use super::re_export::CsgTorus3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::node_3d::SignalsOfNode3D;
    impl WithSignals for CsgTorus3D {
