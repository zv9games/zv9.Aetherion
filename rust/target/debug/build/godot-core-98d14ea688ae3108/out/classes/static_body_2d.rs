...
pub(super) mod re_export {
    ...
    impl StaticBody2D {
        pub fn set_constant_linear_velocity(&mut self, vel: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "set_constant_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_constant_angular_velocity(&mut self, vel: f32,) {
            type CallRet = ();
            type CallParams = (f32,);
            let args = (vel,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8533usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "set_constant_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_constant_linear_velocity(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "get_constant_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_constant_angular_velocity(&self,) -> f32 {
            type CallRet = f32;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8535usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "get_constant_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_physics_material_override(&mut self, physics_material_override: impl AsObjectArg < crate::classes::PhysicsMaterial >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::PhysicsMaterial >,);
            let args = (physics_material_override.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8536usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "set_physics_material_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_physics_material_override(&self,) -> Option < Gd < crate::classes::PhysicsMaterial > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody2D", "get_physics_material_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for StaticBody2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"StaticBody2D"));
            * name
        }
        const INIT_LEVEL: crate::init::InitLevel = crate::init::InitLevel::Scene;
        
    }
    unsafe impl crate::obj::Bounds for StaticBody2D {
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PhysicsBody2D > for StaticBody2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CollisionObject2D > for StaticBody2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node2D > for StaticBody2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CanvasItem > for StaticBody2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for StaticBody2D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for StaticBody2D {
        
    }
    impl crate::obj::cap::GodotDefault for StaticBody2D {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`StaticBody2D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_StaticBody2D__ensure_class_exists {
        ($Class: ident) => {
