...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeIntParameter {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeIntParameter"));
            * name
        }
...
impl crate::obj::EngineEnum for Hint {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "HINT_NONE", Self::RANGE => "HINT_RANGE", Self::RANGE_STEP => "HINT_RANGE_STEP", Self::ENUM => "HINT_ENUM", Self::MAX => "HINT_MAX", _ => self.as_str(),
        }
    }
