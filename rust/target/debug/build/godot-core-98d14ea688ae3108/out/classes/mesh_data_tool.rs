    ...
    impl MeshDataTool {
        pub fn clear(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "clear", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_from_surface(&mut self, mesh: impl AsObjectArg < crate::classes::ArrayMesh >, surface: i32,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::ArrayMesh >, i32,);
            let args = (mesh.as_object_arg(), surface,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5315usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "create_from_surface", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn commit_to_surface_full(&mut self, mesh: ObjectArg < crate::classes::ArrayMesh >, compression_flags: u64,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::ArrayMesh >, u64,);
            let args = (mesh, compression_flags,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5316usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "commit_to_surface", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_format(&self,) -> u64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_format", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edge_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_edge_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_face_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_face_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex(&mut self, idx: i32, vertex: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex(&self, idx: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_normal(&mut self, idx: i32, normal: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_normal(&self, idx: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_tangent(&mut self, idx: i32, tangent: Plane,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_tangent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_tangent(&self, idx: i32,) -> Plane {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_tangent", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_uv(&mut self, idx: i32, uv: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_uv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_uv(&self, idx: i32,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_uv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_uv2(&mut self, idx: i32, uv2: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_uv2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_uv2(&self, idx: i32,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_uv2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_color(&mut self, idx: i32, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_color(&self, idx: i32,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_bones(&mut self, idx: i32, bones: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_bones", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_bones(&self, idx: i32,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_bones", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_weights(&mut self, idx: i32, weights: &PackedFloat32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_weights", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_weights(&self, idx: i32,) -> PackedFloat32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_weights", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_meta(&mut self, idx: i32, meta: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_vertex_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_meta(&self, idx: i32,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_edges(&self, idx: i32,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_edges", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_faces(&self, idx: i32,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_vertex_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edge_vertex(&self, idx: i32, vertex: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_edge_vertex", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edge_faces(&self, idx: i32,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_edge_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_edge_meta(&mut self, idx: i32, meta: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_edge_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edge_meta(&self, idx: i32,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_edge_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_face_vertex(&self, idx: i32, vertex: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_face_vertex", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_face_edge(&self, idx: i32, edge: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_face_edge", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_face_meta(&mut self, idx: i32, meta: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_face_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_face_meta(&self, idx: i32,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_face_meta", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_face_normal(&self, idx: i32,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_face_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_material(&mut self, material: impl AsObjectArg < crate::classes::Material >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Material >,);
            let args = (material.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5350usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "set_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_material(&self,) -> Option < Gd < crate::classes::Material > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshDataTool", "get_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
