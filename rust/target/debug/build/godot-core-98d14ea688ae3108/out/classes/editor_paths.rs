...
pub(super) mod re_export {
    ...
    impl EditorPaths {
        pub fn get_data_dir(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "get_data_dir", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_config_dir(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "get_config_dir", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cache_dir(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "get_cache_dir", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_self_contained(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "is_self_contained", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_self_contained_file(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "get_self_contained_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_project_settings_dir(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorPaths", "get_project_settings_dir", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorPaths {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorPaths"));
            * name
        }
