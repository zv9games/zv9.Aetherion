...
pub(super) mod re_export {
    ...
    impl PhysicalBoneSimulator3D {
        pub fn is_simulating_physics(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalBoneSimulator3D", "is_simulating_physics", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn physical_bones_stop_simulation(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalBoneSimulator3D", "physical_bones_stop_simulation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn physical_bones_start_simulation_full(&mut self, bones: RefArg < Array < StringName > >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalBoneSimulator3D", "physical_bones_start_simulation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn physical_bones_add_collision_exception(&mut self, exception: Rid,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalBoneSimulator3D", "physical_bones_add_collision_exception", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn physical_bones_remove_collision_exception(&mut self, exception: Rid,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PhysicalBoneSimulator3D", "physical_bones_remove_collision_exception", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PhysicalBoneSimulator3D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PhysicalBoneSimulator3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::skeleton_modifier_3d::SignalsOfSkeletonModifier3D;
    impl WithSignals for PhysicalBoneSimulator3D {
