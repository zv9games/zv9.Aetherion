...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeCubemap {
        pub fn set_source(&mut self, value: crate::classes::visual_shader_node_cubemap::Source,) {
            type CallRet = ();
            type CallParams = (crate::classes::visual_shader_node_cubemap::Source,);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10633usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "set_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_source(&self,) -> crate::classes::visual_shader_node_cubemap::Source {
            type CallRet = crate::classes::visual_shader_node_cubemap::Source;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10634usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "get_source", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cube_map(&mut self, value: impl AsObjectArg < crate::classes::TextureLayered >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TextureLayered >,);
            let args = (value.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10635usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "set_cube_map", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cube_map(&self,) -> Option < Gd < crate::classes::TextureLayered > > {
            type CallRet = Option < Gd < crate::classes::TextureLayered > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10636usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "get_cube_map", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_type(&mut self, value: crate::classes::visual_shader_node_cubemap::TextureType,) {
            type CallRet = ();
            type CallParams = (crate::classes::visual_shader_node_cubemap::TextureType,);
            let args = (value,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10637usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "set_texture_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_type(&self,) -> crate::classes::visual_shader_node_cubemap::TextureType {
            type CallRet = crate::classes::visual_shader_node_cubemap::TextureType;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10638usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeCubemap", "get_texture_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for VisualShaderNodeCubemap {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeCubemap"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::VisualShaderNode > for VisualShaderNodeCubemap {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for VisualShaderNodeCubemap {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for VisualShaderNodeCubemap {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for VisualShaderNodeCubemap {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`VisualShaderNodeCubemap`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_VisualShaderNodeCubemap__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::VisualShaderNodeCubemap > for $Class {
...
impl crate::obj::EngineEnum for Source {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TEXTURE => "SOURCE_TEXTURE", Self::PORT => "SOURCE_PORT", Self::MAX => "SOURCE_MAX", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for TextureType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DATA => "TYPE_DATA", Self::COLOR => "TYPE_COLOR", Self::NORMAL_MAP => "TYPE_NORMAL_MAP", Self::MAX => "TYPE_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
mod signals {
    ...
    use super::re_export::VisualShaderNodeCubemap;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for VisualShaderNodeCubemap {
