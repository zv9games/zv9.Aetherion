...
pub(super) mod re_export {
    ...
    impl OpenXrAction {
        pub fn set_localized_name(&mut self, localized_name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_localized_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_localized_name(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_localized_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_action_type(&mut self, action_type: crate::classes::open_xr_action::ActionType,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_action_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_action_type(&self,) -> crate::classes::open_xr_action::ActionType {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_action_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_toplevel_paths(&mut self, toplevel_paths: &PackedStringArray,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "set_toplevel_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_toplevel_paths(&self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OpenXrAction", "get_toplevel_paths", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for OpenXrAction {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"OpenXRAction"));
            * name
        }
...
impl crate::obj::EngineEnum for ActionType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::BOOL => "OPENXR_ACTION_BOOL", Self::FLOAT => "OPENXR_ACTION_FLOAT", Self::VECTOR2 => "OPENXR_ACTION_VECTOR2", Self::POSE => "OPENXR_ACTION_POSE", _ => self.as_str(),
        }
    }
