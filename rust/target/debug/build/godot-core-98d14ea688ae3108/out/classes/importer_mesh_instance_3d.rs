...
pub(super) mod re_export {
    ...
    impl ImporterMeshInstance3D {
        pub fn set_mesh(&mut self, mesh: impl AsObjectArg < crate::classes::ImporterMesh >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::ImporterMesh >,);
            let args = (mesh.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4406usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh(&self,) -> Option < Gd < crate::classes::ImporterMesh > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skin(&mut self, skin: impl AsObjectArg < crate::classes::Skin >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skin(&self,) -> Option < Gd < crate::classes::Skin > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skeleton_path(&mut self, skeleton_path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_skeleton_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skeleton_path(&self,) -> NodePath {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_skeleton_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_layer_mask(&mut self, layer_mask: u32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_layer_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_layer_mask(&self,) -> u32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_layer_mask", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cast_shadows_setting(&mut self, shadow_casting_setting: crate::classes::geometry_instance_3d::ShadowCastingSetting,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_cast_shadows_setting", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cast_shadows_setting(&self,) -> crate::classes::geometry_instance_3d::ShadowCastingSetting {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_cast_shadows_setting", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visibility_range_end_margin(&mut self, distance: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_visibility_range_end_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_visibility_range_end_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_visibility_range_end_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visibility_range_end(&mut self, distance: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_visibility_range_end", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_visibility_range_end(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_visibility_range_end", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visibility_range_begin_margin(&mut self, distance: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_visibility_range_begin_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_visibility_range_begin_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_visibility_range_begin_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visibility_range_begin(&mut self, distance: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_visibility_range_begin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_visibility_range_begin(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_visibility_range_begin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visibility_range_fade_mode(&mut self, mode: crate::classes::geometry_instance_3d::VisibilityRangeFadeMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "set_visibility_range_fade_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_visibility_range_fade_mode(&self,) -> crate::classes::geometry_instance_3d::VisibilityRangeFadeMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ImporterMeshInstance3D", "get_visibility_range_fade_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_ImporterMeshInstance3D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::ImporterMeshInstance3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::node_3d::SignalsOfNode3D;
    impl WithSignals for ImporterMeshInstance3D {
