...
pub(super) mod re_export {
    ...
    impl ResourceImporterOggVorbis {
        pub fn load_from_buffer(stream_data: &PackedByteArray,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(429usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ResourceImporterOggVorbis", "load_from_buffer", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn load_from_file(path: impl AsArg < GString >,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(430usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ResourceImporterOggVorbis", "load_from_file", std::ptr::null_mut(), None, args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ResourceImporterOggVorbis {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ResourceImporterOggVorbis"));
            * name
        }
