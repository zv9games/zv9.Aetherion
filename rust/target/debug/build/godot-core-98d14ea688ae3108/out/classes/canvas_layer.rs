...
pub(super) mod re_export {
    ...
    impl CanvasLayer {
        pub fn set_layer(&mut self, layer: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_layer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_layer(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_layer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_visible(&mut self, visible: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_visible", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_visible(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "is_visible", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn show(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "show", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn hide(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "hide", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_transform(&mut self, transform: Transform2D,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_transform(&self,) -> Transform2D {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_final_transform(&self,) -> Transform2D {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_final_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_offset(&mut self, offset: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_offset(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rotation(&mut self, radians: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rotation(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_rotation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_scale(&mut self, scale: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_scale(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_follow_viewport(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_follow_viewport", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_following_viewport(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "is_following_viewport", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_follow_viewport_scale(&mut self, scale: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_follow_viewport_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_follow_viewport_scale(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_follow_viewport_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_custom_viewport(&mut self, viewport: impl AsObjectArg < crate::classes::Node >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "set_custom_viewport", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_custom_viewport(&self,) -> Option < Gd < crate::classes::Node > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_custom_viewport", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_canvas(&self,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasLayer", "get_canvas", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_CanvasLayer__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::CanvasLayer;
    use crate::registry::signal::TypedSignal;
    use super::*;
    #[doc = "A collection of signals for the [`CanvasLayer`][crate::classes::CanvasLayer] class."]
    pub struct SignalsOfCanvasLayer < 'c, C: WithSignals > {
        #[doc(hidden)]
        pub(crate) __internal_obj: Option < C::__SignalObj < 'c >>,
    }
    impl < 'c, C: WithSignals > SignalsOfCanvasLayer < 'c, C > {
        #[doc = "Signature: `()`"]
    ...
    impl WithSignals for CanvasLayer {
        type SignalCollection < 'c, C: WithSignals > = SignalsOfCanvasLayer < 'c, C >;
    ...
    impl < 'c, C: WithSignals > std::ops::Deref for SignalsOfCanvasLayer < 'c, C > {
        type Target = < < CanvasLayer as crate::obj::GodotClass > ::Base as WithSignals > ::SignalCollection < 'c, C >;
        fn deref(&self) -> &Self::Target {
            type Derived = CanvasLayer;
            crate::private::signal_collection_to_base::< C, Derived > (self)
        }
    }
    impl < 'c, C: WithSignals > std::ops::DerefMut for SignalsOfCanvasLayer < 'c, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            type Derived = CanvasLayer;
