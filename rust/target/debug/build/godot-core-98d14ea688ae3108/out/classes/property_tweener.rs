...
pub(super) mod re_export {
    ...
    impl PropertyTweener {
        pub fn from(&mut self, value: &Variant,) -> Option < Gd < crate::classes::PropertyTweener > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "from", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn from_current(&mut self,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6930usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "from_current", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn as_relative(&mut self,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6931usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "as_relative", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_trans(&mut self, trans: crate::classes::tween::TransitionType,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            type CallParams = (crate::classes::tween::TransitionType,);
            let args = (trans,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6932usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "set_trans", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ease(&mut self, ease: crate::classes::tween::EaseType,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            type CallParams = (crate::classes::tween::EaseType,);
            let args = (ease,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6933usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "set_ease", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_custom_interpolator(&mut self, interpolator_method: &Callable,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "set_custom_interpolator", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_delay(&mut self, delay: f64,) -> Option < Gd < crate::classes::PropertyTweener > > {
            type CallRet = Option < Gd < crate::classes::PropertyTweener > >;
            type CallParams = (f64,);
            let args = (delay,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6935usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PropertyTweener", "set_delay", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PropertyTweener {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PropertyTweener"));
            * name
        }
