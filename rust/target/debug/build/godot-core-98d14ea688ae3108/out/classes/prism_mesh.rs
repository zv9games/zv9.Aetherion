...
pub(super) mod re_export {
    ...
    impl PrismMesh {
        pub fn set_left_to_right(&mut self, left_to_right: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "set_left_to_right", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_left_to_right(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "get_left_to_right", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_width(&mut self, segments: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "set_subdivide_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_width(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "get_subdivide_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_height(&mut self, segments: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "set_subdivide_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_height(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "get_subdivide_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_subdivide_depth(&mut self, segments: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "set_subdivide_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_subdivide_depth(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrismMesh", "get_subdivide_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PrismMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PrismMesh"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PrimitiveMesh > for PrismMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Mesh > for PrismMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for PrismMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for PrismMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for PrismMesh {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`PrismMesh`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_PrismMesh__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::PrismMesh > for $Class {
...
mod signals {
    ...
    use super::re_export::PrismMesh;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for PrismMesh {
