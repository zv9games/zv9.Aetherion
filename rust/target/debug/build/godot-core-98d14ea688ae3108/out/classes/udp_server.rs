    ...
    impl UdpServer {
        pub(crate) fn listen_full(&mut self, port: u16, bind_address: CowArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "listen", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn poll(&mut self,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "poll", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_connection_available(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "is_connection_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "get_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_listening(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "is_listening", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn take_connection(&mut self,) -> Option < Gd < crate::classes::PacketPeerUdp > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "take_connection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn stop(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "stop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max_pending_connections(&mut self, max_pending_connections: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "set_max_pending_connections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max_pending_connections(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "UdpServer", "get_max_pending_connections", self.object_ptr, self.__checked_id(), args,)
            }
        }
