...
pub(super) mod re_export {
    ...
    impl PrimitiveMesh {
        pub fn set_material(&mut self, material: impl AsObjectArg < crate::classes::Material >,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6853usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "set_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_material(&self,) -> Option < Gd < crate::classes::Material > > {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6854usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh_arrays(&self,) -> VariantArray {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6855usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_mesh_arrays", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_custom_aabb(&mut self, aabb: Aabb,) {
            ...
            let args = (aabb,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6856usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "set_custom_aabb", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_custom_aabb(&self,) -> Aabb {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6857usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_custom_aabb", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_flip_faces(&mut self, flip_faces: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "set_flip_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_flip_faces(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_flip_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_add_uv2(&mut self, add_uv2: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "set_add_uv2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_add_uv2(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_add_uv2", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_uv2_padding(&mut self, uv2_padding: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "set_uv2_padding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_uv2_padding(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "get_uv2_padding", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn request_update(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PrimitiveMesh", "request_update", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for PrimitiveMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PrimitiveMesh"));
            * name
        }
