...
pub(super) mod re_export {
    ...
    impl EditorExportPlatform {
        ...
        pub(crate) fn save_pack_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, embed: bool,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, bool,);
        ...
        #[inline]
        pub fn save_pack(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> Dictionary {
            self.save_pack_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn save_pack_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExSavePack < 'a > {
            ExSavePack::new(self, preset, debug, path,)
        }
        pub fn save_zip(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >,);
            let args = (preset.as_object_arg(), debug, path.into_arg(),);
            unsafe {
        ...
        pub fn save_pack_patch(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >,);
            let args = (preset.as_object_arg(), debug, path.into_arg(),);
            unsafe {
        ...
        pub fn save_zip_patch(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >,);
            let args = (preset.as_object_arg(), debug, path.into_arg(),);
            unsafe {
        ...
        pub(crate) fn export_project_files_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, save_cb: RefArg < Callable >, shared_cb: RefArg < Callable >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, RefArg < 'a0, Callable >, RefArg < 'a1, Callable >,);
        ...
        #[inline]
        pub fn export_project_files(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, save_cb: &Callable,) -> crate::global::Error {
            self.export_project_files_ex(preset, debug, save_cb,) . done()
        }
        #[inline]
        pub fn export_project_files_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, save_cb: &'a Callable,) -> ExExportProjectFiles < 'a > {
            ExExportProjectFiles::new(self, preset, debug, save_cb,)
        }
        pub(crate) fn export_project_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, flags: crate::classes::editor_export_platform::DebugFlags,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, crate::classes::editor_export_platform::DebugFlags,);
        ...
        #[inline]
        pub fn export_project(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> crate::global::Error {
            self.export_project_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn export_project_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExExportProject < 'a > {
            ExExportProject::new(self, preset, debug, path,)
        }
        pub(crate) fn export_pack_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, flags: crate::classes::editor_export_platform::DebugFlags,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, crate::classes::editor_export_platform::DebugFlags,);
            let args = (preset, debug, path, flags,);
            unsafe {
        ...
        #[inline]
        pub fn export_pack(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> crate::global::Error {
            self.export_pack_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn export_pack_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExExportPack < 'a > {
            ExExportPack::new(self, preset, debug, path,)
        }
        pub(crate) fn export_zip_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, flags: crate::classes::editor_export_platform::DebugFlags,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, crate::classes::editor_export_platform::DebugFlags,);
            let args = (preset, debug, path, flags,);
            unsafe {
        ...
        #[inline]
        pub fn export_zip(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> crate::global::Error {
            self.export_zip_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn export_zip_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExExportZip < 'a > {
            ExExportZip::new(self, preset, debug, path,)
        }
        pub(crate) fn export_pack_patch_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, patches: RefArg < PackedStringArray >, flags: crate::classes::editor_export_platform::DebugFlags,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, RefArg < 'a1, PackedStringArray >, crate::classes::editor_export_platform::DebugFlags,);
        ...
        #[inline]
        pub fn export_pack_patch(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> crate::global::Error {
            self.export_pack_patch_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn export_pack_patch_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExExportPackPatch < 'a > {
            ExExportPackPatch::new(self, preset, debug, path,)
        }
        pub(crate) fn export_zip_patch_full(&mut self, preset: ObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < GString >, patches: RefArg < PackedStringArray >, flags: crate::classes::editor_export_platform::DebugFlags,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::EditorExportPreset >, bool, CowArg < 'a0, GString >, RefArg < 'a1, PackedStringArray >, crate::classes::editor_export_platform::DebugFlags,);
            let args = (preset, debug, path, patches, flags,);
            unsafe {
        ...
        #[inline]
        pub fn export_zip_patch(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString >,) -> crate::global::Error {
            self.export_zip_patch_ex(preset, debug, path,) . done()
        }
        #[inline]
        pub fn export_zip_patch_ex < 'a > (&'a mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> ExExportZipPatch < 'a > {
        ...
        pub fn get_internal_export_files(&mut self, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool,) -> Dictionary {
            type CallRet = Dictionary;
            type CallParams = (ObjectArg < crate::classes::EditorExportPreset >, bool,);
            let args = (preset.as_object_arg(), debug,);
            unsafe {
    ...
    impl crate::obj::GodotClass for EditorExportPlatform {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorExportPlatform"));
            * name
        }
...
pub struct ExSavePack < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorExportPlatform, preset: ObjectCow < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < 'a, GString >, embed: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExSavePack < 'a > {
    fn new(surround_object: &'a mut re_export::EditorExportPlatform, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> Self {
        let embed = false;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, preset: preset.consume_arg(), debug: debug, path: path.into_arg(), embed: embed,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> Dictionary {
        ...
        = self;
        re_export::EditorExportPlatform::save_pack_full(surround_object, preset.cow_as_object_arg(), debug, path, embed,)
    }
}
...
pub struct ExExportProjectFiles < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorExportPlatform, preset: ObjectCow < crate::classes::EditorExportPreset >, debug: bool, save_cb: CowArg < 'a, Callable >, shared_cb: CowArg < 'a, Callable >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExExportProjectFiles < 'a > {
    fn new(surround_object: &'a mut re_export::EditorExportPlatform, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, save_cb: &'a Callable,) -> Self {
        let shared_cb = Callable::invalid();
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, preset: preset.consume_arg(), debug: debug, save_cb: CowArg::Borrowed(save_cb), shared_cb: CowArg::Owned(shared_cb),
        }
    }
    #[inline]
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_project_files_full(surround_object, preset.cow_as_object_arg(), debug, save_cb.cow_as_arg(), shared_cb.cow_as_arg(),)
    }
}
...
pub struct ExExportProject < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorExportPlatform, preset: ObjectCow < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < 'a, GString >, flags: crate::classes::editor_export_platform::DebugFlags,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExExportProject < 'a > {
    fn new(surround_object: &'a mut re_export::EditorExportPlatform, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, preset: preset.consume_arg(), debug: debug, path: path.into_arg(), flags: flags,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_project_full(surround_object, preset.cow_as_object_arg(), debug, path, flags,)
    }
}
...
impl < 'a > ExExportPack < 'a > {
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_pack_full(surround_object, preset.cow_as_object_arg(), debug, path, flags,)
    }
}
...
impl < 'a > ExExportZip < 'a > {
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_zip_full(surround_object, preset.cow_as_object_arg(), debug, path, flags,)
    }
}
...
pub struct ExExportPackPatch < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorExportPlatform, preset: ObjectCow < crate::classes::EditorExportPreset >, debug: bool, path: CowArg < 'a, GString >, patches: CowArg < 'a, PackedStringArray >, flags: crate::classes::editor_export_platform::DebugFlags,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExExportPackPatch < 'a > {
    fn new(surround_object: &'a mut re_export::EditorExportPlatform, preset: impl AsObjectArg < crate::classes::EditorExportPreset >, debug: bool, path: impl AsArg < GString > + 'a,) -> Self {
        ...
        let flags = crate::obj::EngineBitfield::from_ord(0);
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, preset: preset.consume_arg(), debug: debug, path: path.into_arg(), patches: CowArg::Owned(patches), flags: flags,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_pack_patch_full(surround_object, preset.cow_as_object_arg(), debug, path, patches.cow_as_arg(), flags,)
    }
}
...
impl < 'a > ExExportZipPatch < 'a > {
    ...
    pub fn done(self) -> crate::global::Error {
        ...
        = self;
        re_export::EditorExportPlatform::export_zip_patch_full(surround_object, preset.cow_as_object_arg(), debug, path, patches.cow_as_arg(), flags,)
    }
}
...
impl crate::obj::EngineEnum for ExportMessageType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "EXPORT_MESSAGE_NONE", Self::INFO => "EXPORT_MESSAGE_INFO", Self::WARNING => "EXPORT_MESSAGE_WARNING", Self::ERROR => "EXPORT_MESSAGE_ERROR", _ => self.as_str(),
        }
    }
