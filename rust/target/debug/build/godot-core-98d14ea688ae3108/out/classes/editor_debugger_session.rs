...
pub(super) mod re_export {
    ...
    impl EditorDebuggerSession {
        ...
        pub fn add_session_tab(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            type CallRet = ();
        ...
        pub fn remove_session_tab(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Control >,);
            let args = (control.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for EditorDebuggerSession {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorDebuggerSession"));
            * name
        }
