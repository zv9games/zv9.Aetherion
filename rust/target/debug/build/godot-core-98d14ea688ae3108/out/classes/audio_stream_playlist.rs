...
pub(super) mod re_export {
    ...
    impl AudioStreamPlaylist {
        pub fn set_stream_count(&mut self, stream_count: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "set_stream_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_stream_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "get_stream_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bpm(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "get_bpm", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_list_stream(&mut self, stream_index: i32, audio_stream: impl AsObjectArg < crate::classes::AudioStream >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "set_list_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_list_stream(&self, stream_index: i32,) -> Option < Gd < crate::classes::AudioStream > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "get_list_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shuffle(&mut self, shuffle: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "set_shuffle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shuffle(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "get_shuffle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fade_time(&mut self, dec: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "set_fade_time", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fade_time(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "get_fade_time", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_loop(&mut self, loop_: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "set_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_loop(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamPlaylist", "has_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AudioStreamPlaylist__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::AudioStreamPlaylist;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::audio_stream::SignalsOfAudioStream;
    impl WithSignals for AudioStreamPlaylist {
