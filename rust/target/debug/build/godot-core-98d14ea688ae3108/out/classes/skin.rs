...
pub(super) mod re_export {
    ...
    impl Skin {
        pub fn set_bind_count(&mut self, bind_count: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "set_bind_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bind_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "get_bind_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_bind(&mut self, bone: i32, pose: Transform3D,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "add_bind", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_named_bind(&mut self, name: impl AsArg < GString >, pose: Transform3D,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, Transform3D,);
            let args = (name.into_arg(), pose,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8225usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "add_named_bind", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bind_pose(&mut self, bind_index: i32, pose: Transform3D,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "set_bind_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bind_pose(&self, bind_index: i32,) -> Transform3D {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "get_bind_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bind_name(&mut self, bind_index: i32, name: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "set_bind_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bind_name(&self, bind_index: i32,) -> StringName {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "get_bind_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bind_bone(&mut self, bind_index: i32, bone: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "set_bind_bone", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bind_bone(&self, bind_index: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "get_bind_bone", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_binds(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Skin", "clear_binds", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_Skin__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::Skin;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for Skin {
