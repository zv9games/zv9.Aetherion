...
pub(super) mod re_export {
    ...
    impl Shader {
        ...
        pub(crate) fn set_default_texture_parameter_full(&mut self, name: CowArg < StringName >, texture: ObjectArg < crate::classes::Texture >, index: i32,) {
            type CallRet = ();
            type CallParams < 'a0, > = (CowArg < 'a0, StringName >, ObjectArg < crate::classes::Texture >, i32,);
        ...
        #[inline]
        pub fn set_default_texture_parameter(&mut self, name: impl AsArg < StringName >, texture: impl AsObjectArg < crate::classes::Texture >,) {
            self.set_default_texture_parameter_ex(name, texture,) . done()
        }
        #[inline]
        pub fn set_default_texture_parameter_ex < 'a > (&'a mut self, name: impl AsArg < StringName > + 'a, texture: impl AsObjectArg < crate::classes::Texture >,) -> ExSetDefaultTextureParameter < 'a > {
    ...
    impl crate::obj::GodotClass for Shader {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Shader"));
            * name
        }
...
pub struct ExSetDefaultTextureParameter < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::Shader, name: CowArg < 'a, StringName >, texture: ObjectCow < crate::classes::Texture >, index: i32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExSetDefaultTextureParameter < 'a > {
    fn new(surround_object: &'a mut re_export::Shader, name: impl AsArg < StringName > + 'a, texture: impl AsObjectArg < crate::classes::Texture >,) -> Self {
        let index = 0i32;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, name: name.into_arg(), texture: texture.consume_arg(), index: index,
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::Shader::set_default_texture_parameter_full(surround_object, name, texture.cow_as_object_arg(), index,)
    }
}
...
impl crate::obj::EngineEnum for Mode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SPATIAL => "MODE_SPATIAL", Self::CANVAS_ITEM => "MODE_CANVAS_ITEM", Self::PARTICLES => "MODE_PARTICLES", Self::SKY => "MODE_SKY", Self::FOG => "MODE_FOG", _ => self.as_str(),
        }
    }
