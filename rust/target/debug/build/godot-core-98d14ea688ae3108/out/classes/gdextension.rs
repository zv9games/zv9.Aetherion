...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for GDExtension {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GDExtension"));
            * name
        }
...
impl crate::obj::EngineEnum for InitializationLevel {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::CORE => "INITIALIZATION_LEVEL_CORE", Self::SERVERS => "INITIALIZATION_LEVEL_SERVERS", Self::SCENE => "INITIALIZATION_LEVEL_SCENE", Self::EDITOR => "INITIALIZATION_LEVEL_EDITOR", _ => self.as_str(),
        }
    }
