...
pub(super) mod re_export {
    ...
    impl EditorToaster {
        pub(crate) fn push_toast_full(&mut self, message: CowArg < GString >, severity: crate::classes::editor_toaster::Severity, tooltip: CowArg < GString >,) {
            ...
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(393usize);
    ...
    impl crate::obj::GodotClass for EditorToaster {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorToaster"));
            * name
        }
...
impl crate::obj::EngineEnum for Severity {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::INFO => "SEVERITY_INFO", Self::WARNING => "SEVERITY_WARNING", Self::ERROR => "SEVERITY_ERROR", _ => self.as_str(),
        }
    }
