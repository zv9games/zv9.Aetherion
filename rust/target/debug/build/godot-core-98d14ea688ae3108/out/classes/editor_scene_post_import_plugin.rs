...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for EditorScenePostImportPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorScenePostImportPlugin"));
            * name
        }
...
impl crate::obj::EngineEnum for InternalImportCategory {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NODE => "INTERNAL_IMPORT_CATEGORY_NODE", Self::MESH_3D_NODE => "INTERNAL_IMPORT_CATEGORY_MESH_3D_NODE", Self::MESH => "INTERNAL_IMPORT_CATEGORY_MESH", Self::MATERIAL => "INTERNAL_IMPORT_CATEGORY_MATERIAL", Self::ANIMATION => "INTERNAL_IMPORT_CATEGORY_ANIMATION", Self::ANIMATION_NODE => "INTERNAL_IMPORT_CATEGORY_ANIMATION_NODE", Self::SKELETON_3D_NODE => "INTERNAL_IMPORT_CATEGORY_SKELETON_3D_NODE", Self::MAX => "INTERNAL_IMPORT_CATEGORY_MAX", _ => self.as_str(),
        }
    }
