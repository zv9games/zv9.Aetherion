...
pub(super) mod re_export {
    ...
    #[doc = "# Singleton\n\nThis class is a singleton. You can get the one instance using [`ThemeDb::singleton()`][ThemeDb::singleton].\n\n# Final class\n\nThis class is _final_, meaning you cannot inherit from it, and it comes without `I*` interface trait. It is still possible that other Godot classes inherit from it, but that is limited to the engine itself."]
    #[derive(Debug)]
    #[repr(C)]
    pub struct ThemeDb {
    ...
    impl ThemeDb {
        pub fn singleton() -> Gd < Self > {
            unsafe {
                let __class_name = StringName::from(c"ThemeDB");
        ...
        pub fn set_fallback_font(&mut self, font: impl AsObjectArg < crate::classes::Font >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Font >,);
        ...
        pub fn set_fallback_icon(&mut self, icon: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
        ...
        pub fn set_fallback_stylebox(&mut self, stylebox: impl AsObjectArg < crate::classes::StyleBox >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::StyleBox >,);
            let args = (stylebox.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for ThemeDb {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ThemeDB"));
            * name
        }
