...
pub(super) mod re_export {
    ...
    impl AudioEffectCapture {
        pub fn can_get_buffer(&self, frames: i32,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "can_get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer(&mut self, frames: i32,) -> PackedVector2Array {
            type CallRet = PackedVector2Array;
            type CallParams = (i32,);
            let args = (frames,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(672usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_buffer(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "clear_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffer_length(&mut self, buffer_length_seconds: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "set_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length(&mut self,) -> f32 {
            type CallRet = f32;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(675usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frames_available(&self,) -> i32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(676usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_frames_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_discarded_frames(&self,) -> i64 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(677usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_discarded_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length_frames(&self,) -> i32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(678usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_buffer_length_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pushed_frames(&self,) -> i64 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(679usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectCapture", "get_pushed_frames", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioEffectCapture {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"AudioEffectCapture"));
            * name
        }
