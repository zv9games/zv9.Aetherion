...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for GpuParticlesCollisionHeightField3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GPUParticlesCollisionHeightField3D"));
            * name
        }
...
impl crate::obj::EngineEnum for UpdateMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::WHEN_MOVED => "UPDATE_MODE_WHEN_MOVED", Self::ALWAYS => "UPDATE_MODE_ALWAYS", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
