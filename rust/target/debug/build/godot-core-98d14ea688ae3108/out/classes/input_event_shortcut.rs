...
pub(super) mod re_export {
    ...
    impl InputEventShortcut {
        pub fn set_shortcut(&mut self, shortcut: impl AsObjectArg < crate::classes::Shortcut >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Shortcut >,);
            let args = (shortcut.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4608usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventShortcut", "set_shortcut", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shortcut(&mut self,) -> Option < Gd < crate::classes::Shortcut > > {
            type CallRet = Option < Gd < crate::classes::Shortcut > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4609usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventShortcut", "get_shortcut", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for InputEventShortcut {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"InputEventShortcut"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::InputEvent > for InputEventShortcut {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for InputEventShortcut {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`InputEventShortcut`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_InputEventShortcut__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::InputEventShortcut > for $Class {
...
mod signals {
    ...
    use super::re_export::InputEventShortcut;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for InputEventShortcut {
