...
pub(super) mod re_export {
    ...
    impl GltfBufferView {
        pub fn load_buffer_view_data(&self, state: impl AsObjectArg < crate::classes::GltfState >,) -> PackedByteArray {
            type CallRet = PackedByteArray;
            type CallParams = (ObjectArg < crate::classes::GltfState >,);
            let args = (state.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3598usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "load_buffer_view_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffer(&mut self, buffer: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_buffer", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_offset(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_offset(&mut self, byte_offset: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_length(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_length(&mut self, byte_length: i32,) {
            type CallRet = ();
            type CallParams = (i32,);
            let args = (byte_length,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3604usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_byte_stride(&self,) -> i32 {
            type CallRet = i32;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3605usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_byte_stride(&mut self, byte_stride: i32,) {
            type CallRet = ();
            type CallParams = (i32,);
            let args = (byte_stride,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3606usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_byte_stride", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_indices(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_indices(&mut self, indices: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vertex_attributes(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "get_vertex_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertex_attributes(&mut self, is_attributes: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfBufferView", "set_vertex_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for GltfBufferView {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GLTFBufferView"));
            * name
        }
