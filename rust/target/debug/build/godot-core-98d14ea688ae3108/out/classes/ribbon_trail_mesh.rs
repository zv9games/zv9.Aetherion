...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for RibbonTrailMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"RibbonTrailMesh"));
            * name
        }
...
impl crate::obj::EngineEnum for Shape {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::FLAT => "SHAPE_FLAT", Self::CROSS => "SHAPE_CROSS", _ => self.as_str(),
        }
    }
