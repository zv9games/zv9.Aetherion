...
pub(super) mod re_export {
    ...
    impl ItemList {
        pub(crate) fn add_item_full(&mut self, text: CowArg < GString >, icon: ObjectArg < crate::classes::Texture2D >, selectable: bool,) -> i32 {
            type CallRet = i32;
            type CallParams < 'a0, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Texture2D >, bool,);
        ...
        pub(crate) fn add_icon_item_full(&mut self, icon: ObjectArg < crate::classes::Texture2D >, selectable: bool,) -> i32 {
            type CallRet = i32;
            type CallParams = (ObjectArg < crate::classes::Texture2D >, bool,);
...
impl crate::obj::EngineEnum for SelectMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SINGLE => "SELECT_SINGLE", Self::MULTI => "SELECT_MULTI", Self::TOGGLE => "SELECT_TOGGLE", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
