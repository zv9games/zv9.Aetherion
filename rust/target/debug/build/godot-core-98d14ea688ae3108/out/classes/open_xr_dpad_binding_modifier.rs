...
pub(super) mod re_export {
    ...
    impl OpenXrDpadBindingModifier {
        pub fn set_action_set(&mut self, action_set: impl AsObjectArg < crate::classes::OpenXrActionSet >,) {
            type CallRet = ();
    ...
    impl crate::obj::GodotClass for OpenXrDpadBindingModifier {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"OpenXRDpadBindingModifier"));
            * name
        }
