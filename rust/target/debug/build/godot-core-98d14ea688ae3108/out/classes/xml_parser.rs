...
pub(super) mod re_export {
    ...
    impl XmlParser {
        ...
        pub fn open(&mut self, file: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(11139usize);
    ...
    impl crate::obj::GodotClass for XmlParser {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"XMLParser"));
            * name
        }
...
impl crate::obj::EngineEnum for NodeType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "NODE_NONE", Self::ELEMENT => "NODE_ELEMENT", Self::ELEMENT_END => "NODE_ELEMENT_END", Self::TEXT => "NODE_TEXT", Self::COMMENT => "NODE_COMMENT", Self::CDATA => "NODE_CDATA", Self::UNKNOWN => "NODE_UNKNOWN", _ => self.as_str(),
        }
    }
