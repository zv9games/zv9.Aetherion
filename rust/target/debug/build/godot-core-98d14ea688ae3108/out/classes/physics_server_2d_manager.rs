...
pub(super) mod re_export {
    ...
    #[doc = "# Singleton\n\nThis class is a singleton. You can get the one instance using [`PhysicsServer2DManager::singleton()`][PhysicsServer2DManager::singleton].\n\n# Final class\n\nThis class is _final_, meaning you cannot inherit from it, and it comes without `I*` interface trait. It is still possible that other Godot classes inherit from it, but that is limited to the engine itself."]
    #[derive(Debug)]
    #[repr(C)]
    ...
    impl PhysicsServer2DManager {
        pub fn singleton() -> Gd < Self > {
            unsafe {
                let __class_name = StringName::from(c"PhysicsServer2DManager");
    ...
    impl crate::obj::GodotClass for PhysicsServer2DManager {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PhysicsServer2DManager"));
            * name
        }
