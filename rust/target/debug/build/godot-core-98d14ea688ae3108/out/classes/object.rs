    ...
    impl Object {
        ...
        pub fn set_script(&mut self, script: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Object", "set_script", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_script(&self,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Object", "get_script", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn connect_full(&mut self, signal: CowArg < StringName >, callable: RefArg < Callable >, flags: u32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Object", "connect", self.object_ptr, self.__checked_id(), args,)
            }
        }
...
impl crate::obj::EngineBitfield for ConnectFlags {
    ...
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < ConnectFlags >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("DEFERRED", "CONNECT_DEFERRED", ConnectFlags::DEFERRED), crate::meta::inspect::EnumConstant::new("PERSIST", "CONNECT_PERSIST", ConnectFlags::PERSIST), crate::meta::inspect::EnumConstant::new("ONE_SHOT", "CONNECT_ONE_SHOT", ConnectFlags::ONE_SHOT), crate::meta::inspect::EnumConstant::new("REFERENCE_COUNTED", "CONNECT_REFERENCE_COUNTED", ConnectFlags::REFERENCE_COUNTED)]
        }
    }
}
