...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for ResourceImporter {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ResourceImporter"));
            * name
        }
...
impl crate::obj::EngineEnum for ImportOrder {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DEFAULT => "IMPORT_ORDER_DEFAULT", Self::SCENE => "IMPORT_ORDER_SCENE", _ => self.as_str(),
        }
    }
