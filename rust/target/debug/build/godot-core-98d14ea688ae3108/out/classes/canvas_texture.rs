...
pub(super) mod re_export {
    ...
    impl CanvasTexture {
        pub fn set_diffuse_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_diffuse_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_diffuse_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_diffuse_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_normal_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_normal_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_normal_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_normal_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_specular_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_specular_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_specular_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_specular_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_specular_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_specular_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_specular_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_specular_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_specular_shininess(&mut self, shininess: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_specular_shininess", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_specular_shininess(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_specular_shininess", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_filter(&mut self, filter: crate::classes::canvas_item::TextureFilter,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_texture_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_filter(&self,) -> crate::classes::canvas_item::TextureFilter {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_texture_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_texture_repeat(&mut self, repeat: crate::classes::canvas_item::TextureRepeat,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "set_texture_repeat", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture_repeat(&self,) -> crate::classes::canvas_item::TextureRepeat {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasTexture", "get_texture_repeat", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_CanvasTexture__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::CanvasTexture;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for CanvasTexture {
