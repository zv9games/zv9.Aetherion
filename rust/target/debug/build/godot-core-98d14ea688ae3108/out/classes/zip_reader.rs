...
pub(super) mod re_export {
    ...
    impl ZipReader {
        pub fn open(&mut self, path: impl AsArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "open", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn close(&mut self,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "close", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_files(&mut self,) -> PackedStringArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "get_files", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn read_file_full(&mut self, path: CowArg < GString >, case_sensitive: bool,) -> PackedByteArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "read_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn file_exists_full(&mut self, path: CowArg < GString >, case_sensitive: bool,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ZipReader", "file_exists", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_ZipReader__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::ZipReader;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for ZipReader {
