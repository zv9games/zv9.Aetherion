...
pub(super) mod re_export {
    ...
    impl AudioStream {
        pub fn get_length(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStream", "get_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_monophonic(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStream", "is_monophonic", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn instantiate_playback(&mut self,) -> Option < Gd < crate::classes::AudioStreamPlayback > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStream", "instantiate_playback", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn can_be_sampled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStream", "can_be_sampled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_meta_stream(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStream", "is_meta_stream", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioStream {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"AudioStream"));
            * name
        }
    ...
    impl < 'c, C: WithSignals > SignalsOfAudioStream < 'c, C > {
        ...
        pub fn parameter_list_changed(&mut self) -> SigParameterListChanged < 'c, C > {
            SigParameterListChanged {
                typed: TypedSignal::extract(&mut self.__internal_obj, "parameter_list_changed")
            }
        }
    }
