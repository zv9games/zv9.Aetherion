...
pub(super) mod re_export {
    ...
    impl ParallaxLayer {
        pub fn set_motion_scale(&mut self, scale: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "set_motion_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_motion_scale(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "get_motion_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_motion_offset(&mut self, offset: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "set_motion_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_motion_offset(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "get_motion_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mirroring(&mut self, mirror: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "set_mirroring", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mirroring(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ParallaxLayer", "get_mirroring", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ParallaxLayer {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ParallaxLayer"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::Node2D > for ParallaxLayer {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CanvasItem > for ParallaxLayer {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for ParallaxLayer {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for ParallaxLayer {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ParallaxLayer`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_ParallaxLayer__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::ParallaxLayer > for $Class {
...
mod signals {
    ...
    use super::re_export::ParallaxLayer;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::canvas_item::SignalsOfCanvasItem;
    impl WithSignals for ParallaxLayer {
