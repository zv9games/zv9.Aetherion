...
pub(super) mod re_export {
    ...
    impl Control {
        ...
        pub fn force_drag(&mut self, data: &Variant, preview: impl AsObjectArg < crate::classes::Control >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (RefArg < 'a0, Variant >, ObjectArg < crate::classes::Control >,);
...
impl crate::obj::EngineEnum for FocusMode {
    ...
    fn values() -> &'static[Self] {
        &[FocusMode::NONE, FocusMode::CLICK, FocusMode::ALL]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < FocusMode >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("NONE", "FOCUS_NONE", FocusMode::NONE), crate::meta::inspect::EnumConstant::new("CLICK", "FOCUS_CLICK", FocusMode::CLICK), crate::meta::inspect::EnumConstant::new("ALL", "FOCUS_ALL", FocusMode::ALL)]
        }
    }
}
