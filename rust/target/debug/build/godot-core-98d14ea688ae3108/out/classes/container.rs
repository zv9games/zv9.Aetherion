...
pub(super) mod re_export {
    ...
    impl Container {
        ...
        pub fn fit_child_in_rect(&mut self, child: impl AsObjectArg < crate::classes::Control >, rect: Rect2,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Control >, Rect2,);
            let args = (child.as_object_arg(), rect,);
            unsafe {
    ...
    impl crate::obj::GodotClass for Container {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Container"));
            * name
        }
