...
pub(super) mod re_export {
    ...
    impl GltfLight {
        pub fn from_node(light_node: impl AsObjectArg < crate::classes::Light3D >,) -> Option < Gd < crate::classes::GltfLight > > {
            type CallRet = Option < Gd < crate::classes::GltfLight > >;
            type CallParams = (ObjectArg < crate::classes::Light3D >,);
            let args = (light_node.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3642usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "from_node", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn to_node(&self,) -> Option < Gd < crate::classes::Light3D > > {
            type CallRet = Option < Gd < crate::classes::Light3D > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3643usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "to_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn from_dictionary(dictionary: &Dictionary,) -> Option < Gd < crate::classes::GltfLight > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "from_dictionary", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn to_dictionary(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "to_dictionary", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color(&mut self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_intensity(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_intensity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_intensity(&mut self, intensity: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_intensity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_light_type(&mut self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_light_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_light_type(&mut self, light_type: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_light_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_range(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_range(&mut self, range: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_range", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inner_cone_angle(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_inner_cone_angle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_inner_cone_angle(&mut self, inner_cone_angle: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_inner_cone_angle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_outer_cone_angle(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_outer_cone_angle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_outer_cone_angle(&mut self, outer_cone_angle: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_outer_cone_angle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_additional_data(&mut self, extension_name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "get_additional_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_additional_data(&mut self, extension_name: impl AsArg < StringName >, additional_data: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfLight", "set_additional_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_GltfLight__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::GltfLight;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for GltfLight {
