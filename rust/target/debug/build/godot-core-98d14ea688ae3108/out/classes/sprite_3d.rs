...
pub(super) mod re_export {
    ...
    impl Sprite3D {
        pub fn set_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_region_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_region_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_region_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "is_region_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_region_rect(&mut self, rect: Rect2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_region_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_region_rect(&self,) -> Rect2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_region_rect", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_frame(&mut self, frame: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_frame", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frame(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_frame", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_frame_coords(&mut self, coords: Vector2i,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_frame_coords", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_frame_coords(&self,) -> Vector2i {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_frame_coords", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vframes(&mut self, vframes: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_vframes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_vframes(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_vframes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_hframes(&mut self, hframes: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "set_hframes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_hframes(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Sprite3D", "get_hframes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for Sprite3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Sprite3D"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::SpriteBase3D > for Sprite3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::GeometryInstance3D > for Sprite3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::VisualInstance3D > for Sprite3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node3D > for Sprite3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for Sprite3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for Sprite3D {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`Sprite3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_Sprite3D__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::Sprite3D > for $Class {
...
mod signals {
    ...
    use super::re_export::Sprite3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    #[doc = "A collection of signals for the [`Sprite3D`][crate::classes::Sprite3D] class."]
    pub struct SignalsOfSprite3D < 'c, C: WithSignals > {
        #[doc(hidden)]
        pub(crate) __internal_obj: Option < C::__SignalObj < 'c >>,
    }
    impl < 'c, C: WithSignals > SignalsOfSprite3D < 'c, C > {
        #[doc = "Signature: `()`"]
    ...
    impl WithSignals for Sprite3D {
        type SignalCollection < 'c, C: WithSignals > = SignalsOfSprite3D < 'c, C >;
    ...
    impl < 'c, C: WithSignals > std::ops::Deref for SignalsOfSprite3D < 'c, C > {
        type Target = < < Sprite3D as crate::obj::GodotClass > ::Base as WithSignals > ::SignalCollection < 'c, C >;
        fn deref(&self) -> &Self::Target {
            type Derived = Sprite3D;
            crate::private::signal_collection_to_base::< C, Derived > (self)
        }
    }
    impl < 'c, C: WithSignals > std::ops::DerefMut for SignalsOfSprite3D < 'c, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            type Derived = Sprite3D;
