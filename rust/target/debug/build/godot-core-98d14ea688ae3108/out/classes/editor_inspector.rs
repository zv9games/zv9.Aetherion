...
pub(super) mod re_export {
    ...
    impl EditorInspector {
        pub fn edit(&mut self, object: impl AsObjectArg < crate::classes::Object >,) {
            type CallRet = ();
        ...
        pub(crate) fn instantiate_property_editor_full(object: ObjectArg < crate::classes::Object >, type_: VariantType, path: CowArg < GString >, hint: crate::global::PropertyHint, hint_text: CowArg < GString >, usage: u32, wide: bool,) -> Option < Gd < crate::classes::EditorProperty > > {
            type CallRet = Option < Gd < crate::classes::EditorProperty > >;
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::Object >, VariantType, CowArg < 'a0, GString >, crate::global::PropertyHint, CowArg < 'a1, GString >, u32, bool,);
        ...
        #[inline]
        pub fn instantiate_property_editor(object: impl AsObjectArg < crate::classes::Object >, type_: VariantType, path: impl AsArg < GString >, hint: crate::global::PropertyHint, hint_text: impl AsArg < GString >, usage: u32,) -> Option < Gd < crate::classes::EditorProperty > > {
            Self::instantiate_property_editor_ex(object, type_, path, hint, hint_text, usage,) . done()
        }
        #[inline]
        pub fn instantiate_property_editor_ex < 'a > (object: impl AsObjectArg < crate::classes::Object >, type_: VariantType, path: impl AsArg < GString > + 'a, hint: crate::global::PropertyHint, hint_text: impl AsArg < GString > + 'a, usage: u32,) -> ExInstantiatePropertyEditor < 'a > {
    ...
    impl crate::obj::GodotClass for EditorInspector {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorInspector"));
            * name
        }
...
pub struct ExInstantiatePropertyEditor < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, object: ObjectCow < crate::classes::Object >, type_: VariantType, path: CowArg < 'a, GString >, hint: crate::global::PropertyHint, hint_text: CowArg < 'a, GString >, usage: u32, wide: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExInstantiatePropertyEditor < 'a > {
    fn new(object: impl AsObjectArg < crate::classes::Object >, type_: VariantType, path: impl AsArg < GString > + 'a, hint: crate::global::PropertyHint, hint_text: impl AsArg < GString > + 'a, usage: u32,) -> Self {
        let wide = false;
        Self {
            _phantom: std::marker::PhantomData, object: object.consume_arg(), type_: type_, path: path.into_arg(), hint: hint, hint_text: hint_text.into_arg(), usage: usage, wide: wide,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> Option < Gd < crate::classes::EditorProperty > > {
        ...
        = self;
        re_export::EditorInspector::instantiate_property_editor_full(object.cow_as_object_arg(), type_, path, hint, hint_text, usage, wide,)
    }
}
pub use signals::*;
mod signals {
