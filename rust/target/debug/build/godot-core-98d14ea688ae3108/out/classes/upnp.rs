...
pub(super) mod re_export {
    ...
    impl Upnp {
        ...
        pub fn add_device(&mut self, device: impl AsObjectArg < crate::classes::UpnpDevice >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::UpnpDevice >,);
            let args = (device.as_object_arg(),);
            unsafe {
        ...
        pub fn set_device(&mut self, index: i32, device: impl AsObjectArg < crate::classes::UpnpDevice >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::UpnpDevice >,);
            let args = (index, device.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for Upnp {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"UPNP"));
            * name
        }
...
impl crate::obj::EngineEnum for UpnpResult {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SUCCESS => "UPNP_RESULT_SUCCESS", Self::NOT_AUTHORIZED => "UPNP_RESULT_NOT_AUTHORIZED", Self::PORT_MAPPING_NOT_FOUND => "UPNP_RESULT_PORT_MAPPING_NOT_FOUND", Self::INCONSISTENT_PARAMETERS => "UPNP_RESULT_INCONSISTENT_PARAMETERS", Self::NO_SUCH_ENTRY_IN_ARRAY => "UPNP_RESULT_NO_SUCH_ENTRY_IN_ARRAY", Self::ACTION_FAILED => "UPNP_RESULT_ACTION_FAILED", Self::SRC_IP_WILDCARD_NOT_PERMITTED => "UPNP_RESULT_SRC_IP_WILDCARD_NOT_PERMITTED", Self::EXT_PORT_WILDCARD_NOT_PERMITTED => "UPNP_RESULT_EXT_PORT_WILDCARD_NOT_PERMITTED", Self::INT_PORT_WILDCARD_NOT_PERMITTED => "UPNP_RESULT_INT_PORT_WILDCARD_NOT_PERMITTED", Self::REMOTE_HOST_MUST_BE_WILDCARD => "UPNP_RESULT_REMOTE_HOST_MUST_BE_WILDCARD", Self::EXT_PORT_MUST_BE_WILDCARD => "UPNP_RESULT_EXT_PORT_MUST_BE_WILDCARD", Self::NO_PORT_MAPS_AVAILABLE => "UPNP_RESULT_NO_PORT_MAPS_AVAILABLE", Self::CONFLICT_WITH_OTHER_MECHANISM => "UPNP_RESULT_CONFLICT_WITH_OTHER_MECHANISM", Self::CONFLICT_WITH_OTHER_MAPPING => "UPNP_RESULT_CONFLICT_WITH_OTHER_MAPPING", Self::SAME_PORT_VALUES_REQUIRED => "UPNP_RESULT_SAME_PORT_VALUES_REQUIRED", Self::ONLY_PERMANENT_LEASE_SUPPORTED => "UPNP_RESULT_ONLY_PERMANENT_LEASE_SUPPORTED", Self::INVALID_GATEWAY => "UPNP_RESULT_INVALID_GATEWAY", Self::INVALID_PORT => "UPNP_RESULT_INVALID_PORT", Self::INVALID_PROTOCOL => "UPNP_RESULT_INVALID_PROTOCOL", Self::INVALID_DURATION => "UPNP_RESULT_INVALID_DURATION", Self::INVALID_ARGS => "UPNP_RESULT_INVALID_ARGS", Self::INVALID_RESPONSE => "UPNP_RESULT_INVALID_RESPONSE", Self::INVALID_PARAM => "UPNP_RESULT_INVALID_PARAM", Self::HTTP_ERROR => "UPNP_RESULT_HTTP_ERROR", Self::SOCKET_ERROR => "UPNP_RESULT_SOCKET_ERROR", Self::MEM_ALLOC_ERROR => "UPNP_RESULT_MEM_ALLOC_ERROR", Self::NO_GATEWAY => "UPNP_RESULT_NO_GATEWAY", Self::NO_DEVICES => "UPNP_RESULT_NO_DEVICES", Self::UNKNOWN_ERROR => "UPNP_RESULT_UNKNOWN_ERROR", _ => self.as_str(),
        }
    }
