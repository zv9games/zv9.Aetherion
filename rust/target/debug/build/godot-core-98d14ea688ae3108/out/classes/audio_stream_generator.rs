...
pub(super) mod re_export {
    ...
    impl AudioStreamGenerator {
        pub fn set_mix_rate(&mut self, hz: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "set_mix_rate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mix_rate(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "get_mix_rate", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mix_rate_mode(&mut self, mode: crate::classes::audio_stream_generator::AudioStreamGeneratorMixRate,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "set_mix_rate_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mix_rate_mode(&self,) -> crate::classes::audio_stream_generator::AudioStreamGeneratorMixRate {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "get_mix_rate_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_buffer_length(&mut self, seconds: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "set_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_buffer_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamGenerator", "get_buffer_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioStreamGenerator {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"AudioStreamGenerator"));
            * name
        }
...
impl crate::obj::EngineEnum for AudioStreamGeneratorMixRate {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::OUTPUT => "MIX_RATE_OUTPUT", Self::INPUT => "MIX_RATE_INPUT", Self::CUSTOM => "MIX_RATE_CUSTOM", Self::MAX => "MIX_RATE_MAX", _ => self.as_str(),
        }
    }
