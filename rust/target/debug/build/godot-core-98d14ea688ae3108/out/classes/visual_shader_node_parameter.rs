...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeParameter {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeParameter"));
            * name
        }
...
impl crate::obj::EngineEnum for Qualifier {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "QUAL_NONE", Self::GLOBAL => "QUAL_GLOBAL", Self::INSTANCE => "QUAL_INSTANCE", Self::MAX => "QUAL_MAX", _ => self.as_str(),
        }
    }
