...
pub(super) mod re_export {
    ...
    impl KinematicCollision2D {
        pub fn get_position(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_normal(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_travel(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_travel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_remainder(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_remainder", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_angle_full(&self, up_direction: Vector2,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_angle", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_depth(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_shape(&self,) -> Option < Gd < crate::classes::Object > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_local_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider(&self,) -> Option < Gd < crate::classes::Object > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider_id(&self,) -> u64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider_rid(&self,) -> Rid {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider_rid", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider_shape(&self,) -> Option < Gd < crate::classes::Object > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider_shape_index(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider_shape_index", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_collider_velocity(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "KinematicCollision2D", "get_collider_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_KinematicCollision2D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::KinematicCollision2D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for KinematicCollision2D {
