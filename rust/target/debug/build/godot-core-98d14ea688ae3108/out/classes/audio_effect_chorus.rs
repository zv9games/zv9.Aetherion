...
pub(super) mod re_export {
    ...
    impl AudioEffectChorus {
        pub fn set_voice_count(&mut self, voices: i32,) {
            ...
            let args = (voices,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(680usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_count(&self,) -> i32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(681usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_delay_ms(&mut self, voice_idx: i32, delay_ms: f32,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(682usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_delay_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_delay_ms(&self, voice_idx: i32,) -> f32 {
            ...
            let args = (voice_idx,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(683usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_delay_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_rate_hz(&mut self, voice_idx: i32, rate_hz: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_rate_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_rate_hz(&self, voice_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_rate_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_depth_ms(&mut self, voice_idx: i32, depth_ms: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_depth_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_depth_ms(&self, voice_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_depth_ms", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_level_db(&mut self, voice_idx: i32, level_db: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_level_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_level_db(&self, voice_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_level_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_cutoff_hz(&mut self, voice_idx: i32, cutoff_hz: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_cutoff_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_cutoff_hz(&self, voice_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_cutoff_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_voice_pan(&mut self, voice_idx: i32, pan: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_voice_pan", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_voice_pan(&self, voice_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_voice_pan", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_wet(&mut self, amount: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_wet", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_wet(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_wet", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_dry(&mut self, amount: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "set_dry", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_dry(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectChorus", "get_dry", self.object_ptr, self.__checked_id(), args,)
            }
        }
