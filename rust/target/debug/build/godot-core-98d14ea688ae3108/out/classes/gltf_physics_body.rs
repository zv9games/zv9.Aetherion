...
pub(super) mod re_export {
    ...
    impl GltfPhysicsBody {
        pub fn from_node(body_node: impl AsObjectArg < crate::classes::CollisionObject3D >,) -> Option < Gd < crate::classes::GltfPhysicsBody > > {
            type CallRet = Option < Gd < crate::classes::GltfPhysicsBody > >;
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "from_node", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn to_node(&self,) -> Option < Gd < crate::classes::CollisionObject3D > > {
            type CallRet = Option < Gd < crate::classes::CollisionObject3D > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3719usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "to_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn from_dictionary(dictionary: &Dictionary,) -> Option < Gd < crate::classes::GltfPhysicsBody > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "from_dictionary", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn to_dictionary(&self,) -> Dictionary {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "to_dictionary", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_body_type(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_body_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_body_type(&mut self, body_type: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_body_type", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mass(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_mass", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mass(&mut self, mass: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_mass", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_linear_velocity(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_linear_velocity(&mut self, linear_velocity: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_angular_velocity(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_angular_velocity(&mut self, angular_velocity: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_center_of_mass(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_center_of_mass", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_center_of_mass(&mut self, center_of_mass: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_center_of_mass", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inertia_diagonal(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_inertia_diagonal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_inertia_diagonal(&mut self, inertia_diagonal: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_inertia_diagonal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inertia_orientation(&self,) -> Quaternion {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_inertia_orientation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_inertia_orientation(&mut self, inertia_orientation: Quaternion,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_inertia_orientation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inertia_tensor(&self,) -> Basis {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "get_inertia_tensor", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_inertia_tensor(&mut self, inertia_tensor: Basis,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfPhysicsBody", "set_inertia_tensor", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_GltfPhysicsBody__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::GltfPhysicsBody;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for GltfPhysicsBody {
