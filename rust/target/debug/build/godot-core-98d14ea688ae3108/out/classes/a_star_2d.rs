    ...
    impl AStar2D {
        pub fn get_available_point_id(&self,) -> i64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_available_point_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_point_full(&mut self, id: i64, position: Vector2, weight_scale: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "add_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_point_position(&self, id: i64,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_point_position(&mut self, id: i64, position: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "set_point_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_weight_scale(&self, id: i64,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_weight_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_point_weight_scale(&mut self, id: i64, weight_scale: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "set_point_weight_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_point(&mut self, id: i64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "remove_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_point(&self, id: i64,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "has_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_connections(&mut self, id: i64,) -> PackedInt64Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_connections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_ids(&mut self,) -> PackedInt64Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_ids", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn set_point_disabled_full(&mut self, id: i64, disabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "set_point_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn is_point_disabled(&self, id: i64,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "is_point_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn connect_points_full(&mut self, id: i64, to_id: i64, bidirectional: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "connect_points", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn disconnect_points_full(&mut self, id: i64, to_id: i64, bidirectional: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "disconnect_points", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn are_points_connected_full(&self, id: i64, to_id: i64, bidirectional: bool,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "are_points_connected", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_point_count(&self,) -> i64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_capacity(&self,) -> i64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_capacity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn reserve_space(&mut self, num_nodes: i64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "reserve_space", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "clear", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_closest_point_full(&self, to_position: Vector2, include_disabled: bool,) -> i64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_closest_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_closest_position_in_segment(&self, to_position: Vector2,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_closest_position_in_segment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn get_point_path_full(&mut self, from_id: i64, to_id: i64, allow_partial_path: bool,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_point_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_id_path_full(&mut self, from_id: i64, to_id: i64, allow_partial_path: bool,) -> PackedInt64Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AStar2D", "get_id_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
