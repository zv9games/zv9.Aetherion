...
pub(super) mod re_export {
    ...
    impl ScriptEditorBase {
        ...
        pub fn add_syntax_highlighter(&mut self, highlighter: impl AsObjectArg < crate::classes::EditorSyntaxHighlighter >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorSyntaxHighlighter >,);
            let args = (highlighter.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for ScriptEditorBase {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ScriptEditorBase"));
            * name
        }
