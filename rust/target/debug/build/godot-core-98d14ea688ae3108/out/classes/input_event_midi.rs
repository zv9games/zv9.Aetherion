...
pub(super) mod re_export {
    ...
    impl InputEventMidi {
        pub fn set_channel(&mut self, channel: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_channel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_channel(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_channel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_message(&mut self, message: crate::global::MidiMessage,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_message(&self,) -> crate::global::MidiMessage {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_message", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pitch(&mut self, pitch: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_pitch", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pitch(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_pitch", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_velocity(&mut self, velocity: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_velocity(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_instrument(&mut self, instrument: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_instrument", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_instrument(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_instrument", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pressure(&mut self, pressure: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_pressure", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pressure(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_pressure", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_controller_number(&mut self, controller_number: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_controller_number", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_controller_number(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_controller_number", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_controller_value(&mut self, controller_value: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "set_controller_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_controller_value(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "InputEventMidi", "get_controller_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for InputEventMidi {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"InputEventMIDI"));
            * name
        }
