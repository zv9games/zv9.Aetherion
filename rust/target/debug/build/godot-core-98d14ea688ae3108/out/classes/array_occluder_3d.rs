...
pub(super) mod re_export {
    ...
    impl ArrayOccluder3D {
        pub fn set_arrays(&mut self, vertices: &PackedVector3Array, indices: &PackedInt32Array,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (RefArg < 'a0, PackedVector3Array >, RefArg < 'a1, PackedInt32Array >,);
            let args = (RefArg::new(vertices), RefArg::new(indices),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(648usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ArrayOccluder3D", "set_arrays", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_vertices(&mut self, vertices: &PackedVector3Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ArrayOccluder3D", "set_vertices", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_indices(&mut self, indices: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ArrayOccluder3D", "set_indices", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_ArrayOccluder3D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::ArrayOccluder3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for ArrayOccluder3D {
