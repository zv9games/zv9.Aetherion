...
pub(super) mod re_export {
    ...
    impl DtlsServer {
        pub fn setup(&mut self, server_options: impl AsObjectArg < crate::classes::TlsOptions >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "DtlsServer", "setup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn take_connection(&mut self, udp_peer: impl AsObjectArg < crate::classes::PacketPeerUdp >,) -> Option < Gd < crate::classes::PacketPeerDtls > > {
            type CallRet = Option < Gd < crate::classes::PacketPeerDtls > >;
            type CallParams = (ObjectArg < crate::classes::PacketPeerUdp >,);
            let args = (udp_peer.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(2663usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "DtlsServer", "take_connection", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for DtlsServer {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"DTLSServer"));
            * name
        }
