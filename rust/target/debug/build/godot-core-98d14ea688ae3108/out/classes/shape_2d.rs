...
pub(super) mod re_export {
    ...
    impl Shape2D {
        ...
        pub fn collide(&mut self, local_xform: Transform2D, with_shape: impl AsObjectArg < crate::classes::Shape2D >, shape_xform: Transform2D,) -> bool {
            type CallRet = bool;
            type CallParams = (Transform2D, ObjectArg < crate::classes::Shape2D >, Transform2D,);
            let args = (local_xform, with_shape.as_object_arg(), shape_xform,);
            unsafe {
        ...
        pub fn collide_with_motion(&mut self, local_xform: Transform2D, local_motion: Vector2, with_shape: impl AsObjectArg < crate::classes::Shape2D >, shape_xform: Transform2D, shape_motion: Vector2,) -> bool {
            type CallRet = bool;
            type CallParams = (Transform2D, Vector2, ObjectArg < crate::classes::Shape2D >, Transform2D, Vector2,);
            let args = (local_xform, local_motion, with_shape.as_object_arg(), shape_xform, shape_motion,);
            unsafe {
        ...
        pub fn collide_and_get_contacts(&mut self, local_xform: Transform2D, with_shape: impl AsObjectArg < crate::classes::Shape2D >, shape_xform: Transform2D,) -> PackedVector2Array {
        ...
        pub fn collide_with_motion_and_get_contacts(&mut self, local_xform: Transform2D, local_motion: Vector2, with_shape: impl AsObjectArg < crate::classes::Shape2D >, shape_xform: Transform2D, shape_motion: Vector2,) -> PackedVector2Array {
            type CallRet = PackedVector2Array;
            type CallParams = (Transform2D, Vector2, ObjectArg < crate::classes::Shape2D >, Transform2D, Vector2,);
            let args = (local_xform, local_motion, with_shape.as_object_arg(), shape_xform, shape_motion,);
            unsafe {
    ...
    impl crate::obj::GodotClass for Shape2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Shape2D"));
            * name
        }
