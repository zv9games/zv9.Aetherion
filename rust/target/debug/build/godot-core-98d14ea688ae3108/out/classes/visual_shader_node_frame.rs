...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeFrame {
        ...
        pub fn set_tint_color_enabled(&mut self, enable: bool,) {
            ...
            let args = (enable,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10672usize);
        ...
        pub fn is_tint_color_enabled(&self,) -> bool {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10673usize);
        ...
        pub fn set_tint_color(&mut self, color: Color,) {
            ...
            let args = (color,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10674usize);
        ...
        pub fn get_tint_color(&self,) -> Color {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10675usize);
        ...
        pub fn set_autoshrink_enabled(&mut self, enable: bool,) {
            ...
            let args = (enable,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10676usize);
        ...
        pub fn is_autoshrink_enabled(&self,) -> bool {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10677usize);
        ...
        pub fn add_attached_node(&mut self, node: i32,) {
            ...
            let args = (node,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10678usize);
        ...
        pub fn remove_attached_node(&mut self, node: i32,) {
            ...
            let args = (node,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10679usize);
        ...
        pub fn set_attached_nodes(&mut self, attached_nodes: &PackedInt32Array,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10680usize);
        ...
        pub fn get_attached_nodes(&self,) -> PackedInt32Array {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10681usize);
    ...
    impl crate::obj::GodotClass for VisualShaderNodeFrame {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeFrame"));
            * name
        }
