    ...
    impl EditorExportPlugin {
        pub fn add_shared_object(&mut self, path: impl AsArg < GString >, tags: &PackedStringArray, target: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_shared_object", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_project_static_lib(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_project_static_lib", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_file(&mut self, path: impl AsArg < GString >, file: &PackedByteArray, remap: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_framework(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_framework", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_embedded_framework(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_embedded_framework", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_plist_content(&mut self, plist_content: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_plist_content", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_linker_flags(&mut self, flags: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_linker_flags", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_bundle_file(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_bundle_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_ios_cpp_code(&mut self, code: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_ios_cpp_code", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn add_macos_plugin_file(&mut self, path: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "add_macos_plugin_file", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn skip(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "skip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_option(&self, name: impl AsArg < StringName >,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "get_option", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_export_preset(&self,) -> Option < Gd < crate::classes::EditorExportPreset > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "get_export_preset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_export_platform(&self,) -> Option < Gd < crate::classes::EditorExportPlatform > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlugin", "get_export_platform", self.object_ptr, self.__checked_id(), args,)
            }
        }
