...
pub(super) mod re_export {
    ...
    impl PortableCompressedTexture2D {
        pub(crate) fn create_from_image_full(&mut self, image: ObjectArg < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode, normal_map: bool, lossy_quality: f32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >, crate::classes::portable_compressed_texture_2d::CompressionMode, bool, f32,);
        ...
        #[inline]
        pub fn create_from_image(&mut self, image: impl AsObjectArg < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode,) {
            self.create_from_image_ex(image, compression_mode,) . done()
        }
        #[inline]
        pub fn create_from_image_ex < 'a > (&'a mut self, image: impl AsObjectArg < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode,) -> ExCreateFromImage < 'a > {
    ...
    impl crate::obj::GodotClass for PortableCompressedTexture2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"PortableCompressedTexture2D"));
            * name
        }
...
pub struct ExCreateFromImage < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::PortableCompressedTexture2D, image: ObjectCow < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode, normal_map: bool, lossy_quality: f32,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExCreateFromImage < 'a > {
    fn new(surround_object: &'a mut re_export::PortableCompressedTexture2D, image: impl AsObjectArg < crate::classes::Image >, compression_mode: crate::classes::portable_compressed_texture_2d::CompressionMode,) -> Self {
        let normal_map = false;
        let lossy_quality = 0.8f32;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, image: image.consume_arg(), compression_mode: compression_mode, normal_map: normal_map, lossy_quality: lossy_quality,
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::PortableCompressedTexture2D::create_from_image_full(surround_object, image.cow_as_object_arg(), compression_mode, normal_map, lossy_quality,)
    }
}
#[repr(transparent)]
...
impl crate::obj::EngineEnum for CompressionMode {
    ...
    fn as_str(&self) -> &'static str {
        ...
        match * self {
            Self::LOSSLESS => "LOSSLESS", Self::LOSSY => "LOSSY", Self::BASIS_UNIVERSAL => "BASIS_UNIVERSAL", Self::S3TC => "S3TC", Self::ETC2 => "ETC2", Self::BPTC => "BPTC", _ => "",
        }
    }
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LOSSLESS => "COMPRESSION_MODE_LOSSLESS", Self::LOSSY => "COMPRESSION_MODE_LOSSY", Self::BASIS_UNIVERSAL => "COMPRESSION_MODE_BASIS_UNIVERSAL", Self::S3TC => "COMPRESSION_MODE_S3TC", Self::ETC2 => "COMPRESSION_MODE_ETC2", Self::BPTC => "COMPRESSION_MODE_BPTC", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
        &[CompressionMode::LOSSLESS, CompressionMode::LOSSY, CompressionMode::BASIS_UNIVERSAL, CompressionMode::S3TC, CompressionMode::ETC2, CompressionMode::BPTC]
    }
