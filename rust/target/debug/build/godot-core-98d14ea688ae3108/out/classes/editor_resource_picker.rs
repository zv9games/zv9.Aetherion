...
pub(super) mod re_export {
    ...
    impl EditorResourcePicker {
        ...
        pub fn set_edited_resource(&mut self, resource: impl AsObjectArg < crate::classes::Resource >,) {
            type CallRet = ();
    ...
    impl crate::obj::GodotClass for EditorResourcePicker {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorResourcePicker"));
            * name
        }
