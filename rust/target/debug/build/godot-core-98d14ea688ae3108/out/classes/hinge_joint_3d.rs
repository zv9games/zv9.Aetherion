...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for HingeJoint3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"HingeJoint3D"));
            * name
        }
...
impl crate::obj::EngineEnum for Flag {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::USE_LIMIT => "FLAG_USE_LIMIT", Self::ENABLE_MOTOR => "FLAG_ENABLE_MOTOR", Self::MAX => "FLAG_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
