...
pub(super) mod re_export {
    ...
    impl AnimationNodeAnimation {
        pub fn set_animation(&mut self, name: impl AsArg < StringName >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_animation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_animation(&self,) -> StringName {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "get_animation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_play_mode(&mut self, mode: crate::classes::animation_node_animation::PlayMode,) {
            type CallRet = ();
            type CallParams = (crate::classes::animation_node_animation::PlayMode,);
            let args = (mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(314usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_play_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_play_mode(&self,) -> crate::classes::animation_node_animation::PlayMode {
            type CallRet = crate::classes::animation_node_animation::PlayMode;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(315usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "get_play_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_advance_on_start(&mut self, advance_on_start: bool,) {
            type CallRet = ();
            type CallParams = (bool,);
            let args = (advance_on_start,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(316usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_advance_on_start", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_advance_on_start(&self,) -> bool {
            type CallRet = bool;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(317usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "is_advance_on_start", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_custom_timeline(&mut self, use_custom_timeline: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_use_custom_timeline", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_custom_timeline(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "is_using_custom_timeline", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_timeline_length(&mut self, timeline_length: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_timeline_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_timeline_length(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "get_timeline_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_stretch_time_scale(&mut self, stretch_time_scale: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_stretch_time_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_stretching_time_scale(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "is_stretching_time_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_start_offset(&mut self, start_offset: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_start_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_start_offset(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "get_start_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_loop_mode(&mut self, loop_mode: crate::classes::animation::LoopMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "set_loop_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_loop_mode(&self,) -> crate::classes::animation::LoopMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeAnimation", "get_loop_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AnimationNodeAnimation__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for PlayMode {
    ...
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < PlayMode >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("FORWARD", "PLAY_MODE_FORWARD", PlayMode::FORWARD), crate::meta::inspect::EnumConstant::new("BACKWARD", "PLAY_MODE_BACKWARD", PlayMode::BACKWARD)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::AnimationNodeAnimation;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::animation_node::SignalsOfAnimationNode;
    impl WithSignals for AnimationNodeAnimation {
