...
pub(super) mod re_export {
    ...
    impl ConcavePolygonShape3D {
        pub fn set_faces(&mut self, faces: &PackedVector3Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "set_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_faces(&self,) -> PackedVector3Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "get_faces", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_backface_collision_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "set_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_backface_collision_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ConcavePolygonShape3D", "is_backface_collision_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ConcavePolygonShape3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ConcavePolygonShape3D"));
            * name
        }
