...
pub(super) mod re_export {
    ...
    impl XrPositionalTracker {
        ...
        pub fn set_pose(&mut self, name: impl AsArg < StringName >, transform: Transform3D, linear_velocity: Vector3, angular_velocity: Vector3, tracking_confidence: crate::classes::xr_pose::TrackingConfidence,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(11233usize);
        ...
        pub fn get_input(&self, name: impl AsArg < StringName >,) -> Variant {
            ...
            let args = (name.into_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(11234usize);
        ...
        pub fn set_input(&mut self, name: impl AsArg < StringName >, value: &Variant,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(11235usize);
    ...
    impl crate::obj::GodotClass for XrPositionalTracker {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"XRPositionalTracker"));
            * name
        }
...
impl crate::obj::EngineEnum for TrackerHand {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::UNKNOWN => "TRACKER_HAND_UNKNOWN", Self::LEFT => "TRACKER_HAND_LEFT", Self::RIGHT => "TRACKER_HAND_RIGHT", Self::MAX => "TRACKER_HAND_MAX", _ => self.as_str(),
        }
    }
