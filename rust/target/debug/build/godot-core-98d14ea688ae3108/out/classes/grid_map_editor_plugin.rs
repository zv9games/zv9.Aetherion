...
pub(super) mod re_export {
    ...
    impl GridMapEditorPlugin {
        pub fn get_current_grid_map(&self,) -> Option < Gd < crate::classes::GridMap > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "get_current_grid_map", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_selection(&mut self, begin: Vector3i, end: Vector3i,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "set_selection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_selection(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "clear_selection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_selection(&self,) -> Aabb {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "get_selection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_selection(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "has_selection", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_selected_cells(&self,) -> VariantArray {
            type CallRet = VariantArray;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(423usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "get_selected_cells", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_selected_palette_item(&self, item: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "set_selected_palette_item", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_selected_palette_item(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GridMapEditorPlugin", "get_selected_palette_item", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for GridMapEditorPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GridMapEditorPlugin"));
            * name
        }
