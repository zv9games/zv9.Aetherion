...
pub(super) mod re_export {
    ...
    impl GltfDocument {
        ...
        pub(crate) fn append_from_file_full(&mut self, path: CowArg < GString >, state: ObjectArg < crate::classes::GltfState >, flags: u32, base_path: CowArg < GString >,) -> crate::global::Error {
            ...
            type CallParams < 'a0, 'a1, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::GltfState >, u32, CowArg < 'a1, GString >,);
        ...
        pub(crate) fn append_from_buffer_full(&mut self, bytes: RefArg < PackedByteArray >, base_path: CowArg < GString >, state: ObjectArg < crate::classes::GltfState >, flags: u32,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, 'a1, > = (RefArg < 'a0, PackedByteArray >, CowArg < 'a1, GString >, ObjectArg < crate::classes::GltfState >, u32,);
        ...
        pub(crate) fn append_from_scene_full(&mut self, node: ObjectArg < crate::classes::Node >, state: ObjectArg < crate::classes::GltfState >, flags: u32,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams = (ObjectArg < crate::classes::Node >, ObjectArg < crate::classes::GltfState >, u32,);
        ...
        pub(crate) fn generate_scene_full(&mut self, state: ObjectArg < crate::classes::GltfState >, bake_fps: f32, trimming: bool, remove_immutable_tracks: bool,) -> Option < Gd < crate::classes::Node > > {
            ...
            type CallParams = (ObjectArg < crate::classes::GltfState >, f32, bool, bool,);
        ...
        pub fn write_to_filesystem(&mut self, state: impl AsObjectArg < crate::classes::GltfState >, path: impl AsArg < GString >,) -> crate::global::Error {
            type CallRet = crate::global::Error;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::GltfState >, CowArg < 'a0, GString >,);
        ...
        pub fn import_object_model_property(state: impl AsObjectArg < crate::classes::GltfState >, json_pointer: impl AsArg < GString >,) -> Option < Gd < crate::classes::GltfObjectModelProperty > > {
            type CallRet = Option < Gd < crate::classes::GltfObjectModelProperty > >;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::GltfState >, CowArg < 'a0, GString >,);
            let args = (state.as_object_arg(), json_pointer.into_arg(),);
            unsafe {
        ...
        pub fn export_object_model_property(state: impl AsObjectArg < crate::classes::GltfState >, node_path: impl AsArg < NodePath >, godot_node: impl AsObjectArg < crate::classes::Node >, gltf_node_index: i32,) -> Option < Gd < crate::classes::GltfObjectModelProperty > > {
            type CallRet = Option < Gd < crate::classes::GltfObjectModelProperty > >;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::GltfState >, CowArg < 'a0, NodePath >, ObjectArg < crate::classes::Node >, i32,);
            let args = (state.as_object_arg(), node_path.into_arg(), godot_node.as_object_arg(), gltf_node_index,);
            unsafe {
        ...
        pub(crate) fn register_gltf_document_extension_full(extension: ObjectArg < crate::classes::GltfDocumentExtension >, first_priority: bool,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::GltfDocumentExtension >, bool,);
        ...
        pub fn unregister_gltf_document_extension(extension: impl AsObjectArg < crate::classes::GltfDocumentExtension >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::GltfDocumentExtension >,);
