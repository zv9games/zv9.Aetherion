...
pub(super) mod re_export {
    ...
    pub trait IEditorInspectorPlugin: crate::obj::GodotClass < Base = EditorInspectorPlugin > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        fn parse_property(&mut self, object: Option < Gd < crate::classes::Object > >, type_: VariantType, name: GString, hint_type: crate::global::PropertyHint, hint_string: GString, usage_flags: crate::global::PropertyUsageFlags, wide: bool,) -> bool {
            unimplemented !()
        }
    ...
    impl EditorInspectorPlugin {
        pub fn add_custom_control(&mut self, control: impl AsObjectArg < crate::classes::Control >,) {
            type CallRet = ();
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_custom_control", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn add_property_editor_full(&mut self, property: CowArg < GString >, editor: ObjectArg < crate::classes::Control >, add_to_end: bool, label: CowArg < GString >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Control >, bool, CowArg < 'a1, GString >,);
            let args = (property, editor, add_to_end, label,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(163usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_property_editor", self.object_ptr, self.__checked_id(), args,)
            }
        }
        #[doc = "To set the default parameters, use [`Self::add_property_editor_ex`] and its builder methods.  See [the book](https://godot-rust.github.io/book/godot-api/functions.html#default-parameters) for detailed usage instructions."]
        #[inline]
        pub fn add_property_editor(&mut self, property: impl AsArg < GString >, editor: impl AsObjectArg < crate::classes::Control >,) {
            self.add_property_editor_ex(property, editor,) . done()
        }
        #[inline]
        pub fn add_property_editor_ex < 'a > (&'a mut self, property: impl AsArg < GString > + 'a, editor: impl AsObjectArg < crate::classes::Control >,) -> ExAddPropertyEditor < 'a > {
            ExAddPropertyEditor::new(self, property, editor,)
        }
        pub fn add_property_editor_for_multiple_properties(&mut self, label: impl AsArg < GString >, properties: &PackedStringArray, editor: impl AsObjectArg < crate::classes::Control >,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (CowArg < 'a0, GString >, RefArg < 'a1, PackedStringArray >, ObjectArg < crate::classes::Control >,);
            let args = (label.into_arg(), RefArg::new(properties), editor.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(164usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorInspectorPlugin", "add_property_editor_for_multiple_properties", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorInspectorPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorInspectorPlugin"));
            * name
        }
...
pub struct ExAddPropertyEditor < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::EditorInspectorPlugin, property: CowArg < 'a, GString >, editor: ObjectCow < crate::classes::Control >, add_to_end: bool, label: CowArg < 'a, GString >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExAddPropertyEditor < 'a > {
    fn new(surround_object: &'a mut re_export::EditorInspectorPlugin, property: impl AsArg < GString > + 'a, editor: impl AsObjectArg < crate::classes::Control >,) -> Self {
        let add_to_end = false;
        let label = GString::from("");
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, property: property.into_arg(), editor: editor.consume_arg(), add_to_end: add_to_end, label: CowArg::Owned(label),
        }
    }
    #[inline]
    ...
    pub fn done(self) {
        ...
        = self;
        re_export::EditorInspectorPlugin::add_property_editor_full(surround_object, property, editor.cow_as_object_arg(), add_to_end, label,)
    }
}
pub use signals::*;
mod signals {
