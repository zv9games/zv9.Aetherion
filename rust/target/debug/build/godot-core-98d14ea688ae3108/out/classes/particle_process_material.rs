...
pub(super) mod re_export {
    ...
    impl ParticleProcessMaterial {
        ...
        pub fn set_param_texture(&mut self, param: crate::classes::particle_process_material::Parameter, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams = (crate::classes::particle_process_material::Parameter, ObjectArg < crate::classes::Texture2D >,);
...
impl crate::obj::EngineEnum for SubEmitterMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DISABLED => "SUB_EMITTER_DISABLED", Self::CONSTANT => "SUB_EMITTER_CONSTANT", Self::AT_END => "SUB_EMITTER_AT_END", Self::AT_COLLISION => "SUB_EMITTER_AT_COLLISION", Self::AT_START => "SUB_EMITTER_AT_START", Self::MAX => "SUB_EMITTER_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
