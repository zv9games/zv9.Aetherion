...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTransformOp {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeTransformOp"));
            * name
        }
...
impl crate::obj::EngineEnum for Operator {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::AxB => "OP_AxB", Self::BxA => "OP_BxA", Self::AxB_COMP => "OP_AxB_COMP", Self::BxA_COMP => "OP_BxA_COMP", Self::ADD => "OP_ADD", Self::A_MINUS_B => "OP_A_MINUS_B", Self::B_MINUS_A => "OP_B_MINUS_A", Self::A_DIV_B => "OP_A_DIV_B", Self::B_DIV_A => "OP_B_DIV_A", Self::MAX => "OP_MAX", _ => self.as_str(),
        }
    }
