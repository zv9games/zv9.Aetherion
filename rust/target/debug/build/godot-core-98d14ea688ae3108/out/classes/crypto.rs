...
pub(super) mod re_export {
    ...
    impl Crypto {
        ...
        pub(crate) fn generate_self_signed_certificate_full(&mut self, key: ObjectArg < crate::classes::CryptoKey >, issuer_name: CowArg < GString >, not_before: CowArg < GString >, not_after: CowArg < GString >,) -> Option < Gd < crate::classes::X509Certificate > > {
            type CallRet = Option < Gd < crate::classes::X509Certificate > >;
            type CallParams < 'a0, 'a1, 'a2, > = (ObjectArg < crate::classes::CryptoKey >, CowArg < 'a0, GString >, CowArg < 'a1, GString >, CowArg < 'a2, GString >,);
        ...
        #[inline]
        pub fn generate_self_signed_certificate(&mut self, key: impl AsObjectArg < crate::classes::CryptoKey >,) -> Option < Gd < crate::classes::X509Certificate > > {
            self.generate_self_signed_certificate_ex(key,) . done()
        }
        #[inline]
        pub fn generate_self_signed_certificate_ex < 'a > (&'a mut self, key: impl AsObjectArg < crate::classes::CryptoKey >,) -> ExGenerateSelfSignedCertificate < 'a > {
            ExGenerateSelfSignedCertificate::new(self, key,)
        }
        pub fn sign(&mut self, hash_type: crate::classes::hashing_context::HashType, hash: &PackedByteArray, key: impl AsObjectArg < crate::classes::CryptoKey >,) -> PackedByteArray {
            type CallRet = PackedByteArray;
            type CallParams < 'a0, > = (crate::classes::hashing_context::HashType, RefArg < 'a0, PackedByteArray >, ObjectArg < crate::classes::CryptoKey >,);
            let args = (hash_type, RefArg::new(hash), key.as_object_arg(),);
            unsafe {
        ...
        pub fn verify(&mut self, hash_type: crate::classes::hashing_context::HashType, hash: &PackedByteArray, signature: &PackedByteArray, key: impl AsObjectArg < crate::classes::CryptoKey >,) -> bool {
            type CallRet = bool;
            type CallParams < 'a0, 'a1, > = (crate::classes::hashing_context::HashType, RefArg < 'a0, PackedByteArray >, RefArg < 'a1, PackedByteArray >, ObjectArg < crate::classes::CryptoKey >,);
            let args = (hash_type, RefArg::new(hash), RefArg::new(signature), key.as_object_arg(),);
            unsafe {
        ...
        pub fn encrypt(&mut self, key: impl AsObjectArg < crate::classes::CryptoKey >, plaintext: &PackedByteArray,) -> PackedByteArray {
            type CallRet = PackedByteArray;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::CryptoKey >, RefArg < 'a0, PackedByteArray >,);
            let args = (key.as_object_arg(), RefArg::new(plaintext),);
            unsafe {
        ...
        pub fn decrypt(&mut self, key: impl AsObjectArg < crate::classes::CryptoKey >, ciphertext: &PackedByteArray,) -> PackedByteArray {
            type CallRet = PackedByteArray;
            type CallParams < 'a0, > = (ObjectArg < crate::classes::CryptoKey >, RefArg < 'a0, PackedByteArray >,);
            let args = (key.as_object_arg(), RefArg::new(ciphertext),);
            unsafe {
    ...
    impl crate::obj::GodotClass for Crypto {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Crypto"));
            * name
        }
...
pub struct ExGenerateSelfSignedCertificate < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::Crypto, key: ObjectCow < crate::classes::CryptoKey >, issuer_name: CowArg < 'a, GString >, not_before: CowArg < 'a, GString >, not_after: CowArg < 'a, GString >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExGenerateSelfSignedCertificate < 'a > {
    fn new(surround_object: &'a mut re_export::Crypto, key: impl AsObjectArg < crate::classes::CryptoKey >,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, key: key.consume_arg(), issuer_name: CowArg::Owned(issuer_name), not_before: CowArg::Owned(not_before), not_after: CowArg::Owned(not_after),
        }
    }
    #[inline]
    ...
    pub fn done(self) -> Option < Gd < crate::classes::X509Certificate > > {
        ...
        = self;
        re_export::Crypto::generate_self_signed_certificate_full(surround_object, key.cow_as_object_arg(), issuer_name, not_before, not_after,)
    }
}
pub use signals::*;
mod signals {
