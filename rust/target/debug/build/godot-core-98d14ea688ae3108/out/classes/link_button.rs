...
pub(super) mod re_export {
    ...
    impl LinkButton {
        pub fn set_text(&mut self, text: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_text", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_text(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_text", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_text_direction(&mut self, direction: crate::classes::control::TextDirection,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_text_direction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_text_direction(&self,) -> crate::classes::control::TextDirection {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_text_direction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_language(&mut self, language: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_language", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_language(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_language", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_uri(&mut self, uri: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_uri", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_uri(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_uri", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_underline_mode(&mut self, underline_mode: crate::classes::link_button::UnderlineMode,) {
            type CallRet = ();
            type CallParams = (crate::classes::link_button::UnderlineMode,);
            let args = (underline_mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5160usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_underline_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_underline_mode(&self,) -> crate::classes::link_button::UnderlineMode {
            type CallRet = crate::classes::link_button::UnderlineMode;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5161usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_underline_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_structured_text_bidi_override(&mut self, parser: crate::classes::text_server::StructuredTextParser,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_structured_text_bidi_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_structured_text_bidi_override(&self,) -> crate::classes::text_server::StructuredTextParser {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_structured_text_bidi_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_structured_text_bidi_override_options(&mut self, args: &VariantArray,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "set_structured_text_bidi_override_options", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_structured_text_bidi_override_options(&self,) -> VariantArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "LinkButton", "get_structured_text_bidi_override_options", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_LinkButton__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for UnderlineMode {
    ...
    fn values() -> &'static[Self] {
        &[UnderlineMode::ALWAYS, UnderlineMode::ON_HOVER, UnderlineMode::NEVER]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < UnderlineMode >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("ALWAYS", "UNDERLINE_MODE_ALWAYS", UnderlineMode::ALWAYS), crate::meta::inspect::EnumConstant::new("ON_HOVER", "UNDERLINE_MODE_ON_HOVER", UnderlineMode::ON_HOVER), crate::meta::inspect::EnumConstant::new("NEVER", "UNDERLINE_MODE_NEVER", UnderlineMode::NEVER)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::LinkButton;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::base_button::SignalsOfBaseButton;
    impl WithSignals for LinkButton {
