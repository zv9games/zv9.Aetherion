...
pub(super) mod re_export {
    ...
    impl TorusMesh {
        pub fn set_inner_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "set_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_inner_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "get_inner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_outer_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "set_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_outer_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "get_outer_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_rings(&mut self, rings: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "set_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rings(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "get_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_ring_segments(&mut self, rings: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "set_ring_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_ring_segments(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TorusMesh", "get_ring_segments", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for TorusMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TorusMesh"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PrimitiveMesh > for TorusMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Mesh > for TorusMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for TorusMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for TorusMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for TorusMesh {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`TorusMesh`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_TorusMesh__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::TorusMesh > for $Class {
...
mod signals {
    ...
    use super::re_export::TorusMesh;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for TorusMesh {
