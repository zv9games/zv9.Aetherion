...
pub(super) mod re_export {
    ...
    impl PolygonPathFinder {
        pub fn setup(&mut self, points: &PackedVector2Array, connections: &PackedInt32Array,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (RefArg < 'a0, PackedVector2Array >, RefArg < 'a1, PackedInt32Array >,);
            let args = (RefArg::new(points), RefArg::new(connections),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6749usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "setup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_path(&mut self, from: Vector2, to: Vector2,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "find_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_intersections(&self, from: Vector2, to: Vector2,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "get_intersections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_closest_point(&self, point: Vector2,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "get_closest_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_point_inside(&self, point: Vector2,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "is_point_inside", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_point_penalty(&mut self, idx: i32, penalty: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "set_point_penalty", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_point_penalty(&self, idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "get_point_penalty", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bounds(&self,) -> Rect2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "PolygonPathFinder", "get_bounds", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_PolygonPathFinder__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::PolygonPathFinder;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for PolygonPathFinder {
