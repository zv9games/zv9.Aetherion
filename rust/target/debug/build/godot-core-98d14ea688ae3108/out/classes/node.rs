...
pub(super) mod re_export {
    ...
    impl Node {
        ...
        pub(crate) fn add_child_full(&mut self, node: ObjectArg < crate::classes::Node >, force_readable_name: bool, internal: crate::classes::node::InternalMode,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Node >, bool, crate::classes::node::InternalMode,);
        ...
        pub fn move_child(&mut self, child_node: impl AsObjectArg < crate::classes::Node >, to_index: i32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Node >, i32,);
        ...
        pub fn get_rpc_config(&self,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Node", "get_rpc_config", self.object_ptr, self.__checked_id(), args,)
            }
        }
...
impl crate::obj::EngineEnum for DuplicateFlags {
    ...
    fn values() -> &'static[Self] {
        &[DuplicateFlags::SIGNALS, DuplicateFlags::GROUPS, DuplicateFlags::SCRIPTS, DuplicateFlags::USE_INSTANTIATION]
    }
