...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeTexture {
        ...
        pub fn set_texture(&mut self, value: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
    ...
    impl crate::obj::GodotClass for VisualShaderNodeTexture {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeTexture"));
            * name
        }
...
impl crate::obj::EngineEnum for Source {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TEXTURE => "SOURCE_TEXTURE", Self::SCREEN => "SOURCE_SCREEN", Self::DEPTH => "SOURCE_DEPTH", Self::PORT => "SOURCE_PORT", Self::ROUGHNESS => "SOURCE_ROUGHNESS", Self::MAX => "SOURCE_MAX", _ => self.as_str(),
        }
    }
