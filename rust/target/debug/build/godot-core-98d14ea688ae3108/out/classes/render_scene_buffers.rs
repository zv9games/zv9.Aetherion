...
pub(super) mod re_export {
    ...
    impl RenderSceneBuffers {
        pub fn configure(&mut self, config: impl AsObjectArg < crate::classes::RenderSceneBuffersConfiguration >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::RenderSceneBuffersConfiguration >,);
    ...
    impl crate::obj::GodotClass for RenderSceneBuffers {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"RenderSceneBuffers"));
            * name
        }
