...
pub(super) mod re_export {
    ...
    impl ReferenceRect {
        pub fn get_border_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "get_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "set_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_width(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "get_border_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_width(&mut self, width: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "set_border_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_editor_only(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "get_editor_only", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_editor_only(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "ReferenceRect", "set_editor_only", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for ReferenceRect {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ReferenceRect"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::Control > for ReferenceRect {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CanvasItem > for ReferenceRect {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for ReferenceRect {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for ReferenceRect {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`ReferenceRect`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_ReferenceRect__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::ReferenceRect > for $Class {
...
mod signals {
    ...
    use super::re_export::ReferenceRect;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::control::SignalsOfControl;
    impl WithSignals for ReferenceRect {
