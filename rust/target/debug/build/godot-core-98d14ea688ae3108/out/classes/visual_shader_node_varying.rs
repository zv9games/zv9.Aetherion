...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeVarying {
        ...
        pub fn get_varying_name(&self,) -> GString {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10812usize);
        ...
        pub fn set_varying_type(&mut self, type_: crate::classes::visual_shader::VaryingType,) {
            ...
            let args = (type_,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10813usize);
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVarying {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeVarying"));
            * name
        }
