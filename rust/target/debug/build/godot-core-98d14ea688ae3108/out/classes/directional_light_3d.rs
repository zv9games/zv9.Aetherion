...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for DirectionalLight3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"DirectionalLight3D"));
            * name
        }
...
impl crate::obj::EngineEnum for ShadowMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::ORTHOGONAL => "SHADOW_ORTHOGONAL", Self::PARALLEL_2_SPLITS => "SHADOW_PARALLEL_2_SPLITS", Self::PARALLEL_4_SPLITS => "SHADOW_PARALLEL_4_SPLITS", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for SkyMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LIGHT_AND_SKY => "SKY_MODE_LIGHT_AND_SKY", Self::LIGHT_ONLY => "SKY_MODE_LIGHT_ONLY", Self::SKY_ONLY => "SKY_MODE_SKY_ONLY", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
