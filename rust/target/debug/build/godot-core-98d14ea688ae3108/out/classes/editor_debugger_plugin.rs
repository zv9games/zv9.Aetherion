...
pub(super) mod re_export {
    ...
    pub trait IEditorDebuggerPlugin: crate::obj::GodotClass < Base = EditorDebuggerPlugin > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        fn capture(&mut self, message: GString, data: VariantArray, session_id: i32,) -> bool {
            unimplemented !()
        }
    ...
    impl EditorDebuggerPlugin {
        pub fn get_session(&mut self, id: i32,) -> Option < Gd < crate::classes::EditorDebuggerSession > > {
            type CallRet = Option < Gd < crate::classes::EditorDebuggerSession > >;
            type CallParams = (i32,);
            let args = (id,);
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(6usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorDebuggerPlugin", "get_session", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sessions(&mut self,) -> VariantArray {
            type CallRet = VariantArray;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_editor_api() . fptr_by_index(7usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorDebuggerPlugin", "get_sessions", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorDebuggerPlugin {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorDebuggerPlugin"));
            * name
        }
