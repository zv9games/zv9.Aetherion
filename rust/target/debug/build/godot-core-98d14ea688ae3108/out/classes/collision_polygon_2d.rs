...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for CollisionPolygon2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"CollisionPolygon2D"));
            * name
        }
...
impl crate::obj::EngineEnum for BuildMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SOLIDS => "BUILD_SOLIDS", Self::SEGMENTS => "BUILD_SEGMENTS", _ => self.as_str(),
        }
    }
