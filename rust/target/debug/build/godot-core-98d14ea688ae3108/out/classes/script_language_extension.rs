...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for ScriptLanguageExtension {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ScriptLanguageExtension"));
            * name
        }
...
impl crate::obj::EngineEnum for LookupResultType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SCRIPT_LOCATION => "LOOKUP_RESULT_SCRIPT_LOCATION", Self::CLASS => "LOOKUP_RESULT_CLASS", Self::CLASS_CONSTANT => "LOOKUP_RESULT_CLASS_CONSTANT", Self::CLASS_PROPERTY => "LOOKUP_RESULT_CLASS_PROPERTY", Self::CLASS_METHOD => "LOOKUP_RESULT_CLASS_METHOD", Self::CLASS_SIGNAL => "LOOKUP_RESULT_CLASS_SIGNAL", Self::CLASS_ENUM => "LOOKUP_RESULT_CLASS_ENUM", Self::CLASS_TBD_GLOBALSCOPE => "LOOKUP_RESULT_CLASS_TBD_GLOBALSCOPE", Self::CLASS_ANNOTATION => "LOOKUP_RESULT_CLASS_ANNOTATION", Self::LOCAL_CONSTANT => "LOOKUP_RESULT_LOCAL_CONSTANT", Self::LOCAL_VARIABLE => "LOOKUP_RESULT_LOCAL_VARIABLE", Self::MAX => "LOOKUP_RESULT_MAX", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for CodeCompletionKind {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::CLASS => "CODE_COMPLETION_KIND_CLASS", Self::FUNCTION => "CODE_COMPLETION_KIND_FUNCTION", Self::SIGNAL => "CODE_COMPLETION_KIND_SIGNAL", Self::VARIABLE => "CODE_COMPLETION_KIND_VARIABLE", Self::MEMBER => "CODE_COMPLETION_KIND_MEMBER", Self::ENUM => "CODE_COMPLETION_KIND_ENUM", Self::CONSTANT => "CODE_COMPLETION_KIND_CONSTANT", Self::NODE_PATH => "CODE_COMPLETION_KIND_NODE_PATH", Self::FILE_PATH => "CODE_COMPLETION_KIND_FILE_PATH", Self::PLAIN_TEXT => "CODE_COMPLETION_KIND_PLAIN_TEXT", Self::MAX => "CODE_COMPLETION_KIND_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
