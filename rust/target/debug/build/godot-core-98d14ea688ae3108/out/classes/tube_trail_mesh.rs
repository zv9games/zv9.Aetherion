...
pub(super) mod re_export {
    ...
    impl TubeTrailMesh {
        pub fn set_radius(&mut self, radius: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_radial_steps(&mut self, radial_steps: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_radial_steps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radial_steps(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_radial_steps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_sections(&mut self, sections: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_sections(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_sections", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_length(&mut self, section_length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_section_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_section_rings(&mut self, section_rings: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_section_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_section_rings(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_section_rings", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_top(&mut self, cap_top: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_top(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "is_cap_top", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cap_bottom(&mut self, cap_bottom: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_cap_bottom(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "is_cap_bottom", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_curve(&mut self, curve: impl AsObjectArg < crate::classes::Curve >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Curve >,);
            let args = (curve.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10261usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "set_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_curve(&self,) -> Option < Gd < crate::classes::Curve > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TubeTrailMesh", "get_curve", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for TubeTrailMesh {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TubeTrailMesh"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PrimitiveMesh > for TubeTrailMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Mesh > for TubeTrailMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for TubeTrailMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for TubeTrailMesh {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for TubeTrailMesh {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`TubeTrailMesh`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_TubeTrailMesh__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::TubeTrailMesh > for $Class {
...
mod signals {
    ...
    use super::re_export::TubeTrailMesh;
