...
pub(super) mod re_export {
    ...
    impl Os {
        ...
        pub fn read_string_from_stdin(&mut self, buffer_size: i64,) -> GString {
            type CallRet = GString;
            type CallParams = (i64,);
        ...
        pub fn read_buffer_from_stdin(&mut self, buffer_size: i64,) -> PackedByteArray {
            type CallRet = PackedByteArray;
            type CallParams = (i64,);
            let args = (buffer_size,);
            unsafe {
...
impl crate::obj::EngineEnum for RenderingDriver {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::VULKAN => "RENDERING_DRIVER_VULKAN", Self::OPENGL3 => "RENDERING_DRIVER_OPENGL3", Self::D3D12 => "RENDERING_DRIVER_D3D12", Self::METAL => "RENDERING_DRIVER_METAL", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for StdHandleType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::INVALID => "STD_HANDLE_INVALID", Self::CONSOLE => "STD_HANDLE_CONSOLE", Self::FILE => "STD_HANDLE_FILE", Self::PIPE => "STD_HANDLE_PIPE", Self::UNKNOWN => "STD_HANDLE_UNKNOWN", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
