...
pub(super) mod re_export {
    ...
    impl Tween {
        pub fn tween_property(&mut self, object: impl AsObjectArg < crate::classes::Object >, property: impl AsArg < NodePath >, final_val: &Variant, duration: f64,) -> Option < Gd < crate::classes::PropertyTweener > > {
            ...
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::Object >, CowArg < 'a0, NodePath >, RefArg < 'a1, Variant >, f64,);
        ...
        pub fn tween_subtween(&mut self, subtween: impl AsObjectArg < crate::classes::Tween >,) -> Option < Gd < crate::classes::SubtweenTweener > > {
            type CallRet = Option < Gd < crate::classes::SubtweenTweener > >;
            type CallParams = (ObjectArg < crate::classes::Tween >,);
            let args = (subtween.as_object_arg(),);
            unsafe {
