...
pub(super) mod re_export {
    ...
    impl OpenXrApiExtension {
        ...
        pub fn register_composition_layer_provider(&mut self, extension: impl AsObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,);
        ...
        pub fn register_projection_views_extension(&mut self, extension: impl AsObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,);
            let args = (extension.as_object_arg(),);
            unsafe {
        ...
        pub fn unregister_projection_views_extension(&mut self, extension: impl AsObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrExtensionWrapperExtension >,);
            let args = (extension.as_object_arg(),);
            unsafe {
