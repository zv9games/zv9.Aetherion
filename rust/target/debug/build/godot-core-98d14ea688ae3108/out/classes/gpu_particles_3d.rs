...
pub(super) mod re_export {
    ...
    impl GpuParticles3D {
        ...
        pub fn get_speed_scale(&self,) -> f64 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3966usize);
        ...
        pub fn get_use_fixed_seed(&self,) -> bool {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3970usize);
        ...
        pub fn emit_particle(&mut self, xform: Transform3D, velocity: Vector3, color: Color, custom: Color, flags: u32,) {
            type CallRet = ();
            type CallParams = (Transform3D, Vector3, Color, Color, u32,);
...
impl crate::obj::EngineEnum for EmitFlags {
    ...
    fn values() -> &'static[Self] {
        &[EmitFlags::POSITION, EmitFlags::ROTATION_SCALE, EmitFlags::VELOCITY, EmitFlags::COLOR, EmitFlags::CUSTOM]
    }
