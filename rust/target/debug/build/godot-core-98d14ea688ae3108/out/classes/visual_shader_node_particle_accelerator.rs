...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeParticleAccelerator {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeParticleAccelerator"));
            * name
        }
...
impl crate::obj::EngineEnum for Mode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LINEAR => "MODE_LINEAR", Self::RADIAL => "MODE_RADIAL", Self::TANGENTIAL => "MODE_TANGENTIAL", Self::MAX => "MODE_MAX", _ => self.as_str(),
        }
    }
