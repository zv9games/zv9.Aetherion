...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for EditorExportPreset {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorExportPreset"));
            * name
        }
...
impl crate::obj::EngineEnum for FileExportMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NOT_CUSTOMIZED => "MODE_FILE_NOT_CUSTOMIZED", Self::STRIP => "MODE_FILE_STRIP", Self::KEEP => "MODE_FILE_KEEP", Self::REMOVE => "MODE_FILE_REMOVE", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for ScriptExportMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TEXT => "MODE_SCRIPT_TEXT", Self::BINARY_TOKENS => "MODE_SCRIPT_BINARY_TOKENS", Self::BINARY_TOKENS_COMPRESSED => "MODE_SCRIPT_BINARY_TOKENS_COMPRESSED", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
