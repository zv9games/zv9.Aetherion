...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for TextureLayered {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"TextureLayered"));
            * name
        }
...
impl crate::obj::EngineEnum for LayeredType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TYPE_2D_ARRAY => "LAYERED_TYPE_2D_ARRAY", Self::CUBEMAP => "LAYERED_TYPE_CUBEMAP", Self::CUBEMAP_ARRAY => "LAYERED_TYPE_CUBEMAP_ARRAY", _ => self.as_str(),
        }
    }
