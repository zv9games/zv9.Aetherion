...
pub(super) mod re_export {
    ...
    impl LightmapGiData {
        ...
        pub fn set_light_texture(&mut self, light_texture: impl AsObjectArg < crate::classes::TextureLayered >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TextureLayered >,);
            let args = (light_texture.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for LightmapGiData {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"LightmapGIData"));
            * name
        }
...
impl crate::obj::EngineEnum for ShadowmaskMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "SHADOWMASK_MODE_NONE", Self::REPLACE => "SHADOWMASK_MODE_REPLACE", Self::OVERLAY => "SHADOWMASK_MODE_OVERLAY", _ => self.as_str(),
        }
    }
