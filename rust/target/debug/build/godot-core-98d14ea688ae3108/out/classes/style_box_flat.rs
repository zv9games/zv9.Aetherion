...
pub(super) mod re_export {
    ...
    impl StyleBoxFlat {
        pub fn set_bg_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_bg_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bg_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_bg_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_width_all(&mut self, width: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_border_width_all", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_width_min(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_border_width_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_width(&mut self, margin: crate::global::Side, width: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_border_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_width(&self, margin: crate::global::Side,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_border_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_blend(&mut self, blend: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_border_blend", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_blend(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_border_blend", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_corner_radius_all(&mut self, radius: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_corner_radius_all", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_corner_radius(&mut self, corner: crate::global::Corner, radius: i32,) {
            type CallRet = ();
            type CallParams = (crate::global::Corner, i32,);
            let args = (corner, radius,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8631usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_corner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_corner_radius(&self, corner: crate::global::Corner,) -> i32 {
            type CallRet = i32;
            type CallParams = (crate::global::Corner,);
            let args = (corner,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8632usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_corner_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_expand_margin(&mut self, margin: crate::global::Side, size: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_expand_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_expand_margin_all(&mut self, size: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_expand_margin_all", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_expand_margin(&self, margin: crate::global::Side,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_expand_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_draw_center(&mut self, draw_center: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_draw_center", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_draw_center_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "is_draw_center_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skew(&mut self, skew: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_skew", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skew(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_skew", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shadow_color(&mut self, color: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_shadow_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shadow_color(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_shadow_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shadow_size(&mut self, size: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_shadow_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shadow_size(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_shadow_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shadow_offset(&mut self, offset: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_shadow_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shadow_offset(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_shadow_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_anti_aliased(&mut self, anti_aliased: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_anti_aliased", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_anti_aliased(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "is_anti_aliased", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_aa_size(&mut self, size: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_aa_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_aa_size(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_aa_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_corner_detail(&mut self, detail: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "set_corner_detail", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_corner_detail(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StyleBoxFlat", "get_corner_detail", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_StyleBoxFlat__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::StyleBoxFlat;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for StyleBoxFlat {
