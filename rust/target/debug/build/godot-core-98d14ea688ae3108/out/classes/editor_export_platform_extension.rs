...
pub(super) mod re_export {
    ...
    pub trait IEditorExportPlatformExtension: crate::obj::GodotClass < Base = EditorExportPlatformExtension > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        fn get_option_icon(&self, device: i32,) -> Option < Gd < crate::classes::ImageTexture > > {
            unimplemented !()
        }
    ...
    impl EditorExportPlatformExtension {
        pub fn set_config_error(&self, error_text: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlatformExtension", "set_config_error", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_config_error(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlatformExtension", "get_config_error", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_config_missing_templates(&self, missing_templates: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlatformExtension", "set_config_missing_templates", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_config_missing_templates(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "EditorExportPlatformExtension", "get_config_missing_templates", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for EditorExportPlatformExtension {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorExportPlatformExtension"));
            * name
        }
