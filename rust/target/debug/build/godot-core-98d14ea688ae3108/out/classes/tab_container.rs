...
pub(super) mod re_export {
    ...
    impl TabContainer {
        pub fn get_tab_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_current_tab(&mut self, tab_idx: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_current_tab", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_current_tab(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_current_tab", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_previous_tab(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_previous_tab", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn select_previous_available(&mut self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "select_previous_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn select_next_available(&mut self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "select_next_available", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_current_tab_control(&self,) -> Option < Gd < crate::classes::Control > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_current_tab_control", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_bar(&self,) -> Option < Gd < crate::classes::TabBar > > {
            type CallRet = Option < Gd < crate::classes::TabBar > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8842usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_bar", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_control(&self, tab_idx: i32,) -> Option < Gd < crate::classes::Control > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_control", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_alignment(&mut self, alignment: crate::classes::tab_bar::AlignmentMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_alignment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_alignment(&self,) -> crate::classes::tab_bar::AlignmentMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_alignment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tabs_position(&mut self, tabs_position: crate::classes::tab_container::TabPosition,) {
            type CallRet = ();
            type CallParams = (crate::classes::tab_container::TabPosition,);
            let args = (tabs_position,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8846usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tabs_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tabs_position(&self,) -> crate::classes::tab_container::TabPosition {
            type CallRet = crate::classes::tab_container::TabPosition;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8847usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tabs_position", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_clip_tabs(&mut self, clip_tabs: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_clip_tabs", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_clip_tabs(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_clip_tabs", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tabs_visible(&mut self, visible: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tabs_visible", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn are_tabs_visible(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "are_tabs_visible", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_all_tabs_in_front(&mut self, is_front: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_all_tabs_in_front", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_all_tabs_in_front(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "is_all_tabs_in_front", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_title(&mut self, tab_idx: i32, title: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_title", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_title(&self, tab_idx: i32,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_title", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_tooltip(&mut self, tab_idx: i32, tooltip: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_tooltip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_tooltip(&self, tab_idx: i32,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_tooltip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_icon(&mut self, tab_idx: i32, icon: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_icon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_icon(&self, tab_idx: i32,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_icon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_icon_max_width(&mut self, tab_idx: i32, width: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_icon_max_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_icon_max_width(&self, tab_idx: i32,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_icon_max_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_disabled(&mut self, tab_idx: i32, disabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_tab_disabled(&self, tab_idx: i32,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "is_tab_disabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_hidden(&mut self, tab_idx: i32, hidden: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_hidden", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_tab_hidden(&self, tab_idx: i32,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "is_tab_hidden", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_metadata(&mut self, tab_idx: i32, metadata: &Variant,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_metadata", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_metadata(&self, tab_idx: i32,) -> Variant {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_metadata", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_button_icon(&mut self, tab_idx: i32, icon: impl AsObjectArg < crate::classes::Texture2D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_button_icon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_button_icon(&self, tab_idx: i32,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_button_icon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_idx_at_point(&self, point: Vector2,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_idx_at_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_idx_from_control(&self, control: impl AsObjectArg < crate::classes::Control >,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_idx_from_control", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_popup(&mut self, popup: impl AsObjectArg < crate::classes::Node >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Node >,);
            let args = (popup.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8872usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_popup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_popup(&self,) -> Option < Gd < crate::classes::Popup > > {
            type CallRet = Option < Gd < crate::classes::Popup > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8873usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_popup", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_drag_to_rearrange_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_drag_to_rearrange_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_drag_to_rearrange_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_drag_to_rearrange_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tabs_rearrange_group(&mut self, group_id: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tabs_rearrange_group", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tabs_rearrange_group(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tabs_rearrange_group", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_hidden_tabs_for_min_size(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_use_hidden_tabs_for_min_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_use_hidden_tabs_for_min_size(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_use_hidden_tabs_for_min_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_tab_focus_mode(&mut self, focus_mode: crate::classes::control::FocusMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_tab_focus_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_tab_focus_mode(&self,) -> crate::classes::control::FocusMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_tab_focus_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_deselect_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "set_deselect_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_deselect_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "TabContainer", "get_deselect_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_TabContainer__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for TabPosition {
    ...
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < TabPosition >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("TOP", "POSITION_TOP", TabPosition::TOP), crate::meta::inspect::EnumConstant::new("BOTTOM", "POSITION_BOTTOM", TabPosition::BOTTOM), crate::meta::inspect::EnumConstant::new("MAX", "POSITION_MAX", TabPosition::MAX)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::TabContainer;
    use crate::registry::signal::TypedSignal;
    use super::*;
    #[doc = "A collection of signals for the [`TabContainer`][crate::classes::TabContainer] class."]
    pub struct SignalsOfTabContainer < 'c, C: WithSignals > {
        #[doc(hidden)]
        pub(crate) __internal_obj: Option < C::__SignalObj < 'c >>,
    }
    impl < 'c, C: WithSignals > SignalsOfTabContainer < 'c, C > {
        ...
        #[doc = "Signature: `()`"]
        pub fn pre_popup_pressed(&mut self) -> SigPrePopupPressed < 'c, C > {
            SigPrePopupPressed {
                typed: TypedSignal::extract(&mut self.__internal_obj, "pre_popup_pressed")
            }
        }
    }
    ...
    type TypedSigPrePopupPressed < 'c, C > = TypedSignal < 'c, C, () >;
    pub struct SigPrePopupPressed < 'c, C: WithSignals > {
        typed: TypedSigPrePopupPressed < 'c, C >,
    }
    impl < 'c, C: WithSignals > SigPrePopupPressed < 'c, C > {
        pub fn emit(&mut self,) {
            self.typed.emit_tuple(());
            
        }
    }
    impl < 'c, C: WithSignals > std::ops::Deref for SigPrePopupPressed < 'c, C > {
        type Target = TypedSigPrePopupPressed < 'c, C >;
        fn deref(&self) -> &Self::Target {
            &self.typed
        }
    }
    impl < C: WithSignals > std::ops::DerefMut for SigPrePopupPressed < '_, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.typed
        }
    }
    use crate::obj::WithSignals;
    impl WithSignals for TabContainer {
        type SignalCollection < 'c, C: WithSignals > = SignalsOfTabContainer < 'c, C >;
    ...
    impl < 'c, C: WithSignals > std::ops::Deref for SignalsOfTabContainer < 'c, C > {
        type Target = < < TabContainer as crate::obj::GodotClass > ::Base as WithSignals > ::SignalCollection < 'c, C >;
        fn deref(&self) -> &Self::Target {
            type Derived = TabContainer;
            crate::private::signal_collection_to_base::< C, Derived > (self)
        }
    }
    impl < 'c, C: WithSignals > std::ops::DerefMut for SignalsOfTabContainer < 'c, C > {
        fn deref_mut(&mut self) -> &mut Self::Target {
            type Derived = TabContainer;
