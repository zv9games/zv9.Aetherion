    ...
    impl StreamPeerTcp {
        pub(crate) fn bind_full(&mut self, port: i32, host: CowArg < GString >,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "bind", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn connect_to_host(&mut self, host: impl AsArg < GString >, port: i32,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "connect_to_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn poll(&mut self,) -> crate::global::Error {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "poll", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_status(&self,) -> crate::classes::stream_peer_tcp::Status {
            type CallRet = crate::classes::stream_peer_tcp::Status;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(8599usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "get_status", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_connected_host(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "get_connected_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_connected_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "get_connected_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_local_port(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "get_local_port", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn disconnect_from_host(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "disconnect_from_host", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_no_delay(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StreamPeerTcp", "set_no_delay", self.object_ptr, self.__checked_id(), args,)
            }
        }
...
impl crate::obj::EngineEnum for Status {
    ...
    fn values() -> &'static[Self] {
        &[Status::NONE, Status::CONNECTING, Status::CONNECTED, Status::ERROR]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < Status >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("NONE", "STATUS_NONE", Status::NONE), crate::meta::inspect::EnumConstant::new("CONNECTING", "STATUS_CONNECTING", Status::CONNECTING), crate::meta::inspect::EnumConstant::new("CONNECTED", "STATUS_CONNECTED", Status::CONNECTED), crate::meta::inspect::EnumConstant::new("ERROR", "STATUS_ERROR", Status::ERROR)]
        }
    }
}
