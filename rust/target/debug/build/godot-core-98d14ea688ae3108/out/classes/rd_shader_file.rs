...
pub(super) mod re_export {
    ...
    impl RdShaderFile {
        pub(crate) fn set_bytecode_full(&mut self, bytecode: ObjectArg < crate::classes::RdShaderSpirv >, version: CowArg < StringName >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (ObjectArg < crate::classes::RdShaderSpirv >, CowArg < 'a0, StringName >,);
            let args = (bytecode, version,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7095usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdShaderFile", "set_bytecode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn get_spirv_full(&self, version: CowArg < StringName >,) -> Option < Gd < crate::classes::RdShaderSpirv > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdShaderFile", "get_spirv", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_version_list(&self,) -> Array < StringName > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdShaderFile", "get_version_list", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_base_error(&mut self, error: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdShaderFile", "set_base_error", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_base_error(&self,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdShaderFile", "get_base_error", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_RdShaderFile__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::RdShaderFile;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for RdShaderFile {
