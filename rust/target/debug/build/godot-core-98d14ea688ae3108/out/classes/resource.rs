...
pub(super) mod re_export {
    ...
    impl Resource {
        ...
        pub(crate) fn duplicate_full(&self, subresources: bool,) -> Option < Gd < crate::classes::Resource > > {
    ...
    impl crate::obj::GodotClass for Resource {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Resource"));
            * name
        }
...
pub struct ExDuplicate < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a re_export::Resource, subresources: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExDuplicate < 'a > {
    fn new(surround_object: &'a re_export::Resource,) -> Self {
        let subresources = false;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, subresources: subresources,
        }
    }
    #[inline]
    pub fn subresources(self, subresources: bool) -> Self {
        Self {
            subresources: subresources, .. self
        }
    }
    #[inline]
    pub fn done(self) -> Option < Gd < crate::classes::Resource > > {
        let Self {
            _phantom, surround_object, subresources,
        }
        = self;
        re_export::Resource::duplicate_full(surround_object, subresources,)
    }
}
pub use signals::*;
mod signals {
