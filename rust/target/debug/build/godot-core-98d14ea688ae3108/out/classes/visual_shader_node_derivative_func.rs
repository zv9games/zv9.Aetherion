...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeDerivativeFunc {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeDerivativeFunc"));
            * name
        }
...
impl crate::obj::EngineEnum for Function {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SUM => "FUNC_SUM", Self::X => "FUNC_X", Self::Y => "FUNC_Y", Self::MAX => "FUNC_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for Precision {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "PRECISION_NONE", Self::COARSE => "PRECISION_COARSE", Self::FINE => "PRECISION_FINE", Self::MAX => "PRECISION_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
