...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeFloatFunc {
        pub fn set_function(&mut self, func: crate::classes::visual_shader_node_float_func::Function,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatFunc", "set_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_function(&self,) -> crate::classes::visual_shader_node_float_func::Function {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatFunc", "get_function", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for VisualShaderNodeFloatFunc {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeFloatFunc"));
            * name
        }
...
impl crate::obj::EngineEnum for Function {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::SIN => "FUNC_SIN", Self::COS => "FUNC_COS", Self::TAN => "FUNC_TAN", Self::ASIN => "FUNC_ASIN", Self::ACOS => "FUNC_ACOS", Self::ATAN => "FUNC_ATAN", Self::SINH => "FUNC_SINH", Self::COSH => "FUNC_COSH", Self::TANH => "FUNC_TANH", Self::LOG => "FUNC_LOG", Self::EXP => "FUNC_EXP", Self::SQRT => "FUNC_SQRT", Self::ABS => "FUNC_ABS", Self::SIGN => "FUNC_SIGN", Self::FLOOR => "FUNC_FLOOR", Self::ROUND => "FUNC_ROUND", Self::CEIL => "FUNC_CEIL", Self::FRACT => "FUNC_FRACT", Self::SATURATE => "FUNC_SATURATE", Self::NEGATE => "FUNC_NEGATE", Self::ACOSH => "FUNC_ACOSH", Self::ASINH => "FUNC_ASINH", Self::ATANH => "FUNC_ATANH", Self::DEGREES => "FUNC_DEGREES", Self::EXP2 => "FUNC_EXP2", Self::INVERSE_SQRT => "FUNC_INVERSE_SQRT", Self::LOG2 => "FUNC_LOG2", Self::RADIANS => "FUNC_RADIANS", Self::RECIPROCAL => "FUNC_RECIPROCAL", Self::ROUNDEVEN => "FUNC_ROUNDEVEN", Self::TRUNC => "FUNC_TRUNC", Self::ONEMINUS => "FUNC_ONEMINUS", Self::MAX => "FUNC_MAX", _ => self.as_str(),
        }
    }
