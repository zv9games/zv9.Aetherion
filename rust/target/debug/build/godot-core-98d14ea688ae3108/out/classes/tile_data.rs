...
pub(super) mod re_export {
    ...
    impl TileData {
        ...
        pub fn set_occluder_polygon(&mut self, layer_id: i32, polygon_index: i32, polygon: impl AsObjectArg < crate::classes::OccluderPolygon2D >,) {
            type CallRet = ();
            type CallParams = (i32, i32, ObjectArg < crate::classes::OccluderPolygon2D >,);
            let args = (layer_id, polygon_index, polygon.as_object_arg(),);
            unsafe {
        ...
        pub fn set_occluder(&mut self, layer_id: i32, occluder_polygon: impl AsObjectArg < crate::classes::OccluderPolygon2D >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::OccluderPolygon2D >,);
