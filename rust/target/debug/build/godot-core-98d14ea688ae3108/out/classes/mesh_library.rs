...
pub(super) mod re_export {
    ...
    impl MeshLibrary {
        pub fn create_item(&mut self, id: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "create_item", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_name(&mut self, id: i32, name: impl AsArg < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_mesh(&mut self, id: i32, mesh: impl AsObjectArg < crate::classes::Mesh >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Mesh >,);
            let args = (id, mesh.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5379usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_mesh_transform(&mut self, id: i32, mesh_transform: Transform3D,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_mesh_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_mesh_cast_shadow(&mut self, id: i32, shadow_casting_setting: crate::classes::rendering_server::ShadowCastingSetting,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_mesh_cast_shadow", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_navigation_mesh_transform(&mut self, id: i32, navigation_mesh: Transform3D,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_navigation_mesh_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_navigation_layers(&mut self, id: i32, navigation_layers: u32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_navigation_layers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_shapes(&mut self, id: i32, shapes: &VariantArray,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_shapes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_item_preview(&mut self, id: i32, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Texture2D >,);
            let args = (id, texture.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5385usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "set_item_preview", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_name(&self, id: i32,) -> GString {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_mesh(&self, id: i32,) -> Option < Gd < crate::classes::Mesh > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_mesh_transform(&self, id: i32,) -> Transform3D {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_mesh_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_mesh_cast_shadow(&self, id: i32,) -> crate::classes::rendering_server::ShadowCastingSetting {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_mesh_cast_shadow", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_navigation_mesh_transform(&self, id: i32,) -> Transform3D {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_navigation_mesh_transform", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_navigation_layers(&self, id: i32,) -> u32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_navigation_layers", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_shapes(&self, id: i32,) -> VariantArray {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_shapes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_preview(&self, id: i32,) -> Option < Gd < crate::classes::Texture2D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_preview", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn remove_item(&mut self, id: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "remove_item", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_item_by_name(&self, name: impl AsArg < GString >,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "find_item_by_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "clear", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_item_list(&self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_item_list", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_last_unused_item_id(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshLibrary", "get_last_unused_item_id", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for MeshLibrary {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"MeshLibrary"));
            * name
        }
