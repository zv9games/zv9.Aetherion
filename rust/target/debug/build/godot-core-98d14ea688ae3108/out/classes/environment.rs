...
pub(super) mod re_export {
    ...
    impl Environment {
        ...
        pub fn set_sky(&mut self, sky: impl AsObjectArg < crate::classes::Sky >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Sky >,);
        ...
        pub fn set_glow_map(&mut self, mode: impl AsObjectArg < crate::classes::Texture >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Texture >,);
...
impl crate::obj::EngineEnum for ToneMapper {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LINEAR => "TONE_MAPPER_LINEAR", Self::REINHARDT => "TONE_MAPPER_REINHARDT", Self::FILMIC => "TONE_MAPPER_FILMIC", Self::ACES => "TONE_MAPPER_ACES", Self::AGX => "TONE_MAPPER_AGX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
