    ...
    impl FogMaterial {
        pub fn set_density(&mut self, density: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_density", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_density(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_density", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_albedo(&mut self, albedo: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_albedo", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_albedo(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_albedo", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_emission(&mut self, emission: Color,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_emission", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_emission(&self,) -> Color {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_emission", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height_falloff(&mut self, height_falloff: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_height_falloff", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_height_falloff(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_height_falloff", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_edge_fade(&mut self, edge_fade: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_edge_fade", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_edge_fade(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_edge_fade", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_density_texture(&mut self, density_texture: impl AsObjectArg < crate::classes::Texture3D >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "set_density_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_density_texture(&self,) -> Option < Gd < crate::classes::Texture3D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogMaterial", "get_density_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
