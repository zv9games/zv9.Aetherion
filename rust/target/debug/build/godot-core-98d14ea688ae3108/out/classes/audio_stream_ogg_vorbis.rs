...
pub(super) mod re_export {
    ...
    impl AudioStreamOggVorbis {
        pub fn load_from_buffer(stream_data: &PackedByteArray,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "load_from_buffer", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn load_from_file(path: impl AsArg < GString >,) -> Option < Gd < crate::classes::AudioStreamOggVorbis > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "load_from_file", std::ptr::null_mut(), None, args,)
            }
        }
        pub fn set_packet_sequence(&mut self, packet_sequence: impl AsObjectArg < crate::classes::OggPacketSequence >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OggPacketSequence >,);
            let args = (packet_sequence.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(888usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_packet_sequence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_packet_sequence(&self,) -> Option < Gd < crate::classes::OggPacketSequence > > {
            type CallRet = Option < Gd < crate::classes::OggPacketSequence > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(889usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "get_packet_sequence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_loop(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn has_loop(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "has_loop", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_loop_offset(&mut self, seconds: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_loop_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_loop_offset(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "get_loop_offset", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bpm(&mut self, bpm: f64,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_bpm", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bpm(&self,) -> f64 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "get_bpm", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_beat_count(&mut self, count: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_beat_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_beat_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "get_beat_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_bar_beats(&mut self, count: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "set_bar_beats", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bar_beats(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioStreamOggVorbis", "get_bar_beats", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioStreamOggVorbis {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"AudioStreamOggVorbis"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::AudioStream > for AudioStreamOggVorbis {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for AudioStreamOggVorbis {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`AudioStreamOggVorbis`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_AudioStreamOggVorbis__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::AudioStreamOggVorbis > for $Class {
...
mod signals {
    ...
    use super::re_export::AudioStreamOggVorbis;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::audio_stream::SignalsOfAudioStream;
    impl WithSignals for AudioStreamOggVorbis {
