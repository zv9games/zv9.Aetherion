...
pub(super) mod re_export {
    ...
    impl FileSystemDock {
        ...
        pub fn add_resource_tooltip_plugin(&mut self, plugin: impl AsObjectArg < crate::classes::EditorResourceTooltipPlugin >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorResourceTooltipPlugin >,);
        ...
        pub fn remove_resource_tooltip_plugin(&mut self, plugin: impl AsObjectArg < crate::classes::EditorResourceTooltipPlugin >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorResourceTooltipPlugin >,);
            let args = (plugin.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for FileSystemDock {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"FileSystemDock"));
            * name
        }
