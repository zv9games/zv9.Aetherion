...
pub(super) mod re_export {
    ...
    impl MeshInstance3D {
        pub fn set_mesh(&mut self, mesh: impl AsObjectArg < crate::classes::Mesh >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Mesh >,);
            let args = (mesh.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5356usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "set_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh(&self,) -> Option < Gd < crate::classes::Mesh > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skeleton_path(&mut self, skeleton_path: impl AsArg < NodePath >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "set_skeleton_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skeleton_path(&mut self,) -> NodePath {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_skeleton_path", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_skin(&mut self, skin: impl AsObjectArg < crate::classes::Skin >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Skin >,);
            let args = (skin.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5360usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "set_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skin(&self,) -> Option < Gd < crate::classes::Skin > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_skin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skin_reference(&self,) -> Option < Gd < crate::classes::SkinReference > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_skin_reference", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_surface_override_material_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_surface_override_material_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_surface_override_material(&mut self, surface: i32, material: impl AsObjectArg < crate::classes::Material >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Material >,);
            let args = (surface, material.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5364usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "set_surface_override_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_surface_override_material(&self, surface: i32,) -> Option < Gd < crate::classes::Material > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_surface_override_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_active_material(&self, surface: i32,) -> Option < Gd < crate::classes::Material > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_active_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_trimesh_collision(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "create_trimesh_collision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn create_convex_collision_full(&mut self, clean: bool, simplify: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "create_convex_collision", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn create_multiple_convex_collisions_full(&mut self, settings: ObjectArg < crate::classes::MeshConvexDecompositionSettings >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::MeshConvexDecompositionSettings >,);
            let args = (settings,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5369usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "create_multiple_convex_collisions", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub fn get_blend_shape_count(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_blend_shape_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn find_blend_shape_by_name(&mut self, name: impl AsArg < StringName >,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "find_blend_shape_by_name", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_blend_shape_value(&self, blend_shape_idx: i32,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "get_blend_shape_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_blend_shape_value(&mut self, blend_shape_idx: i32, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "set_blend_shape_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn create_debug_tangents(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "create_debug_tangents", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub(crate) fn bake_mesh_from_current_blend_shape_mix_full(&mut self, existing: ObjectArg < crate::classes::ArrayMesh >,) -> Option < Gd < crate::classes::ArrayMesh > > {
            ...
            type CallParams = (ObjectArg < crate::classes::ArrayMesh >,);
            let args = (existing,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5375usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "bake_mesh_from_current_blend_shape_mix", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn bake_mesh_from_current_skeleton_pose_full(&mut self, existing: ObjectArg < crate::classes::ArrayMesh >,) -> Option < Gd < crate::classes::ArrayMesh > > {
            type CallRet = Option < Gd < crate::classes::ArrayMesh > >;
            type CallParams = (ObjectArg < crate::classes::ArrayMesh >,);
            let args = (existing,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5376usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshInstance3D", "bake_mesh_from_current_skeleton_pose", self.object_ptr, self.__checked_id(), args,)
            }
        }
        #[doc = "To set the default parameters, use [`Self::bake_mesh_from_current_skeleton_pose_ex`] and its builder methods.  See [the book](https://godot-rust.github.io/book/godot-api/functions.html#default-parameters) for detailed usage instructions."]
        #[inline]
        ...
        #[inline]
        pub fn bake_mesh_from_current_skeleton_pose_ex < 'a > (&'a mut self,) -> ExBakeMeshFromCurrentSkeletonPose < 'a > {
...
#[must_use]
pub struct ExBakeMeshFromCurrentSkeletonPose < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::MeshInstance3D, existing: ObjectCow < crate::classes::ArrayMesh >,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExBakeMeshFromCurrentSkeletonPose < 'a > {
    fn new(surround_object: &'a mut re_export::MeshInstance3D,) -> Self {
        let existing = Gd::null_arg();
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, existing: existing.consume_arg(),
    ...
    pub fn done(self) -> Option < Gd < crate::classes::ArrayMesh > > {
        ...
        = self;
        re_export::MeshInstance3D::bake_mesh_from_current_skeleton_pose_full(surround_object, existing.cow_as_object_arg(),)
    }
}
pub use signals::*;
mod signals {
