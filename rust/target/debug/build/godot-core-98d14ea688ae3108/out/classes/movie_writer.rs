...
pub(super) mod re_export {
    ...
    pub trait IMovieWriter: crate::obj::GodotClass < Base = MovieWriter > + crate::private::You_forgot_the_attribute__godot_api {
        ...
        unsafe fn write_frame_rawptr(&mut self, frame_image: Option < Gd < crate::classes::Image > >, audio_frame_block: * const c_void,) -> crate::global::Error;
        fn write_end(&mut self,);
        
    }
    impl MovieWriter {
        pub fn add_writer(writer: impl AsObjectArg < crate::classes::MovieWriter >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::MovieWriter >,);
            let args = (writer.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5438usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MovieWriter", "add_writer", std::ptr::null_mut(), None, args,)
            }
        }
    ...
    impl crate::obj::GodotClass for MovieWriter {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"MovieWriter"));
            * name
        }
