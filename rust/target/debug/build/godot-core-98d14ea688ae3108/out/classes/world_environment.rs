...
pub(super) mod re_export {
    ...
    impl WorldEnvironment {
        pub fn set_environment(&mut self, env: impl AsObjectArg < crate::classes::Environment >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "WorldEnvironment", "set_environment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_environment(&self,) -> Option < Gd < crate::classes::Environment > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "WorldEnvironment", "get_environment", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_camera_attributes(&mut self, camera_attributes: impl AsObjectArg < crate::classes::CameraAttributes >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "WorldEnvironment", "set_camera_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_camera_attributes(&self,) -> Option < Gd < crate::classes::CameraAttributes > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "WorldEnvironment", "get_camera_attributes", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for WorldEnvironment {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"WorldEnvironment"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::Node > for WorldEnvironment {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for WorldEnvironment {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`WorldEnvironment`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_WorldEnvironment__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::WorldEnvironment > for $Class {
...
mod signals {
    ...
    use super::re_export::WorldEnvironment;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::node::SignalsOfNode;
    impl WithSignals for WorldEnvironment {
