...
pub(super) mod re_export {
    ...
    impl VehicleWheel3D {
        pub fn set_radius(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_radius(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_radius", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_suspension_rest_length(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_suspension_rest_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_suspension_rest_length(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_suspension_rest_length", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_suspension_travel(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_suspension_travel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_suspension_travel(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_suspension_travel", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_suspension_stiffness(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_suspension_stiffness", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_suspension_stiffness(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_suspension_stiffness", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_suspension_max_force(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_suspension_max_force", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_suspension_max_force(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_suspension_max_force", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_damping_compression(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_damping_compression", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_damping_compression(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_damping_compression", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_damping_relaxation(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_damping_relaxation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_damping_relaxation(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_damping_relaxation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_as_traction(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_use_as_traction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_used_as_traction(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "is_used_as_traction", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_as_steering(&mut self, enable: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_use_as_steering", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_used_as_steering(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "is_used_as_steering", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_friction_slip(&mut self, length: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_friction_slip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_friction_slip(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_friction_slip", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_in_contact(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "is_in_contact", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_contact_body(&self,) -> Option < Gd < crate::classes::Node3D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_contact_body", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_contact_point(&self,) -> Vector3 {
            type CallRet = Vector3;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10383usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_contact_point", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_contact_normal(&self,) -> Vector3 {
            type CallRet = Vector3;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10384usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_contact_normal", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_roll_influence(&mut self, roll_influence: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_roll_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_roll_influence(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_roll_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_skidinfo(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_skidinfo", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_rpm(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_rpm", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_engine_force(&mut self, engine_force: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_engine_force", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_engine_force(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_engine_force", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_brake(&mut self, brake: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_brake", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_brake(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_brake", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_steering(&mut self, steering: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "set_steering", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_steering(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VehicleWheel3D", "get_steering", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_VehicleWheel3D__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::VehicleWheel3D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::node_3d::SignalsOfNode3D;
    impl WithSignals for VehicleWheel3D {
