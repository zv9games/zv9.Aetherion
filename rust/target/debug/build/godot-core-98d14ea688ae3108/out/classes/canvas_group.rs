...
pub(super) mod re_export {
    ...
    impl CanvasGroup {
        pub fn set_fit_margin(&mut self, fit_margin: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "set_fit_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fit_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "get_fit_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_clear_margin(&mut self, clear_margin: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "set_clear_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_clear_margin(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "get_clear_margin", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_mipmaps(&mut self, use_mipmaps: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "set_use_mipmaps", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_using_mipmaps(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "CanvasGroup", "is_using_mipmaps", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_CanvasGroup__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::CanvasGroup;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::canvas_item::SignalsOfCanvasItem;
    impl WithSignals for CanvasGroup {
