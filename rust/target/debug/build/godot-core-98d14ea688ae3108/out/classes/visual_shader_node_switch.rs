...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for VisualShaderNodeSwitch {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeSwitch"));
            * name
        }
...
impl crate::obj::EngineEnum for OpType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::FLOAT => "OP_TYPE_FLOAT", Self::INT => "OP_TYPE_INT", Self::UINT => "OP_TYPE_UINT", Self::VECTOR_2D => "OP_TYPE_VECTOR_2D", Self::VECTOR_3D => "OP_TYPE_VECTOR_3D", Self::VECTOR_4D => "OP_TYPE_VECTOR_4D", Self::BOOLEAN => "OP_TYPE_BOOLEAN", Self::TRANSFORM => "OP_TYPE_TRANSFORM", Self::MAX => "OP_TYPE_MAX", _ => self.as_str(),
        }
    }
