...
pub(super) mod re_export {
    ...
    impl TreeItem {
        ...
        pub fn set_icon_overlay(&mut self, column: i32, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Texture2D >,);
            let args = (column, texture.as_object_arg(),);
            unsafe {
        ...
        pub fn set_custom_draw(&mut self, column: i32, object: impl AsObjectArg < crate::classes::Object >, callback: impl AsArg < StringName >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (i32, ObjectArg < crate::classes::Object >, CowArg < 'a0, StringName >,);
        ...
        pub fn set_custom_font(&mut self, column: i32, font: impl AsObjectArg < crate::classes::Font >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Font >,);
        ...
        pub(crate) fn add_button_full(&mut self, column: i32, button: ObjectArg < crate::classes::Texture2D >, id: i32, disabled: bool, tooltip_text: CowArg < GString >,) {
            type CallRet = ();
            type CallParams < 'a0, > = (i32, ObjectArg < crate::classes::Texture2D >, i32, bool, CowArg < 'a0, GString >,);
        ...
        pub fn add_child(&mut self, child: impl AsObjectArg < crate::classes::TreeItem >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::TreeItem >,);
