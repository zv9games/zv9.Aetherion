...
impl crate::obj::EngineEnum for ColorModeType {
    ...
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < ColorModeType >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("RGB", "MODE_RGB", ColorModeType::RGB), crate::meta::inspect::EnumConstant::new("HSV", "MODE_HSV", ColorModeType::HSV), crate::meta::inspect::EnumConstant::new("RAW", "MODE_RAW", ColorModeType::RAW), crate::meta::inspect::EnumConstant::new("OKHSL", "MODE_OKHSL", ColorModeType::OKHSL)]
        }
    }
}
