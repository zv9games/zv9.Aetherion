...
pub(super) mod re_export {
    ...
    impl Polygon2D {
        ...
        pub fn add_bone(&mut self, path: impl AsArg < NodePath >, weights: &PackedFloat32Array,) {
            ...
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6735usize);
        ...
        pub fn get_bone_count(&self,) -> i32 {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(6736usize);
    ...
    impl crate::obj::GodotClass for Polygon2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Polygon2D"));
            * name
        }
