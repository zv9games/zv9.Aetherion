...
pub(super) mod re_export {
    ...
    impl SyntaxHighlighter {
        pub fn get_line_syntax_highlighting(&mut self, line: i32,) -> Dictionary {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "get_line_syntax_highlighting", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_cache(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "update_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn clear_highlighting_cache(&mut self,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "clear_highlighting_cache", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_text_edit(&self,) -> Option < Gd < crate::classes::TextEdit > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SyntaxHighlighter", "get_text_edit", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SyntaxHighlighter {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"SyntaxHighlighter"));
            * name
        }
