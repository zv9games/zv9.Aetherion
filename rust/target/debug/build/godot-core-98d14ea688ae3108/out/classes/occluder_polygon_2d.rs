...
pub(super) mod re_export {
    ...
    impl OccluderPolygon2D {
        pub fn set_closed(&mut self, closed: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "set_closed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_closed(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "is_closed", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_cull_mode(&mut self, cull_mode: crate::classes::occluder_polygon_2d::CullMode,) {
            type CallRet = ();
            type CallParams = (crate::classes::occluder_polygon_2d::CullMode,);
            let args = (cull_mode,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5969usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "set_cull_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cull_mode(&self,) -> crate::classes::occluder_polygon_2d::CullMode {
            type CallRet = crate::classes::occluder_polygon_2d::CullMode;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5970usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "get_cull_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_polygon(&mut self, polygon: &PackedVector2Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "set_polygon", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_polygon(&self,) -> PackedVector2Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "OccluderPolygon2D", "get_polygon", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_OccluderPolygon2D__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for CullMode {
    ...
    fn values() -> &'static[Self] {
        &[CullMode::DISABLED, CullMode::CLOCKWISE, CullMode::COUNTER_CLOCKWISE]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < CullMode >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("DISABLED", "CULL_DISABLED", CullMode::DISABLED), crate::meta::inspect::EnumConstant::new("CLOCKWISE", "CULL_CLOCKWISE", CullMode::CLOCKWISE), crate::meta::inspect::EnumConstant::new("COUNTER_CLOCKWISE", "CULL_COUNTER_CLOCKWISE", CullMode::COUNTER_CLOCKWISE)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::OccluderPolygon2D;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for OccluderPolygon2D {
