...
pub(super) mod re_export {
    ...
    impl RenderingServer {
        ...
        pub fn texture_2d_update(&mut self, texture: Rid, image: impl AsObjectArg < crate::classes::Image >, layer: i32,) {
            type CallRet = ();
            type CallParams = (Rid, ObjectArg < crate::classes::Image >, i32,);
        ...
        pub fn instance_set_interpolated(&mut self, instance: Rid, interpolated: bool,) {
            type CallRet = ();
            type CallParams = (Rid, bool,);
            let args = (instance, interpolated,);
            unsafe {
                let method_bind = sys::class_servers_api() . fptr_by_index(867usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RenderingServer", "instance_set_interpolated", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn instance_reset_physics_interpolation(&mut self, instance: Rid,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RenderingServer", "instance_reset_physics_interpolation", self.object_ptr, self.__checked_id(), args,)
            }
        }
        ...
        pub(crate) fn set_boot_image_full(&mut self, image: ObjectArg < crate::classes::Image >, color: Color, scale: bool, use_filter: bool,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >, Color, bool, bool,);
...
impl crate::obj::EngineEnum for TextureType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::TYPE_2D => "TEXTURE_TYPE_2D", Self::LAYERED => "TEXTURE_TYPE_LAYERED", Self::TYPE_3D => "TEXTURE_TYPE_3D", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for MultimeshPhysicsInterpolationQuality {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::FAST => "MULTIMESH_INTERP_QUALITY_FAST", Self::HIGH => "MULTIMESH_INTERP_QUALITY_HIGH", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for ViewportScaling3DMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::BILINEAR => "VIEWPORT_SCALING_3D_MODE_BILINEAR", Self::FSR => "VIEWPORT_SCALING_3D_MODE_FSR", Self::FSR2 => "VIEWPORT_SCALING_3D_MODE_FSR2", Self::METALFX_SPATIAL => "VIEWPORT_SCALING_3D_MODE_METALFX_SPATIAL", Self::METALFX_TEMPORAL => "VIEWPORT_SCALING_3D_MODE_METALFX_TEMPORAL", Self::MAX => "VIEWPORT_SCALING_3D_MODE_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for ViewportAnisotropicFiltering {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DISABLED => "VIEWPORT_ANISOTROPY_DISABLED", Self::ANISOTROPY_2X => "VIEWPORT_ANISOTROPY_2X", Self::ANISOTROPY_4X => "VIEWPORT_ANISOTROPY_4X", Self::ANISOTROPY_8X => "VIEWPORT_ANISOTROPY_8X", Self::ANISOTROPY_16X => "VIEWPORT_ANISOTROPY_16X", Self::MAX => "VIEWPORT_ANISOTROPY_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for EnvironmentToneMapper {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LINEAR => "ENV_TONE_MAPPER_LINEAR", Self::REINHARD => "ENV_TONE_MAPPER_REINHARD", Self::FILMIC => "ENV_TONE_MAPPER_FILMIC", Self::ACES => "ENV_TONE_MAPPER_ACES", Self::AGX => "ENV_TONE_MAPPER_AGX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for PipelineSource {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::CANVAS => "PIPELINE_SOURCE_CANVAS", Self::MESH => "PIPELINE_SOURCE_MESH", Self::SURFACE => "PIPELINE_SOURCE_SURFACE", Self::DRAW => "PIPELINE_SOURCE_DRAW", Self::SPECIALIZATION => "PIPELINE_SOURCE_SPECIALIZATION", Self::MAX => "PIPELINE_SOURCE_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
