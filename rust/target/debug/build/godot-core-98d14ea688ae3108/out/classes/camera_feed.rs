...
pub(super) mod re_export {
    ...
    impl CameraFeed {
        ...
        pub fn set_rgb_image(&mut self, rgb_image: impl AsObjectArg < crate::classes::Image >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >,);
            let args = (rgb_image.as_object_arg(),);
            unsafe {
        ...
        pub fn set_ycbcr_image(&mut self, ycbcr_image: impl AsObjectArg < crate::classes::Image >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >,);
            let args = (ycbcr_image.as_object_arg(),);
            unsafe {
...
impl crate::obj::EngineEnum for FeedDataType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NOIMAGE => "FEED_NOIMAGE", Self::RGB => "FEED_RGB", Self::YCBCR => "FEED_YCBCR", Self::YCBCR_SEP => "FEED_YCBCR_SEP", Self::EXTERNAL => "FEED_EXTERNAL", _ => self.as_str(),
        }
    }
