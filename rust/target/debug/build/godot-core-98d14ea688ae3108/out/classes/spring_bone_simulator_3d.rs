...
pub(super) mod re_export {
    ...
    impl SpringBoneSimulator3D {
        ...
        pub fn set_radius_damping_curve(&mut self, index: i32, curve: impl AsObjectArg < crate::classes::Curve >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Curve >,);
            let args = (index, curve.as_object_arg(),);
            unsafe {
        ...
        pub fn set_stiffness_damping_curve(&mut self, index: i32, curve: impl AsObjectArg < crate::classes::Curve >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Curve >,);
            let args = (index, curve.as_object_arg(),);
            unsafe {
        ...
        pub fn set_drag_damping_curve(&mut self, index: i32, curve: impl AsObjectArg < crate::classes::Curve >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Curve >,);
            let args = (index, curve.as_object_arg(),);
            unsafe {
        ...
        pub fn set_gravity_damping_curve(&mut self, index: i32, curve: impl AsObjectArg < crate::classes::Curve >,) {
            type CallRet = ();
            type CallParams = (i32, ObjectArg < crate::classes::Curve >,);
            let args = (index, curve.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for SpringBoneSimulator3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"SpringBoneSimulator3D"));
            * name
        }
...
impl crate::obj::EngineEnum for BoneDirection {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::PLUS_X => "BONE_DIRECTION_PLUS_X", Self::MINUS_X => "BONE_DIRECTION_MINUS_X", Self::PLUS_Y => "BONE_DIRECTION_PLUS_Y", Self::MINUS_Y => "BONE_DIRECTION_MINUS_Y", Self::PLUS_Z => "BONE_DIRECTION_PLUS_Z", Self::MINUS_Z => "BONE_DIRECTION_MINUS_Z", Self::FROM_PARENT => "BONE_DIRECTION_FROM_PARENT", _ => self.as_str(),
        }
    }
...
impl crate::obj::EngineEnum for CenterFrom {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::WORLD_ORIGIN => "CENTER_FROM_WORLD_ORIGIN", Self::NODE => "CENTER_FROM_NODE", Self::BONE => "CENTER_FROM_BONE", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for RotationAxis {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::X => "ROTATION_AXIS_X", Self::Y => "ROTATION_AXIS_Y", Self::Z => "ROTATION_AXIS_Z", Self::ALL => "ROTATION_AXIS_ALL", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
        &[RotationAxis::X, RotationAxis::Y, RotationAxis::Z, RotationAxis::ALL]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < RotationAxis >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("X", "ROTATION_AXIS_X", RotationAxis::X), crate::meta::inspect::EnumConstant::new("Y", "ROTATION_AXIS_Y", RotationAxis::Y), crate::meta::inspect::EnumConstant::new("Z", "ROTATION_AXIS_Z", RotationAxis::Z), crate::meta::inspect::EnumConstant::new("ALL", "ROTATION_AXIS_ALL", RotationAxis::ALL)]
        }
    }
}
