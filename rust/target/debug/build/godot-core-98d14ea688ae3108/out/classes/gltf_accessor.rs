...
impl crate::obj::EngineEnum for GltfComponentType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NONE => "COMPONENT_TYPE_NONE", Self::SIGNED_BYTE => "COMPONENT_TYPE_SIGNED_BYTE", Self::UNSIGNED_BYTE => "COMPONENT_TYPE_UNSIGNED_BYTE", Self::SIGNED_SHORT => "COMPONENT_TYPE_SIGNED_SHORT", Self::UNSIGNED_SHORT => "COMPONENT_TYPE_UNSIGNED_SHORT", Self::SIGNED_INT => "COMPONENT_TYPE_SIGNED_INT", Self::UNSIGNED_INT => "COMPONENT_TYPE_UNSIGNED_INT", Self::SINGLE_FLOAT => "COMPONENT_TYPE_SINGLE_FLOAT", Self::DOUBLE_FLOAT => "COMPONENT_TYPE_DOUBLE_FLOAT", Self::HALF_FLOAT => "COMPONENT_TYPE_HALF_FLOAT", Self::SIGNED_LONG => "COMPONENT_TYPE_SIGNED_LONG", Self::UNSIGNED_LONG => "COMPONENT_TYPE_UNSIGNED_LONG", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
