...
pub(super) mod re_export {
    ...
    impl NoiseTexture3D {
        pub fn set_width(&mut self, width: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_height(&mut self, height: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_depth(&mut self, depth: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_invert(&mut self, invert: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_invert", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_invert(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_invert", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_seamless(&mut self, seamless: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_seamless", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_seamless(&mut self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_seamless", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_seamless_blend_skirt(&mut self, seamless_blend_skirt: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_seamless_blend_skirt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_seamless_blend_skirt(&mut self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_seamless_blend_skirt", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_normalize(&mut self, normalize: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_normalize", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_normalized(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "is_normalized", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_color_ramp(&mut self, gradient: impl AsObjectArg < crate::classes::Gradient >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Gradient >,);
            let args = (gradient.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5873usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_color_ramp", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_color_ramp(&self,) -> Option < Gd < crate::classes::Gradient > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_color_ramp", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_noise(&mut self, noise: impl AsObjectArg < crate::classes::Noise >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Noise >,);
            let args = (noise.as_object_arg(),);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5875usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "set_noise", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_noise(&mut self,) -> Option < Gd < crate::classes::Noise > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "NoiseTexture3D", "get_noise", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for NoiseTexture3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"NoiseTexture3D"));
            * name
        }
