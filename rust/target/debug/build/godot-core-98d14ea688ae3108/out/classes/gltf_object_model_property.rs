...
pub(super) mod re_export {
    ...
    impl GltfObjectModelProperty {
        ...
        pub fn set_gltf_to_godot_expression(&mut self, gltf_to_godot_expr: impl AsObjectArg < crate::classes::Expression >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Expression >,);
            let args = (gltf_to_godot_expr.as_object_arg(),);
            unsafe {
        ...
        pub fn set_godot_to_gltf_expression(&mut self, godot_to_gltf_expr: impl AsObjectArg < crate::classes::Expression >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Expression >,);
            let args = (godot_to_gltf_expr.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for GltfObjectModelProperty {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GLTFObjectModelProperty"));
            * name
        }
...
impl crate::obj::EngineEnum for GltfObjectModelType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::UNKNOWN => "GLTF_OBJECT_MODEL_TYPE_UNKNOWN", Self::BOOL => "GLTF_OBJECT_MODEL_TYPE_BOOL", Self::FLOAT => "GLTF_OBJECT_MODEL_TYPE_FLOAT", Self::FLOAT_ARRAY => "GLTF_OBJECT_MODEL_TYPE_FLOAT_ARRAY", Self::FLOAT2 => "GLTF_OBJECT_MODEL_TYPE_FLOAT2", Self::FLOAT3 => "GLTF_OBJECT_MODEL_TYPE_FLOAT3", Self::FLOAT4 => "GLTF_OBJECT_MODEL_TYPE_FLOAT4", Self::FLOAT2X2 => "GLTF_OBJECT_MODEL_TYPE_FLOAT2X2", Self::FLOAT3X3 => "GLTF_OBJECT_MODEL_TYPE_FLOAT3X3", Self::FLOAT4X4 => "GLTF_OBJECT_MODEL_TYPE_FLOAT4X4", Self::INT => "GLTF_OBJECT_MODEL_TYPE_INT", _ => self.as_str(),
        }
    }
