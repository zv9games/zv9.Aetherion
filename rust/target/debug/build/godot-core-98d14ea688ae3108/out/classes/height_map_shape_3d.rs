...
pub(super) mod re_export {
    ...
    impl HeightMapShape3D {
        pub fn set_map_width(&mut self, width: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "set_map_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_map_width(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "get_map_width", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_map_depth(&mut self, height: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "set_map_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_map_depth(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "get_map_depth", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_map_data(&mut self, data: &PackedFloat32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "set_map_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_map_data(&self,) -> PackedFloat32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "get_map_data", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min_height(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "get_min_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max_height(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "get_max_height", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn update_map_data_from_image(&mut self, image: impl AsObjectArg < crate::classes::Image >, height_min: f32, height_max: f32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >, f32, f32,);
            let args = (image.as_object_arg(), height_min, height_max,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(4275usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "HeightMapShape3D", "update_map_data_from_image", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for HeightMapShape3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"HeightMapShape3D"));
            * name
        }
