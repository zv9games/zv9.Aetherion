...
pub(super) mod re_export {
    ...
    impl FogVolume {
        pub fn set_size(&mut self, size: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "set_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_size(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "get_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_shape(&mut self, shape: crate::classes::rendering_server::FogVolumeShape,) {
            type CallRet = ();
            type CallParams = (crate::classes::rendering_server::FogVolumeShape,);
            let args = (shape,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3396usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "set_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_shape(&self,) -> crate::classes::rendering_server::FogVolumeShape {
            type CallRet = crate::classes::rendering_server::FogVolumeShape;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3397usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "get_shape", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_material(&mut self, material: impl AsObjectArg < crate::classes::Material >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "set_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_material(&self,) -> Option < Gd < crate::classes::Material > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "FogVolume", "get_material", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for FogVolume {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"FogVolume"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::VisualInstance3D > for FogVolume {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node3D > for FogVolume {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for FogVolume {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for FogVolume {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`FogVolume`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_FogVolume__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::FogVolume > for $Class {
...
mod signals {
    ...
    use super::re_export::FogVolume;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::node_3d::SignalsOfNode3D;
    impl WithSignals for FogVolume {
