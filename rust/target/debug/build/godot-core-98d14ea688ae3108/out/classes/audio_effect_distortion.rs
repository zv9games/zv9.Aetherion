    ...
    impl AudioEffectDistortion {
        pub fn set_mode(&mut self, mode: crate::classes::audio_effect_distortion::Mode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "set_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mode(&self,) -> crate::classes::audio_effect_distortion::Mode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "get_mode", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_pre_gain(&mut self, pre_gain: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "set_pre_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pre_gain(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "get_pre_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_keep_hf_hz(&mut self, keep_hf_hz: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "set_keep_hf_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_keep_hf_hz(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "get_keep_hf_hz", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_drive(&mut self, drive: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "set_drive", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_drive(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "get_drive", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_post_gain(&mut self, post_gain: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "set_post_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_post_gain(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectDistortion", "get_post_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
