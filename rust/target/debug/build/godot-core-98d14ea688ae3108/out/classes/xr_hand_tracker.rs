...
impl crate::obj::EngineEnum for HandTrackingSource {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::UNKNOWN => "HAND_TRACKING_SOURCE_UNKNOWN", Self::UNOBSTRUCTED => "HAND_TRACKING_SOURCE_UNOBSTRUCTED", Self::CONTROLLER => "HAND_TRACKING_SOURCE_CONTROLLER", Self::NOT_TRACKED => "HAND_TRACKING_SOURCE_NOT_TRACKED", Self::MAX => "HAND_TRACKING_SOURCE_MAX", _ => self.as_str(),
        }
    }
