...
pub(super) mod re_export {
    ...
    impl Expression {
        ...
        pub(crate) fn execute_full(&mut self, inputs: RefArg < VariantArray >, base_instance: ObjectArg < crate::classes::Object >, show_error: bool, const_calls_only: bool,) -> Variant {
            type CallRet = Variant;
            type CallParams < 'a0, > = (RefArg < 'a0, VariantArray >, ObjectArg < crate::classes::Object >, bool, bool,);
    ...
    impl crate::obj::GodotClass for Expression {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Expression"));
            * name
        }
...
pub struct ExExecute < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::Expression, inputs: CowArg < 'a, VariantArray >, base_instance: ObjectCow < crate::classes::Object >, show_error: bool, const_calls_only: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExExecute < 'a > {
    fn new(surround_object: &'a mut re_export::Expression,) -> Self {
        ...
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, inputs: CowArg::Owned(inputs), base_instance: base_instance.consume_arg(), show_error: show_error, const_calls_only: const_calls_only,
        }
    }
    #[inline]
    ...
    #[inline]
    pub fn base_instance(self, base_instance: impl AsObjectArg < crate::classes::Object >) -> Self {
        Self {
            base_instance: base_instance.consume_arg(), .. self
        }
    }
    #[inline]
    ...
    pub fn done(self) -> Variant {
        ...
        = self;
        re_export::Expression::execute_full(surround_object, inputs.cow_as_arg(), base_instance.cow_as_object_arg(), show_error, const_calls_only,)
    }
}
pub use signals::*;
mod signals {
