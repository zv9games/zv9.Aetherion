...
pub(super) mod re_export {
    ...
    impl RdSamplerState {
        pub fn set_mag_filter(&mut self, p_member: crate::classes::rendering_device::SamplerFilter,) {
            type CallRet = ();
            type CallParams = (crate::classes::rendering_device::SamplerFilter,);
            let args = (p_member,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7065usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_mag_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mag_filter(&self,) -> crate::classes::rendering_device::SamplerFilter {
            type CallRet = crate::classes::rendering_device::SamplerFilter;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7066usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_mag_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_min_filter(&mut self, p_member: crate::classes::rendering_device::SamplerFilter,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_min_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min_filter(&self,) -> crate::classes::rendering_device::SamplerFilter {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_min_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_mip_filter(&mut self, p_member: crate::classes::rendering_device::SamplerFilter,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_mip_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mip_filter(&self,) -> crate::classes::rendering_device::SamplerFilter {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_mip_filter", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_repeat_u(&mut self, p_member: crate::classes::rendering_device::SamplerRepeatMode,) {
            type CallRet = ();
            type CallParams = (crate::classes::rendering_device::SamplerRepeatMode,);
            let args = (p_member,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7071usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_repeat_u", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_repeat_u(&self,) -> crate::classes::rendering_device::SamplerRepeatMode {
            type CallRet = crate::classes::rendering_device::SamplerRepeatMode;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7072usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_repeat_u", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_repeat_v(&mut self, p_member: crate::classes::rendering_device::SamplerRepeatMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_repeat_v", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_repeat_v(&self,) -> crate::classes::rendering_device::SamplerRepeatMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_repeat_v", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_repeat_w(&mut self, p_member: crate::classes::rendering_device::SamplerRepeatMode,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_repeat_w", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_repeat_w(&self,) -> crate::classes::rendering_device::SamplerRepeatMode {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_repeat_w", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_lod_bias(&mut self, p_member: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_lod_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_lod_bias(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_lod_bias", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_use_anisotropy(&mut self, p_member: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_use_anisotropy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_use_anisotropy(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_use_anisotropy", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_anisotropy_max(&mut self, p_member: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_anisotropy_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_anisotropy_max(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_anisotropy_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_enable_compare(&mut self, p_member: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_enable_compare", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_enable_compare(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_enable_compare", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_compare_op(&mut self, p_member: crate::classes::rendering_device::CompareOperator,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_compare_op", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_compare_op(&self,) -> crate::classes::rendering_device::CompareOperator {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_compare_op", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_min_lod(&mut self, p_member: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_min_lod", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min_lod(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_min_lod", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max_lod(&mut self, p_member: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_max_lod", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max_lod(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_max_lod", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_border_color(&mut self, p_member: crate::classes::rendering_device::SamplerBorderColor,) {
            type CallRet = ();
            type CallParams = (crate::classes::rendering_device::SamplerBorderColor,);
            let args = (p_member,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7091usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_border_color(&self,) -> crate::classes::rendering_device::SamplerBorderColor {
            type CallRet = crate::classes::rendering_device::SamplerBorderColor;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(7092usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_border_color", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_unnormalized_uvw(&mut self, p_member: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "set_unnormalized_uvw", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_unnormalized_uvw(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "RdSamplerState", "get_unnormalized_uvw", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_RdSamplerState__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::RdSamplerState;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::object::SignalsOfObject;
    impl WithSignals for RdSamplerState {
