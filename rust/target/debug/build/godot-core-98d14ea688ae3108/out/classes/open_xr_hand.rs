...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for OpenXrHand {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"OpenXRHand"));
            * name
        }
...
impl crate::obj::EngineEnum for MotionRange {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::UNOBSTRUCTED => "MOTION_RANGE_UNOBSTRUCTED", Self::CONFORM_TO_CONTROLLER => "MOTION_RANGE_CONFORM_TO_CONTROLLER", Self::MAX => "MOTION_RANGE_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for SkeletonRig {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::OPENXR => "SKELETON_RIG_OPENXR", Self::HUMANOID => "SKELETON_RIG_HUMANOID", Self::MAX => "SKELETON_RIG_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
