    ...
    impl SliderJoint3D {
        pub fn set_param(&mut self, param: crate::classes::slider_joint_3d::Param, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SliderJoint3D", "set_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_param(&self, param: crate::classes::slider_joint_3d::Param,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SliderJoint3D", "get_param", self.object_ptr, self.__checked_id(), args,)
            }
        }
