...
pub(super) mod re_export {
    ...
    impl Cubemap {
        pub fn create_placeholder(&self,) -> Option < Gd < crate::classes::Resource > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "Cubemap", "create_placeholder", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for Cubemap {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"Cubemap"));
            * name
        }
