...
pub(super) mod re_export {
    ...
    impl crate::obj::GodotClass for SceneReplicationConfig {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"SceneReplicationConfig"));
            * name
        }
...
impl crate::obj::EngineEnum for ReplicationMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::NEVER => "REPLICATION_MODE_NEVER", Self::ALWAYS => "REPLICATION_MODE_ALWAYS", Self::ON_CHANGE => "REPLICATION_MODE_ON_CHANGE", _ => self.as_str(),
        }
    }
