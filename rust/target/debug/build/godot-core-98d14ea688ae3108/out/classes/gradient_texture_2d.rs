...
pub(super) mod re_export {
    ...
    impl GradientTexture2D {
        pub fn set_gradient(&mut self, gradient: impl AsObjectArg < crate::classes::Gradient >,) {
            type CallRet = ();
    ...
    impl crate::obj::GodotClass for GradientTexture2D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GradientTexture2D"));
            * name
        }
...
impl crate::obj::EngineEnum for Fill {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::LINEAR => "FILL_LINEAR", Self::RADIAL => "FILL_RADIAL", Self::SQUARE => "FILL_SQUARE", _ => self.as_str(),
        }
    }
