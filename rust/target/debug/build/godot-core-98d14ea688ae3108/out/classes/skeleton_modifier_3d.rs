...
pub(super) mod re_export {
    ...
    impl SkeletonModifier3D {
        pub fn get_skeleton(&self,) -> Option < Gd < crate::classes::Skeleton3D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "get_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_active(&mut self, active: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "set_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_active(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "is_active", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_influence(&mut self, influence: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "set_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_influence(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "SkeletonModifier3D", "get_influence", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for SkeletonModifier3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"SkeletonModifier3D"));
            * name
        }
...
impl crate::obj::EngineEnum for BoneAxis {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::PLUS_X => "BONE_AXIS_PLUS_X", Self::MINUS_X => "BONE_AXIS_MINUS_X", Self::PLUS_Y => "BONE_AXIS_PLUS_Y", Self::MINUS_Y => "BONE_AXIS_MINUS_Y", Self::PLUS_Z => "BONE_AXIS_PLUS_Z", Self::MINUS_Z => "BONE_AXIS_MINUS_Z", _ => self.as_str(),
        }
    }
    ...
    impl < 'c, C: WithSignals > SignalsOfSkeletonModifier3D < 'c, C > {
        ...
        pub fn modification_processed(&mut self) -> SigModificationProcessed < 'c, C > {
            SigModificationProcessed {
                typed: TypedSignal::extract(&mut self.__internal_obj, "modification_processed")
            }
        }
    }
