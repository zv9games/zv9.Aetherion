...
pub(super) mod re_export {
    ...
    impl MeshTexture {
        pub fn set_mesh(&mut self, mesh: impl AsObjectArg < crate::classes::Mesh >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "set_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_mesh(&self,) -> Option < Gd < crate::classes::Mesh > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "get_mesh", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_image_size(&mut self, size: Vector2,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "set_image_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_image_size(&self,) -> Vector2 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "get_image_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_base_texture(&mut self, texture: impl AsObjectArg < crate::classes::Texture2D >,) {
            type CallRet = ();
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "set_base_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_base_texture(&self,) -> Option < Gd < crate::classes::Texture2D > > {
            type CallRet = Option < Gd < crate::classes::Texture2D > >;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(5404usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "MeshTexture", "get_base_texture", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for MeshTexture {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"MeshTexture"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::Texture2D > for MeshTexture {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Texture > for MeshTexture {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for MeshTexture {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for MeshTexture {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for MeshTexture {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`MeshTexture`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_MeshTexture__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::MeshTexture > for $Class {
...
mod signals {
    ...
    use super::re_export::MeshTexture;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for MeshTexture {
