...
pub(super) mod re_export {
    ...
    impl GltfSkeleton {
        pub fn get_joints(&mut self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_joints", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_joints(&mut self, joints: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "set_joints", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_roots(&mut self,) -> PackedInt32Array {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_roots", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_roots(&mut self, roots: &PackedInt32Array,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "set_roots", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_godot_skeleton(&mut self,) -> Option < Gd < crate::classes::Skeleton3D > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_godot_skeleton", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_unique_names(&mut self,) -> Array < GString > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_unique_names", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_unique_names(&mut self, unique_names: &Array < GString >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "set_unique_names", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_godot_bone_node(&mut self,) -> Dictionary {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_godot_bone_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_godot_bone_node(&mut self, godot_bone_node: &Dictionary,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "set_godot_bone_node", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bone_attachment_count(&mut self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_bone_attachment_count", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_bone_attachment(&mut self, idx: i32,) -> Option < Gd < crate::classes::BoneAttachment3D > > {
            type CallRet = Option < Gd < crate::classes::BoneAttachment3D > >;
            type CallParams = (i32,);
            let args = (idx,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(3768usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "GltfSkeleton", "get_bone_attachment", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_GltfSkeleton__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::GltfSkeleton;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for GltfSkeleton {
