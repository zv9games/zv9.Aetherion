...
pub(super) mod re_export {
    ...
    impl Viewport {
        pub fn set_world_2d(&mut self, world_2d: impl AsObjectArg < crate::classes::World2D >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::World2D >,);
        ...
        pub(crate) fn push_input_full(&mut self, event: ObjectArg < crate::classes::InputEvent >, in_local_coords: bool,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::InputEvent >, bool,);
        ...
        pub fn set_world_3d(&mut self, world_3d: impl AsObjectArg < crate::classes::World3D >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::World3D >,);
...
impl crate::obj::EngineEnum for Scaling3DMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::BILINEAR => "SCALING_3D_MODE_BILINEAR", Self::FSR => "SCALING_3D_MODE_FSR", Self::FSR2 => "SCALING_3D_MODE_FSR2", Self::METALFX_SPATIAL => "SCALING_3D_MODE_METALFX_SPATIAL", Self::METALFX_TEMPORAL => "SCALING_3D_MODE_METALFX_TEMPORAL", Self::MAX => "SCALING_3D_MODE_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for AnisotropicFiltering {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DISABLED => "ANISOTROPY_DISABLED", Self::MAX => "ANISOTROPY_MAX", _ => self.as_str(),
        }
    }
    fn values() -> &'static[Self] {
...
impl crate::obj::EngineEnum for ScreenSpaceAa {
    ...
    fn values() -> &'static[Self] {
        &[ScreenSpaceAa::DISABLED, ScreenSpaceAa::FXAA]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < ScreenSpaceAa >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("DISABLED", "SCREEN_SPACE_AA_DISABLED", ScreenSpaceAa::DISABLED), crate::meta::inspect::EnumConstant::new("FXAA", "SCREEN_SPACE_AA_FXAA", ScreenSpaceAa::FXAA), crate::meta::inspect::EnumConstant::new("MAX", "SCREEN_SPACE_AA_MAX", ScreenSpaceAa::MAX)]
        }
    }
}
