...
pub(super) mod re_export {
    ...
    impl AudioEffectFilter {
        pub fn set_cutoff(&mut self, freq: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "set_cutoff", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_cutoff(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "get_cutoff", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_resonance(&mut self, amount: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "set_resonance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_resonance(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "get_resonance", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_gain(&mut self, amount: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "set_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_gain(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "get_gain", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_db(&mut self, amount: crate::classes::audio_effect_filter::FilterDb,) {
            type CallRet = ();
            type CallParams = (crate::classes::audio_effect_filter::FilterDb,);
            let args = (amount,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(757usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "set_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_db(&self,) -> crate::classes::audio_effect_filter::FilterDb {
            type CallRet = crate::classes::audio_effect_filter::FilterDb;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(758usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectFilter", "get_db", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AudioEffectFilter__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for FilterDb {
    ...
    fn values() -> &'static[Self] {
        &[FilterDb::FILTER_6DB, FilterDb::FILTER_12DB, FilterDb::FILTER_18DB, FilterDb::FILTER_24DB]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < FilterDb >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("FILTER_6DB", "FILTER_6DB", FilterDb::FILTER_6DB), crate::meta::inspect::EnumConstant::new("FILTER_12DB", "FILTER_12DB", FilterDb::FILTER_12DB), crate::meta::inspect::EnumConstant::new("FILTER_18DB", "FILTER_18DB", FilterDb::FILTER_18DB), crate::meta::inspect::EnumConstant::new("FILTER_24DB", "FILTER_24DB", FilterDb::FILTER_24DB)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::AudioEffectFilter;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for AudioEffectFilter {
