...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeVectorBase {
        ...
        pub fn get_op_type(&self,) -> crate::classes::visual_shader_node_vector_base::OpType {
            ...
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10834usize);
    ...
    impl crate::obj::GodotClass for VisualShaderNodeVectorBase {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VisualShaderNodeVectorBase"));
            * name
        }
...
impl crate::obj::EngineEnum for OpType {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::VECTOR_2D => "OP_TYPE_VECTOR_2D", Self::VECTOR_3D => "OP_TYPE_VECTOR_3D", Self::VECTOR_4D => "OP_TYPE_VECTOR_4D", Self::MAX => "OP_TYPE_MAX", _ => self.as_str(),
        }
    }
