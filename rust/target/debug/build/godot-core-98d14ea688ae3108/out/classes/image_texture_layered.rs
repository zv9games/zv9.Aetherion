...
pub(super) mod re_export {
    ...
    impl ImageTextureLayered {
        ...
        pub fn update_layer(&mut self, image: impl AsObjectArg < crate::classes::Image >, layer: i32,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::Image >, i32,);
            let args = (image.as_object_arg(), layer,);
            unsafe {
    ...
    impl crate::obj::GodotClass for ImageTextureLayered {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"ImageTextureLayered"));
            * name
        }
