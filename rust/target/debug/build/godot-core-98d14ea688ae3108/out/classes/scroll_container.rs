...
impl crate::obj::EngineEnum for ScrollMode {
    ...
    fn godot_name(&self) -> &'static str {
        #[allow(unreachable_patterns)]
        match * self {
            Self::DISABLED => "SCROLL_MODE_DISABLED", Self::AUTO => "SCROLL_MODE_AUTO", Self::SHOW_ALWAYS => "SCROLL_MODE_SHOW_ALWAYS", Self::SHOW_NEVER => "SCROLL_MODE_SHOW_NEVER", Self::RESERVE => "SCROLL_MODE_RESERVE", _ => self.as_str(),
        }
    }
