...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeFloatParameter {
        pub fn set_hint(&mut self, hint: crate::classes::visual_shader_node_float_parameter::Hint,) {
            type CallRet = ();
            type CallParams = (crate::classes::visual_shader_node_float_parameter::Hint,);
            let args = (hint,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10658usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_hint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_hint(&self,) -> crate::classes::visual_shader_node_float_parameter::Hint {
            type CallRet = crate::classes::visual_shader_node_float_parameter::Hint;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10659usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "get_hint", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_min(&mut self, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_min(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "get_min", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_max(&mut self, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_max(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "get_max", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_step(&mut self, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_step(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "get_step", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_default_value_enabled(&mut self, enabled: bool,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_default_value_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_default_value_enabled(&self,) -> bool {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "is_default_value_enabled", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_default_value(&mut self, value: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "set_default_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_default_value(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeFloatParameter", "get_default_value", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_VisualShaderNodeFloatParameter__ensure_class_exists {
        ($Class: ident) => {
...
impl crate::obj::EngineEnum for Hint {
    ...
    fn values() -> &'static[Self] {
        &[Hint::NONE, Hint::RANGE, Hint::RANGE_STEP]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < Hint >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("NONE", "HINT_NONE", Hint::NONE), crate::meta::inspect::EnumConstant::new("RANGE", "HINT_RANGE", Hint::RANGE), crate::meta::inspect::EnumConstant::new("RANGE_STEP", "HINT_RANGE_STEP", Hint::RANGE_STEP), crate::meta::inspect::EnumConstant::new("MAX", "HINT_MAX", Hint::MAX)]
        }
    }
}
...
mod signals {
    ...
    use super::re_export::VisualShaderNodeFloatParameter;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for VisualShaderNodeFloatParameter {
