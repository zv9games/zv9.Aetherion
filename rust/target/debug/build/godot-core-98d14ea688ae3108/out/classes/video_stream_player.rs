...
pub(super) mod re_export {
    ...
    impl VideoStreamPlayer {
        pub fn set_stream(&mut self, stream: impl AsObjectArg < crate::classes::VideoStream >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::VideoStream >,);
    ...
    impl crate::obj::GodotClass for VideoStreamPlayer {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"VideoStreamPlayer"));
            * name
        }
