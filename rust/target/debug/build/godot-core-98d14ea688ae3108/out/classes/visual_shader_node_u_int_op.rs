...
pub(super) mod re_export {
    ...
    impl VisualShaderNodeUIntOp {
        pub fn set_operator(&mut self, op: crate::classes::visual_shader_node_u_int_op::Operator,) {
            type CallRet = ();
            type CallParams = (crate::classes::visual_shader_node_u_int_op::Operator,);
            let args = (op,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10803usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeUIntOp", "set_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_operator(&self,) -> crate::classes::visual_shader_node_u_int_op::Operator {
            type CallRet = crate::classes::visual_shader_node_u_int_op::Operator;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(10804usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "VisualShaderNodeUIntOp", "get_operator", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_VisualShaderNodeUIntOp__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::VisualShaderNodeUIntOp;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for VisualShaderNodeUIntOp {
