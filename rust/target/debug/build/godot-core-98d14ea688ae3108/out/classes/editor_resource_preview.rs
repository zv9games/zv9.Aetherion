...
pub(super) mod re_export {
    ...
    impl EditorResourcePreview {
        pub fn queue_resource_preview(&mut self, path: impl AsArg < GString >, receiver: impl AsObjectArg < crate::classes::Object >, receiver_func: impl AsArg < StringName >, userdata: &Variant,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, 'a2, > = (CowArg < 'a0, GString >, ObjectArg < crate::classes::Object >, CowArg < 'a1, StringName >, RefArg < 'a2, Variant >,);
            let args = (path.into_arg(), receiver.as_object_arg(), receiver_func.into_arg(), RefArg::new(userdata),);
            unsafe {
        ...
        pub fn queue_edited_resource_preview(&mut self, resource: impl AsObjectArg < crate::classes::Resource >, receiver: impl AsObjectArg < crate::classes::Object >, receiver_func: impl AsArg < StringName >, userdata: &Variant,) {
            type CallRet = ();
            type CallParams < 'a0, 'a1, > = (ObjectArg < crate::classes::Resource >, ObjectArg < crate::classes::Object >, CowArg < 'a0, StringName >, RefArg < 'a1, Variant >,);
            let args = (resource.as_object_arg(), receiver.as_object_arg(), receiver_func.into_arg(), RefArg::new(userdata),);
            unsafe {
        ...
        pub fn add_preview_generator(&mut self, generator: impl AsObjectArg < crate::classes::EditorResourcePreviewGenerator >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorResourcePreviewGenerator >,);
            let args = (generator.as_object_arg(),);
            unsafe {
        ...
        pub fn remove_preview_generator(&mut self, generator: impl AsObjectArg < crate::classes::EditorResourcePreviewGenerator >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::EditorResourcePreviewGenerator >,);
            let args = (generator.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for EditorResourcePreview {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"EditorResourcePreview"));
            * name
        }
