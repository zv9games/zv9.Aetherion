...
pub(super) mod re_export {
    ...
    impl OpenXrInteractionProfileEditorBase {
        pub fn setup(&mut self, action_map: impl AsObjectArg < crate::classes::OpenXrActionMap >, interaction_profile: impl AsObjectArg < crate::classes::OpenXrInteractionProfile >,) {
            type CallRet = ();
            type CallParams = (ObjectArg < crate::classes::OpenXrActionMap >, ObjectArg < crate::classes::OpenXrInteractionProfile >,);
            let args = (action_map.as_object_arg(), interaction_profile.as_object_arg(),);
            unsafe {
    ...
    impl crate::obj::GodotClass for OpenXrInteractionProfileEditorBase {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"OpenXRInteractionProfileEditorBase"));
            * name
        }
