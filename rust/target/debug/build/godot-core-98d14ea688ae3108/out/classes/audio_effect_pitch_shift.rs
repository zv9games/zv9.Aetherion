...
pub(super) mod re_export {
    ...
    impl AudioEffectPitchShift {
        pub fn set_pitch_scale(&mut self, rate: f32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_pitch_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_pitch_scale(&self,) -> f32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_pitch_scale", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_oversampling(&mut self, amount: i32,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_oversampling", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_oversampling(&self,) -> i32 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_oversampling", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_fft_size(&mut self, size: crate::classes::audio_effect_pitch_shift::FftSize,) {
            type CallRet = ();
            type CallParams = (crate::classes::audio_effect_pitch_shift::FftSize,);
            let args = (size,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(789usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "set_fft_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_fft_size(&self,) -> crate::classes::audio_effect_pitch_shift::FftSize {
            type CallRet = crate::classes::audio_effect_pitch_shift::FftSize;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(790usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AudioEffectPitchShift", "get_fft_size", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for AudioEffectPitchShift {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"AudioEffectPitchShift"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::AudioEffect > for AudioEffectPitchShift {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Resource > for AudioEffectPitchShift {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::RefCounted > for AudioEffectPitchShift {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for AudioEffectPitchShift {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`AudioEffectPitchShift`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_AudioEffectPitchShift__ensure_class_exists {
        ($Class: ident) => {
            unsafe impl::godot::obj::Inherits < ::godot::classes::AudioEffectPitchShift > for $Class {
...
mod signals {
    ...
    use super::re_export::AudioEffectPitchShift;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::resource::SignalsOfResource;
    impl WithSignals for AudioEffectPitchShift {
