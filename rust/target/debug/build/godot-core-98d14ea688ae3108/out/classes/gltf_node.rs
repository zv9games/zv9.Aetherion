...
pub(super) mod re_export {
    ...
    impl GltfNode {
        ...
        pub(crate) fn get_scene_node_path_full(&mut self, gltf_state: ObjectArg < crate::classes::GltfState >, handle_skeletons: bool,) -> NodePath {
            type CallRet = NodePath;
            type CallParams = (ObjectArg < crate::classes::GltfState >, bool,);
        ...
        #[inline]
        pub fn get_scene_node_path(&mut self, gltf_state: impl AsObjectArg < crate::classes::GltfState >,) -> NodePath {
            self.get_scene_node_path_ex(gltf_state,) . done()
        }
        #[inline]
        pub fn get_scene_node_path_ex < 'a > (&'a mut self, gltf_state: impl AsObjectArg < crate::classes::GltfState >,) -> ExGetSceneNodePath < 'a > {
    ...
    impl crate::obj::GodotClass for GltfNode {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"GLTFNode"));
            * name
        }
...
pub struct ExGetSceneNodePath < 'a > {
    _phantom: std::marker::PhantomData < &'a() >, surround_object: &'a mut re_export::GltfNode, gltf_state: ObjectCow < crate::classes::GltfState >, handle_skeletons: bool,
}
#[allow(clippy::wrong_self_convention, clippy::redundant_field_names, clippy::needless_update)]
impl < 'a > ExGetSceneNodePath < 'a > {
    fn new(surround_object: &'a mut re_export::GltfNode, gltf_state: impl AsObjectArg < crate::classes::GltfState >,) -> Self {
        let handle_skeletons = true;
        Self {
            _phantom: std::marker::PhantomData, surround_object: surround_object, gltf_state: gltf_state.consume_arg(), handle_skeletons: handle_skeletons,
        }
    }
    #[inline]
    ...
    pub fn done(self) -> NodePath {
        ...
        = self;
        re_export::GltfNode::get_scene_node_path_full(surround_object, gltf_state.cow_as_object_arg(), handle_skeletons,)
    }
}
pub use signals::*;
mod signals {
