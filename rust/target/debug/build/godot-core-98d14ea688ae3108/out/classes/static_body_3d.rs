...
pub(super) mod re_export {
    ...
    impl StaticBody3D {
        pub fn set_constant_linear_velocity(&mut self, vel: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "set_constant_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_constant_angular_velocity(&mut self, vel: Vector3,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "set_constant_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_constant_linear_velocity(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "get_constant_linear_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_constant_angular_velocity(&self,) -> Vector3 {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "get_constant_angular_velocity", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn set_physics_material_override(&mut self, physics_material_override: impl AsObjectArg < crate::classes::PhysicsMaterial >,) {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "set_physics_material_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn get_physics_material_override(&self,) -> Option < Gd < crate::classes::PhysicsMaterial > > {
            ...
            unsafe {
                ...
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "StaticBody3D", "get_physics_material_override", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    impl crate::obj::GodotClass for StaticBody3D {
        ...
        fn class_name() -> ClassName {
            ...
            let name: &'static ClassName = CLASS_NAME.get_or_init(|| ClassName::alloc_next_ascii(c"StaticBody3D"));
            * name
        }
    ...
    unsafe impl crate::obj::Inherits < crate::classes::PhysicsBody3D > for StaticBody3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::CollisionObject3D > for StaticBody3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node3D > for StaticBody3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Node > for StaticBody3D {
        
    }
    unsafe impl crate::obj::Inherits < crate::classes::Object > for StaticBody3D {
    ...
    #[doc = r" # Safety"]
    #[doc = r""]
    #[doc = "The provided class must be a subclass of all the superclasses of [`StaticBody3D`]"]
    #[macro_export]
    #[allow(non_snake_case)]
    macro_rules !inherit_from_StaticBody3D__ensure_class_exists {
        ($Class: ident) => {
