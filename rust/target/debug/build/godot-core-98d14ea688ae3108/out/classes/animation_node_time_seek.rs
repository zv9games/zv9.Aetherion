...
pub(super) mod re_export {
    ...
    impl AnimationNodeTimeSeek {
        pub fn set_explicit_elapse(&mut self, enable: bool,) {
            type CallRet = ();
            type CallParams = (bool,);
            let args = (enable,);
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(460usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeTimeSeek", "set_explicit_elapse", self.object_ptr, self.__checked_id(), args,)
            }
        }
        pub fn is_explicit_elapse(&self,) -> bool {
            type CallRet = bool;
            type CallParams = ();
            let args = ();
            unsafe {
                let method_bind = sys::class_scene_api() . fptr_by_index(461usize);
                Signature::< CallParams, CallRet > ::out_class_ptrcall(method_bind, "AnimationNodeTimeSeek", "is_explicit_elapse", self.object_ptr, self.__checked_id(), args,)
            }
        }
    ...
    macro_rules !inherit_from_AnimationNodeTimeSeek__ensure_class_exists {
        ($Class: ident) => {
...
mod signals {
    ...
    use super::re_export::AnimationNodeTimeSeek;
    use crate::registry::signal::TypedSignal;
    use super::*;
    use crate::obj::WithSignals;
    use crate::classes::animation_node::SignalsOfAnimationNode;
    impl WithSignals for AnimationNodeTimeSeek {
