...
impl crate::obj::EngineEnum for PlayAreaMode {
    ...
    fn values() -> &'static[Self] {
        &[PlayAreaMode::UNKNOWN, PlayAreaMode::AREA_3DOF, PlayAreaMode::SITTING, PlayAreaMode::ROOMSCALE, PlayAreaMode::STAGE]
    }
    fn all_constants() -> &'static[crate::meta::inspect::EnumConstant < PlayAreaMode >] {
        const {
            &[crate::meta::inspect::EnumConstant::new("UNKNOWN", "XR_PLAY_AREA_UNKNOWN", PlayAreaMode::UNKNOWN), crate::meta::inspect::EnumConstant::new("AREA_3DOF", "XR_PLAY_AREA_3DOF", PlayAreaMode::AREA_3DOF), crate::meta::inspect::EnumConstant::new("SITTING", "XR_PLAY_AREA_SITTING", PlayAreaMode::SITTING), crate::meta::inspect::EnumConstant::new("ROOMSCALE", "XR_PLAY_AREA_ROOMSCALE", PlayAreaMode::ROOMSCALE), crate::meta::inspect::EnumConstant::new("STAGE", "XR_PLAY_AREA_STAGE", PlayAreaMode::STAGE)]
        }
    }
}
