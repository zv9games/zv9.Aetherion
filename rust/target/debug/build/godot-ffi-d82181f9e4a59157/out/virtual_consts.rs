...
pub mod EditorExportPlatformExtension {
    ...
    pub const get_option_icon: (&'static str, u32) = ("_get_option_icon", 3991065292u32);
...
pub mod TextServerExtension {
    ...
    pub const font_draw_glyph: (&'static str, u32) = ("_font_draw_glyph", 309868464u32);
    pub const font_draw_glyph_outline: (&'static str, u32) = ("_font_draw_glyph_outline", 3090733778u32);
    ...
    pub const shaped_text_draw: (&'static str, u32) = ("_shaped_text_draw", 2453262187u32);
    pub const shaped_text_draw_outline: (&'static str, u32) = ("_shaped_text_draw_outline", 1686767567u32);
