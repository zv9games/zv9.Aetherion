...
pub struct EngineConfig {
    ...
    pub grid_width: i32,        // Width of generation grid
    pub grid_height: i32,       // Height of generation grid
}
...
pub fn load_config() -> EngineConfig {
    EngineConfig {
        ...
        grid_width: env::var("ECHO_GRID_WIDTH")
            .ok()
            .and_then(|v| v.parse().ok())
            .unwrap_or(64),
        grid_height: env::var("ECHO_GRID_HEIGHT")
            .ok()
            .and_then(|v| v.parse().ok())
            .unwrap_or(64),
    }
